...
var nexa_last_touchend_time = undefined; //20190311  prevent double tap zooming
var useToBe = true;
		...
		if(useCheckTranskey){
		    if(useToBe){
				if (document.addEventListener) {
			    	document.addEventListener("click", checkTransKey, false);
				} else if (document.attachEvent) {
			    	document.attachEvent("onclick", checkTransKey);
				}
...
function mTranskey(){
	...
	//20190311  prevent double tap zooming
	if(useToBe){
		var nexa_touchendEvent = 'ontouchend="mtk.prevent_iOS_doubleTabZooming(event, this);';
	}
...
/*	function getOffsetPoint(Element) {
	...
	function qwertyMobileLayoutForDIV(id, cssText){
		...
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 0);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-4px -9px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 1);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-39px -9px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 2);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-73px -9px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 3);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-108px -9px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 4);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-143px -9px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 5);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-178px -9px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 6);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-213px -9px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 7);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-248px -9px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 8);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-284px -9px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 9);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-319px -9px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height " '+startEvent+'="mtk.start(event, this, 10);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-354px -9px;"></div></div>'+
	'</div>'+
	'<div class="dv_'+cssText+'_div_2  dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 11);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-4px -60px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 12);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-39px -60px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 13);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-73px -60px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 14);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-108px -60px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 15);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-143px -60px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 16);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-178px -60px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 17);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-213px -60px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 18);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-248px -60px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 19);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-284px -60px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 20);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-319px -60px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 21);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-354px -60px;"></div></div>'+
	'</div>'+
	'<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 22);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-4px -108px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 23);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-39px -108px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 24);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-73px -108px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 25);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-108px -108px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 26);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-143px -108px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 27);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-178px -108px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 28);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-213px -108px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 29);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-248px -108px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 30);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-284px -108px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 31);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-319px -108px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 32);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-354px -108px;"></div></div>'+
	'</div>'+
	'<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div_a dv_'+cssText+'_div2_Height" id="mtk_cp" '+startEvent+'="mtk.cap(event, this);" ' + nexa_touchendEvent + '" role="button" tabindex="0" aria-label="쉬프트"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-2px -157px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 33);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-39px -161px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 34);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-73px -161px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 35);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-108px -161px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 36);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-143px -161px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 37);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-178px -161px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 38);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-213px -161px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 39);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-248px -161px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 40);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-284px -161px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div_a dv_'+cssText+'_end dv_'+cssText+'_div2_Height" id="mtk_del" '+startEvent+'="mtk.del(event, this);" ' + nexa_touchendEvent + '" role="button" tabindex="0" aria-label="삭제"><div class="dv_'+cssText+'_div2_2  dv_'+cssText+'_div2_2_qTop" style="background-position:-333px -157px;width:40px;"></div></div>'+
	'</div>';
		if(useSpace) {
			layout += '<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height">'+
				'<div class="dv_'+cssText+'_div3 dv_'+cssText+'_div_a dv_'+cssText+'_div2_Height"  id="mtk_sp" '+startEvent+'="mtk.sp(event, this);" ' + nexa_touchendEvent + '" role="button" tabindex="0" aria-label="특수키"><div class="dv_'+cssText+'_div3_2 dv_'+cssText+'_div3_3_qTop" style="background-position:-16px -211px;"></div></div>'+
				'<div class="dv_'+cssText+'_div3 dv_'+cssText+'_div_a dv_'+cssText+'_div2_Height"  id="mtk_space" '+startEvent+'="mtk.clear(event, this);" ' + nexa_touchendEvent + '" role="button" tabindex="0" aria-label="전체사제"><div class="dv_'+cssText+'_div3_3 dv_'+cssText+'_div3_3_qTop" style="background-position:-75px -211px;"></div></div>'+
				'<div class="dv_'+cssText+'_div3 dv_'+cssText+'_div_a dv_'+cssText+'_div2_Height"  '+startEvent+'="mtk.start(event, this, 41);" ' + nexa_touchendEvent + '" role="button" tabindex="0" aria-label="스페이스바"><div class="dv_'+cssText+'_div3_3 dv_'+cssText+'_div3_3_qTop" style="background-position:-162px -212px;"></div></div>'+
				'<div class="dv_'+cssText+'_div3 dv_'+cssText+'_div_b dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.done(event, this);" ' + nexa_touchendEvent + '" role="button" tabindex="0" aria-label="입력완료"><div class="dv_'+cssText+'_div3_2 dv_'+cssText+'_div3_3_qTop" style="width:75px;height:27px;background-position:-282px -211px;"></div></div>'+
			'</div>';
		} else {
			layout += '<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height">'+
				'<div class="dv_'+cssText+'_div3 dv_'+cssText+'_div_a dv_'+cssText+'_div2_Height"  id="mtk_sp" '+startEvent+'="mtk.sp(event, this);" ' + nexa_touchendEvent + '" role="button" tabindex="0" aria-label="특수키"><div class="dv_'+cssText+'_div3_2 dv_'+cssText+'_div3_3_qTop" style="width:42px;height:27px;background-position:-31px -211px;"></div></div>'+
				'<div class="dv_'+cssText+'_div3 dv_'+cssText+'_div_a dv_'+cssText+'_div2_Height"  '+startEvent+'="mtk.clear(event, this);" ' + nexa_touchendEvent + '" role="button" tabindex="0" aria-label="전체삭제"><div class="dv_'+cssText+'_div3_3 dv_'+cssText+'_div3_3_qTop" style="background-position:-130px -212px;"></div></div>'+
				'<div class="dv_'+cssText+'_div3 dv_'+cssText+'_div_b dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.done(event, this);" ' + nexa_touchendEvent + '" role="button" tabindex="0" aria-label="입력완료"><div class="dv_'+cssText+'_div3_2 dv_'+cssText+'_div3_3_qTop" style="width:75px;height:27px;background-position:-263px -211px;"></div></div>'+
			'</div>';
		}
	...
	function numberMobileLayoutForDIV(id, cssText){
		...
		if(document.getElementById(id).getAttribute("data-tk-useinput")=="true") {
			layout = '<div id="mtk_disp" class="dv_'+cssText+'_disp" style="height: 1px; border:0px;" ' + nexa_touchendEvent + '" role="button" tabindex="0" aria-label="가상키보드 영역 입니다"></div>';
		} else {
			layout += '<div class="dv_'+cssText+'_disp_a" role="button" tabindex="0" aria-label="가상키보드 영역 입니다"></div>';
			layout += '<div class="dv_'+cssText+'_disp_b" '+startEvent+'="mtk.close();" ' + nexa_touchendEvent + '" role="button" tabindex="0" aria-label="가상키보드 닫기"></div></div>';
		}
		
		layout += '<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 0);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-33px -20px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 1);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-131px -20px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 2);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-228px -20px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 3);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-327px -20px;"></div></div>'+
	'</div>'+
	'<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 4);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-33px -81px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 5);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-131px -81px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 6);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-228px -81px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 7);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-327px -81px;"></div></div>'+
	'</div>'+
	'<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 8);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-33px -142px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 9);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-131px -142px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 10);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-228px -142px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 11);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-327px -142px;"></div></div>'+
	'</div>'+
	'<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div3 dv_'+cssText+'_div_a dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.del(event, this);" ' + nexa_touchendEvent + '" role="button" tabindex="0" aria-label="삭제"><div class="dv_'+cssText+'_div2_2 dv_'+cssText+'_div2_2_nTop" style="background-position:-33px -203px;"></div></div>'+
		'<div class="dv_'+cssText+'_div3 dv_'+cssText+'_div_a dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.clear(event, this);" ' + nexa_touchendEvent + '" role="button" tabindex="0" aria-label="전체 삭제"><div class="dv_'+cssText+'_div3_3 dv_'+cssText+'_div3_3_nTop" style="background-position:-114px -206px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2  dv_'+cssText+'_div_b dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.done(event, this);" ' + nexa_touchendEvent + '" role="button" tabindex="0" aria-label="확인"><div class="dv_'+cssText+'_div3_2 dv_'+cssText+'_div3_3_nTop" style="background-position:-272px -206px;"></div></div>'+
	'</div>';
		if(showLicense&&licenseType!="")
			layout += '<div class="dv_'+cssText+'_licenseType" style="position : absolute;margin: 5px; color : red;">' + licenseType + " (" + licExpiredDate + ")" + '</div>';
	...
	function numberMobileNDLayoutForDIV(id, cssText){
		...
		layout += '<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 0);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_3 dv_'+cssText+'_div2_2_nTop" style="background-position:-39px -21px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 1);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_3 dv_'+cssText+'_div2_2_nTop" style="background-position:-147px -21px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 2);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_3 dv_'+cssText+'_div2_2_nTop" style="background-position:-254px -21px;"></div></div>'+
	'</div>'+
	'<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 3);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_3 dv_'+cssText+'_div2_2_nTop" style="background-position:-39px -82px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 4);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_3 dv_'+cssText+'_div2_2_nTop" style="background-position:-147px -82px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 5);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_3 dv_'+cssText+'_div2_2_nTop" style="background-position:-254px -82px;"></div></div>'+
	'</div>'+
	'<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 6);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_3 dv_'+cssText+'_div2_2_nTop" style="background-position:-39px -144px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 7);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_3 dv_'+cssText+'_div2_2_nTop" style="background-position:-147px -144px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 8);" ' + nexa_touchendEvent + '" role="button" tabindex="0"><div class="dv_'+cssText+'_div2_3 dv_'+cssText+'_div2_2_nTop" style="background-position:-254px -144px;"></div></div>'+
	'</div>'+
	'<div class="dv_'+cssText+'_div_2 dv_'+cssText+'_end dv_'+cssText+'_div2_Height">'+
		'<div class="dv_'+cssText+'_div3 dv_'+cssText+'_div_a dv_'+cssText+'_div2_Height"  '+startEvent+'="mtk.del(event, this);" ' + nexa_touchendEvent + '" role="button" tabindex="0" aria-label="삭제"><div class="dv_'+cssText+'_div2_3 dv_'+cssText+'_div2_2_nTop" style="background-position:-37px -203px;"></div></div>'+
		'<div class="dv_'+cssText+'_div3 dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.start(event, this, 9);" ' + nexa_touchendEvent + '" role="button" tabindex="0" aria-label="전체 삭제"><div class="dv_'+cssText+'_div2_3 dv_'+cssText+'_div2_2_nTop" style="background-position:-147px -207px;"></div></div>'+
		'<div class="dv_'+cssText+'_div2  dv_'+cssText+'_div_b dv_'+cssText+'_end dv_'+cssText+'_div2_Height" '+startEvent+'="mtk.done(event, this);" ' + nexa_touchendEvent + '" role="button" tabindex="0" aria-label="확인"><div class="dv_'+cssText+'_div3_4 dv_'+cssText+'_div3_3_nTop" style="background-position:-243px -206px;"></div></div>'+
	'</div>';
		if(showLicense&&licenseType!="")
			layout += '<div class="dv_'+cssText+'_licenseType" style="position : absolute;margin: 5px; color : red;">' + licenseType + " (" + licExpiredDate + ")" + '</div>';
	...
	this.transkeyInputLayout = function(inputObj){
		...
		var maxLength = inputObj.getAttribute("data-tk-maxLength")==null?-1:inputObj.getAttribute("data-tk-maxLength");
		...
		var layout = '<label class="transkey_input_label">'+ inputText +'</label><div class="dv_'+cssText+'_disp_b_not_input" '+startEvent+'="mtk.close();" style="position: absolute; top:5%; right:5%;" ' + nexa_touchendEvent + '" role="button" tabindex="0" aria-label="가상키보드 닫기"></div>';
...
mTranskey.prototype.setKeyboard = function(inputObj){
	...
	//document.getElementById('mainframe.VFrameSet.frameMain.form.divAll.form.divWork.form:container').appendChild(div);
...
mTranskey.prototype.start = function(e, ele, index){
		...
		if(mtk.now.inputObj.getAttribute("data-tk-maxLength")!=null){
			if (mtk.now.inputObj.value.length >= mtk.now.inputObj.getAttribute("data-tk-maxLength")) {
				this.close();
				return;
			}
		}
...
//		transkeyObj.useInputDiv.style.display="none";
	...
	if(transkeyObj.useInput){
		var maxLength = transkeyObj.inputObj.getAttribute("data-tk-maxLength")==null?-1:transkeyObj.inputObj.getAttribute("data-tk-maxLength");
...
mTranskey.prototype.reSizeListener = function(){
	...
	if(mtk.now!=null){
		if(transkey_divType==1) {
		 ...
		 var div = mtk.now.div;
		 var maxLength = mtk.now.inputObj.getAttribute("data-tk-maxLength")==null?-1:mtk.now.inputObj.getAttribute("data-tk-maxLength");
...
//[투비소프트 추가. 20190311] ios 10이상에서 safari double tapping 방지목적.
mTranskey.prototype.prevent_iOS_doubleTabZooming = function(evt, ele){
	console.log("preventDoubleTabpping : evt = " + evt);
	console.log("preventDoubleTabpping : nexacro._OS=" + nexacro._OS);
	var curTime = (evt.timeStamp || Date().now());
	if (nexacro._OS == "iOS" && parseFloat(nexacro._OSVersion) >= 10)
	{
		// prevent double tap zooming
		if (nexa_last_touchend_time && (curTime - nexa_last_touchend_time) < 500) {
			evt.preventDefault();
		}

		nexa_last_touchend_time = curTime;
	}
...
//TOBE
function initmTranskey_sh(input){
	setMaxDigits(131);	
	if(transkey_divType==1){
		useFakeKey=true;
		mtk_useTalkBack=true;
