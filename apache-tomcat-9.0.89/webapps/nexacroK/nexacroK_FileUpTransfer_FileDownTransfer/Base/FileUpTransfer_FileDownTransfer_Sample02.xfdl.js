(function()
{
    return function(nexacro, system, trace)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Button("Button00","110","32","140","30",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new nexacro.Button("Button00_00","260","32","140","30",null,null,null,null,null,null,this);
            obj.set_taborder("6");
        ...
        // User Script
        this.registerScript("FileUpTransfer_FileDownTransfer_Sample02.xfdl", function(nexacro, system, trace) {
        ...
        this.loadIncludeScript("FileUpTransfer_FileDownTransfer_Sample02.xfdl");
