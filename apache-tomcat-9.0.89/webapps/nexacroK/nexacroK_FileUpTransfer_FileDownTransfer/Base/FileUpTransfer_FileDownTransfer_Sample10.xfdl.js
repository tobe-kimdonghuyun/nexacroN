(function()
{
    return function(nexacro, system, trace)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Button("btnSave","73","32","67","31",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("정상 전송");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("Button00","153","32","187","34",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("jsp에서 errorcde -1로 던질경우");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("Button00_00","350","32","160","34",null,null,null,null,null,null,this);
            obj.set_taborder("6");
        ...
        // User Script
        this.registerScript("FileUpTransfer_FileDownTransfer_Sample10.xfdl", function(nexacro, system, trace) {
        ...
        this.btnSave_onclick = function(obj,e)
        {
        	...
        	this.uploadfile_temp("test1");
        };

        this.Button00_onclick = function(obj,e)
        {
        	this.uploadfile_temp("test2");
        }

        this.Button00_00_onclick = function(obj,e)
        {
        	this.uploadfile_temp("test3");
        };
        ...
        this.uploadfile_temp = function(flag,returntype)
        {
        	...
        	/*
        	const req = this.uploadfile_temp("test1",this.flg);
        	if (req)
        	{
        		req.then(([ErrorCode,ErrorMsg]) => {
        			this.TextArea00.insertText("✅ 전송완료 : req.then 이후 확인 errorcode= ["+ErrorCode+"], errormessage = ["+ErrorMsg +"]\n");
        ...
        this.loadIncludeScript("FileUpTransfer_FileDownTransfer_Sample10.xfdl");
