(function()
{
    return function(nexacro, system, trace)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Button("Button00","285","35","140","30",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("getAllResponseHeaders");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("Button00_00","435","35","140","30",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("getResponseHeader");
            this.addChild(obj.name, obj);
            ...
            obj = new nexacro.Button("btnSearch00","130","34","100","31",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("downloadAll");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("FileUpTransfer_FileDownTransfer_Sample07.xfdl", function(nexacro, system, trace) {
        ...
        this.downloadfileAll = function()
        {
        	...
        	this.fileDownTrans.download(this.saveUrl+"fileDownload_postdatatest.jsp" + encVar,"promise");
        ...
        this.Button00_onclick = function(obj,e)
        {
        	...
        	this.TextArea00.insertText(typeof(res));
        // 	if (!res)
        // 		return;
        //
        ...
        this.Button00_00_onclick = function(obj,e)
        {
        	...
        	const res = this.fileDownTrans.getAllResponseHeaders();
         	...
         	Object.keys(res).forEach(key => {
        		const value = res[key];
        		if(key == "jsp_download_header"){
        			trace(`${key} : ${value}`);
        			this.TextArea00.insertText('getResponseHeader(' + key + ') => ' + this.fileDownTrans.getResponseHeader(key)+"\n");
        		}
        ...
        this.loadIncludeScript("FileUpTransfer_FileDownTransfer_Sample07.xfdl");
