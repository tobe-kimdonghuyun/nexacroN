(function()
{
    return function(nexacro, system, trace)
    {
        ...
        // User Script
        this.registerScript("FileUpTransfer_FileDownTransfer_Sample03.xfdl", function(nexacro, system, trace) {
        ...
        this.loadIncludeScript("FileUpTransfer_FileDownTransfer_Sample03.xfdl");
