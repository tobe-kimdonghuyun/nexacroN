(function()
{
    return function(nexacro, system, trace)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Button("Button00_00","115","33","80","30",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("download");
            this.addChild(obj.name, obj);

            obj = new nexacro.Button("Button00_00_00","205","33","210","30",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("download( [strUrl [, strTargetpath]] )");
            this.addChild(obj.name, obj);

            obj = new nexacro.TextArea("TextArea00","10","286","820","264",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("FileUpTransfer_FileDownTransfer_Sample06.xfdl", function(nexacro, system, trace) {
        ...
        this.Button00_00_00_onclick = function(obj,e)
        {
        	...
        	else
        	{
        		if(system.navigatorname == "Chrome")
        			this.fileDownTrans.download("http://172.10.12.45:9090/fileSample/"+this.dsUpload.getColumn(0,"FILE_NAME"), "%USERAPP%"+this.dsUpload.getColumn(0,"FILE_NAME"));
        		else
        			this.fileDownTrans.download("http://172.10.12.45:9090/fileSample/"+this.dsUpload.getColumn(0,"FILE_NAME"), "%DOCUMENT%"+this.dsUpload.getColumn(0,"FILE_NAME"));
        	}
        };
        ...
        this.loadIncludeScript("FileUpTransfer_FileDownTransfer_Sample06.xfdl");
