(function()
{
    return function(nexacro, system, trace)
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new nexacro.Button("Button00","110","32","310","30",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("getHTTPHeaderVariable(\"header0\");");
            this.addChild(obj.name, obj);

            obj = new nexacro.TextArea("TextArea00","12","289","379","151",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("FileUpTransfer_FileDownTransfer_Sample01.xfdl", function(nexacro, system, trace) {
        ...
        {
        	//this.TextArea00.insertText(nexacro.getAllResponseHeaders());
        	this.TextArea00.deleteText();
        	this.TextArea00.insertText("nexacro.getHTTPHeaderVariable('header0')="+nexacro.getHTTPHeaderVariable("header0")+"\n");
        	this.TextArea00.insertText("nexacro.getHTTPHeaderVariable('dynamicHTTP')="+nexacro.getHTTPHeaderVariable("dynamicHTTP")+"\n");
        	/*
        ...
        this.uploadfile = function(returntype)
        {
        	...
        	//file upload
        	return this.fileUpTrans.upload(this.saveUrl +"fileUpload_postdatatest2.jsp?filefolder="+this.folderName, returntype);
        }
        ...
        this.loadIncludeScript("FileUpTransfer_FileDownTransfer_Sample01.xfdl");
