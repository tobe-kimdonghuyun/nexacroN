    ...
    _pControlElement.createCommandStart = function ()
    {
        if (!this._is_popup)
        {
            ...
            if (owner_elem && !this.handle)
            {
                ...
                {
                    str += " title = '" + this.tooltiptext.replaceAll("'", "&apos;") + "' ";
                }
    ...
    */
    ...
    _pScrollableControlElement._on_updateClientRect = function ()
    {
        ...
        */
        ...
        {
            if (this._is_expand && (expandbartype == "fixed" || expandbartype == "const"))
            {
                if (zclient_width > 0)
                {
                    if (expanddirtype == "horz" || expanddirtype == "auto")
...
//	        if (this.left || this.top)
    ...
    * position 이동  : 터치시 화면반응속도 중간, 스크롤속도 중간, 화면출렁거림 거의없음 (노드량이 많으면 느려질 수 있음)
        ...
        if (owner_elem && !this.handle)
        {
            ...
            if (contentsType != ContentType.EMPTY)
            {
                ...
                if (contentsType != ContentType.TEXT)
                {
                    ...
                    command += "<img id='" + this.name + ContentSuffix.ICON + "' " + nexacro.__getDOMNode_Alt("");
                    command += (icon_style) ? (" style='" + icon_style + "'") : "";
                    command += " class='" + this._getElementNexaClassName("nexaiconitem", undefined, "img") + "' src='" + this.icon._sysurl + "'/>";
                }
    ...
    _pIconTextControlElement._createContents = function (handle)
    {
        ...
        if (contentsType != ContentType.EMPTY)
        {
            if (handle)
            {
                ...
                if (contentsType != ContentType.TEXT)
                {
                    icon_node = doc.createElement("img");
    ...
    _pIconTextControlElement._getContentsType = function ()
    {
        ...
        const { icon, text, iconPos, verticalAlign, textAlign } = this;
