   ...
   PlatformResponse platformResponse = new PlatformResponse(response.getOutputStream(), PlatformType.CONTENT_TYPE_XML, strCharset);
    ...
    try {
        ...
        for(int i = 1; i <= 10; i++) {
            ...
            outDataSet.set(nRow, "Column0",     "1NNNNN");
            outDataSet.set(nRow, "Column1", "aaaNNNNN");
			
			nRow = outDataSet.newRow();
            outDataSet.set(nRow, "Column0",     "2NNNNN");
            outDataSet.set(nRow, "Column1", "bbbNNNNN");
			
			nRow = outDataSet.newRow();
            outDataSet.set(nRow, "Column0",     "3NNNNN");
            outDataSet.set(nRow, "Column1", "cccNNNNN");
			
			nRow = outDataSet.newRow();
            outDataSet.set(nRow, "Column0",     "4NNNNN");
            outDataSet.set(nRow, "Column1", "dddNNNNN");
			
			nRow = outDataSet.newRow();
            outDataSet.set(nRow, "Column0",     "5NNNNN");
            outDataSet.set(nRow, "Column1", "eeeNNNNN");
            nRow = outDataSet.newRow();
            outDataSet.set(nRow, "Column0",     "6NNNNN");
            outDataSet.set(nRow, "Column1", "gggNNNNN");
        }
