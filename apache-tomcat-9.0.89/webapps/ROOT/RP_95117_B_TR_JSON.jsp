...
<%
     ...
     *********************************************************/     
    PlatformRequest platformRequest = new PlatformRequest(request.getInputStream(), PlatformType.CONTENT_TYPE_JSON);
    ...
    System.out.println("1111nCount==>" + inVariableList.getString("nCount")); 
    System.out.println("2222argu0==>" + inVariableList.getString("argu0")); 
    System.out.println("3333argu1==>" + inVariableList.getString("argu1")); 
    
    DataSet ds = inDataSetList.get("input");
    DataSet ds2 = inDataSetList.get("input2");   	
    DataSet ds3 = inDataSetList.get("input3");   	   	
	
    //System.out.println("input : " + ds.saveXml()); 
    ...
    PlatformResponse platformResponse = new PlatformResponse(response.getOutputStream(), PlatformType.CONTENT_TYPE_JSON, strCharset);   
