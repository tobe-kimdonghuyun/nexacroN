...
<%
	...
	wrapped.setHeader("dynamicHTTP", "jsp change value");
	// 변경된 헤더 값 확인
	String myHeaderValue = wrapped.getHeader("header0");
	String myHeaderValue_2 = wrapped.getHeader("dynamicHTTP");
	System.out.println("header0 값: " + myHeaderValue);
	System.out.println("dynamicHTTP 값: " + myHeaderValue_2);

	// 변경된 헤더 값을 HTTP 응답 헤더에 반영 (패킷에서 확인 가능)
	response.setHeader("header0", myHeaderValue);
	response.setHeader("dynamicHTTP", myHeaderValue_2);
