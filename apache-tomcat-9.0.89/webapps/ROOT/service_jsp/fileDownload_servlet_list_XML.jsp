...
<% 
	String filePath = request.getRealPath("./nexacro17/FileSample") + "/"; //파일이 존재하는 실제경로
	String url = request.getRequestURL().substring(0, request.getRequestURL().lastIndexOf("/") - 3) + "FileSample/";
