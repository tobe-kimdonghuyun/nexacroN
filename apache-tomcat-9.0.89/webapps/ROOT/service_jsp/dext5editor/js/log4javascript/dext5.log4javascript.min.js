if(!window.DEXT5Solution){window.DEXT5Solution=function(){Array.prototype.shift||(Array.prototype.shift=function(){if(0<this.length){for(var d=this[0],c=0,f=this.length-1;c<f;c++)this[c]=this[c+1];this.length--;return d}});var h={log4javascript:null,logType:"console",consoleLog:null,initConsoleLog:function(){this.consoleLog=window.console||{log:function(){}}},writeLog:function(d,c,f,h){c=c.toLowerCase();null!=h&&0<h.length?f+=", param: "+Array.prototype.slice.call(h,0).join(", "):null==h&&(f+=", param: null");
switch(c){case "info":dext5SolutionLog.info(d+" "+f);break;case "trace":dext5SolutionLog.trace(d+" "+f);break;case "debug":dext5SolutionLog.debug(d+" "+f);break;case "warn":dext5SolutionLog.warn(d+" "+f);break;case "error":dext5SolutionLog.error(d+" "+f);break;case "fatal":dext5SolutionLog.fatal(d+" "+f)}},InitializationLog:function(){function d(){function a(g){try{return Boolean(g.loaded)}catch(b){return!1}}function f(){var d=setInterval(function(){k?clearInterval(d):Boolean(e)&&a(e)&&(clearInterval(d),
k=!0,b())},100)}function c(){try{if("console"==h.logType)return!0;if(!d){if(e.closed)return d=!0,!1;!k&&e.loaded&&(k=!0)}return k&&!d}catch(a){return d=!0,!1}}function q(a,g){for(var b=""+a;b.length<g;)b="0"+b;return b}function b(){if(c())for(;0<l.length;){for(var a=l.shift(),g=a.timeStamp,g=q(g.getHours(),2)+":"+q(g.getMinutes(),2)+":"+q(g.getSeconds(),2)+" ",b=a.level.name;5>b.length;)b+=" ";g=g+b+" - "+a.getCombinedMessages();(b=a.getThrowableStrRep())&&(g+="\r\n"+b);-1<g.indexOf("#separator#")&&
...
'<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">',"\t<head>","\t\t<title>DEXT5 Solution Log</title>",'\t\t<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />',"\t\t\x3c!-- Make IE8 behave like IE7, having gone to all the trouble of making IE work --\x3e",'\t\t<meta http-equiv="X-UA-Compatible" content="IE=7" />','\t\t<script type="text/javascript">',"\t\t\t//<![CDATA[","\t\t\tvar loggingEnabled = true;","\t\t\tvar messagesBeforeDocLoaded = [];","","\t\t\tfunction toggleLoggingEnabled() {",
