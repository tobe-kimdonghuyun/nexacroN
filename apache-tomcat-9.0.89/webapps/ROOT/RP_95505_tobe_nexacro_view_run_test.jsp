...
<SCRIPT LANGUAGE="javascript">
	function fn_onload() {
		...
		NexacroLauncher.bjson = "http://172.10.12.45:9090/nexacro14/14.0.1.4202/mdi_test/start.json";
		...
		NexacroAXCtrl.bjson = "http://172.10.12.45:9090/nexacro14/14.0.1.4202/mdi_test/start.json";	//http://localhost:8080/dbcc/
