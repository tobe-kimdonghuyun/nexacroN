...
/***** 엔진 및 런처 정보 *****/
//런처 서비스 버전 정보
var strLauncherVersion = "1,1,0,40";

//런처 서비스 설치 파일명
var strLauncherFileName = "TPLSvc_Setup.exe";

//런처 서비스 웹소켓 방식 사용 여부 true:사용, false:사용안함(https통신)
var bWebsocketUse = false;

//엔진 버전 정보
var strVersion = "21.0.0.1313";

//window32bit 엔진 key
var strEnginesetupkey32 = "{3D10EE09-348B-4B0B-AD04-69A3CE921D1C}";

//window64bit 엔진 key
var strEnginesetupkey64 = "{3E221E7D-2ECF-4EF4-AD16-C69972112C86}";
...
//이미지 및 아이콘 파일 경로
var strLoadingimage = "";//strServerPath + "service/install/dev/img/loading_img.gif";   
var strSplashimage = "";//strServerPath + "service/install/dev/img/loading_img.gif";
var strWallpapericon = strServerPath + "service/install/perf/img/seegene_icon_P256.ico";

/***** 프로젝트 속성 정보 *****/
//project key value
var strKey = "Seegene_perf";

//프로젝트 부트스트랩(start.json) 파일 경로
var strBjson = strServerPath + "start.json";

//Component 경로 (%USERAPPLOCAL% = C:\Users\[UserName]\AppData\Local)
var strComponentPath = "%USERAPPLOCAL%\\Component\\";  
		...
		else if(strAction == "method") 
		{
			if(objNexacro.result == "success") 
			{
				...
				else if(objNexacro.value.getengineversion) 
				{
					...
					var strEgineVer = reg.test(strRtnEngineVer);
					
					if (!strEgineVer || strRtnEngineVer == "") 
					//if (!strRtnEngineVer || strRtnEngineVer == "")
					{						
						fnDownloadEngine();
					} 
					else 
