...
var strWallpapericon = strServerPath + "service/install/images/seegene_icon_S256_0119.ico";
var strSetupResourcePath = strServerPath+ "service/install/staging/engine";
var bSetupResource = true;

/***** 프로젝트 속성 정보 *****/
//project key value
var strKey = "차세대LIS_staging";
var strWallpapername = "SeeLIS 기준정보시스템";
...
function fnSetActionMethod(strMethod)
{
	...
	if(strMethod == 'makeshortcut')
	{
		...
		{
			"makeshortcut": {
				"param": [strWallpapername, strWallpapericon, "", strWallpaperposition, false]
			}
		};
	}
	...
	else if(strMethod == 'isexistshortcut')
	{
		...
		objNexacro.value = {
			"isexistshortcut": {
				"param": [strWallpapername, "startmenu", true],
				"result": null
			}
		};
	}
