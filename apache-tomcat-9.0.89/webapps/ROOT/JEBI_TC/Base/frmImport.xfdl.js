(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "check","type" : "INT","size" : "256"},{"id" : "sheetKey","type" : "STRING","size" : "256"},{"id" : "sheetData","type" : "STRING","size" : "256"},{"id" : "browser","type" : "STRING","size" : "256"}]}});
            this.addChild(obj.name, obj);
