(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "actionCode","type" : "STRING","size" : "256"},{"id" : "actionData","type" : "STRING","size" : "256"}]}});
            this.addChild(obj.name, obj);


            obj = new Dataset("dsDomList", this);
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "nodeName","type" : "STRING","size" : "256"},{"id" : "nodeId","type" : "STRING","size" : "256"},{"id" : "Column0","type" : "STRING","size" : "256"}]}});
            this.addChild(obj.name, obj);
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "compareCode","type" : "STRING","size" : "256"},{"id" : "compareData","type" : "STRING","size" : "256"}]}});
            this.addChild(obj.name, obj);
        ...
        this.dsAction_onload = function(obj,e)
        {

        };

        this.dsTC_oncolumnchanged = function(obj,e)
        {

        	if(e.columnid == "action")
        	{
        		if(e.newvalue == '2' ||e.newvalue == '10' || e.newvalue == '11'|| e.newvalue == '12'){
        			this.dsTC.setColumn(e.row,'type',"all");
        			this.dsTC.setColumn(e.row,'element',"");
        		}
        		else{
        			this.dsTC.setColumn(e.row,'type',"id");
        		}
        	}
        };

        this.txtDescription_onkeydown = function(obj,e)
        {
        	if(e.altkey == true){
        		if(e.keycode === 13){
        			this.btnExport_onclick();
        			this.btnCopyRow.setFocus();
        		}
        	}
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.txtDescription.addEventHandler("onkeydown",this.txtDescription_onkeydown,this);
            ...
            this.dsTC.addEventHandler("oncolumnchanged",this.dsTC_oncolumnchanged,this);
        };
