(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "testscript_no","type" : "STRING","size" : "256"},{"id" : "testscript_id","type" : "STRING","size" : "256"},{"id" : "description","type" : "STRING","size" : "256"},{"id" : "browser","type" : "STRING","size" : "256"},{"id" : "type","type" : "STRING","size" : "256"},{"id" : "action","type" : "STRING","size" : "256"},{"id" : "element","type" : "STRING","size" : "256"},{"id" : "dictionaryKey","type" : "STRING","size" : "256"},{"id" : "count","type" : "STRING","size" : "256"},{"id" : "time","type" : "STRING","size" : "256"},{"id" : "input","type" : "STRING","size" : "256"},{"id" : "zoom","type" : "STRING","size" : "256"},{"id" : "ime","type" : "STRING","size" : "256"},{"id" : "key","type" : "STRING","size" : "256"},{"id" : "compareType","type" : "STRING","size" : "256"},{"id" : "resultValue","type" : "STRING","size" : "256"},{"id" : "expectValue","type" : "STRING","size" : "256"},{"id" : "expectUI","type" : "STRING","size" : "256"}]},"Rows" : [{}]});
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "actionCode","type" : "STRING","size" : "256"},{"id" : "actionData","type" : "STRING","size" : "256"}]},"Rows" : [{"actionCode" : "0","actionData" : "click"},{"actionCode" : "1","actionData" : "input"},{"actionData" : "tab","actionCode" : "2"},{"actionData" : "scroll","actionCode" : "3"},{"actionData" : "sleep","actionCode" : "4"},{"actionData" : "compare","actionCode" : "5"},{"actionData" : "screenShot","actionCode" : "6"}]});
            this.addChild(obj.name, obj);


            obj = new Dataset("dsCompareType", this);
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "typeCode","type" : "STRING","size" : "256"},{"id" : "typeData","type" : "STRING","size" : "256"}]},"Rows" : [{"typeData" : "textValue","typeCode" : "0"},{"typeData" : "comboValue","typeCode" : "2"},{"typeData" : "ui","typeCode" : "3"},{"typeData" : "checkStatus","typeCode" : "4"},{"typeData" : "positon","typeCode" : "5"}]});
            this.addChild(obj.name, obj);
