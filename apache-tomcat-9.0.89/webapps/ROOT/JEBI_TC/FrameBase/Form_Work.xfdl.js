(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "url","type" : "STRING","size" : "256"}]},"Rows" : [{}]});
