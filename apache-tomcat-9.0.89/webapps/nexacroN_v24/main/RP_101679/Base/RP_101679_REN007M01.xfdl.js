(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("RP_101679_REN007M01.xfdl", function() {
        /**
        ...
        *******************************************************************************************************************************/
        ...
        // 	this.divForm.form.Div00.form.resetScroll();
        ...
        *******************************************************************************************************************************/
        ...
        this.dsList_oncolumnchanged = function(obj,e)
        {
        	...
        	if (!this.gfnIsNull(this.param.bzentyNm)) {
        		for (var i=0; i< this.dsList.rowcount; i++) {
        			...
        			} else if (this.dsList.getColumn(i,"hireYnCd") == 2) {
        ...
        this.loadIncludeScript("RP_101679_REN007M01.xfdl");
