(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("0");
            obj.set_text("TAB키로 이동 시 displaynulltext 읽지 않음");
            this.addChild(obj.name, obj);

            obj = new Static("Static00_00_01","0","140","140","30",null,null,null,null,null,null,this);
            ...
            obj = new Edit("edtUserNm","0","179","626","50",null,null,null,null,null,null,this);
            ...
            obj.set_accessibilityaction("액션");
            obj.set_accessibilitydescription("디스크립션");
            this.addChild(obj.name, obj);

            obj = new Static("Static00_00_01_00","666","140","140","30",null,null,null,null,null,null,this);
            obj.set_initvalueid("iv_StaticE");
            obj.set_taborder("3");
            ...
            obj = new Edit("edtEmail","666","179","626","50",null,null,null,null,null,null,this);
            obj.set_initvalueid("iv_EditE");
            obj.set_taborder("4");
            obj.set_cssclass("edt_WF_reply");
            ...
            obj = new BindItem("item0","edtUserNm","value","ds_ParamId","user_nm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","edtEmail","value","ds_ParamId","email_id");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("rp101459.xfdl", function() {
        ...
        this.loadIncludeScript("rp101459.xfdl");
