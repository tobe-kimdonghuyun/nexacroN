(function()
{
    return function()
    {
        ...
        *******************************************************************************************************************************/
        ...
        {
        // 	this.parent.parent.divForm00.url = "work::CST/TSC_test/CST002S02.xfdl";
        // 	this.parent.parent.divForm00_00.url = "work::CST/TSC_test/CST002S03.xfdl";
        // 	this.parent.parent.divForm00_00_00.url = "work::CST/TSC_test/CST002S05.xfdl";
        // 	this.parent.parent.divForm00_00_00_00.url = "work::CST/TSC_test/CST002S04.xfdl";
        	...
        	//trace(this.name + "CST002S01 : " + this.cfnGetAtrb.getRowCount());
        ...
        *******************************************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.dstest.addEventHandler("onvaluechanged",this.dstest_onvaluechanged,this);
        };
