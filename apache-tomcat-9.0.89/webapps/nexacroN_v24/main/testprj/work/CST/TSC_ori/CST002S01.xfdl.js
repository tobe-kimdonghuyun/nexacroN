(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new BindItem("item13","divAplcntInfo.form.staLabel01_00","cssclass","dsAtrb","ccTAS00233");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item14","divAplcntInfo.form.staLabel03_00_01","cssclass","dsAtrb","ccTAS00233");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item15","divAplcntInfo.form.staLabel03_00_00_00","cssclass","dsAtrb","ccTAS00233");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item16","divAplcntInfo.form.staLabel05_00_00","cssclass","dsAtrb","ccTAS00233");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item17","divAplcntInfo.form.staLabel05_01_00","cssclass","dsAtrb","ccTAS00233");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item22","divAplcntInfo.form.rdoCtrtChcYn","readonly","dsAtrb","roTAS00233");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item23","divAplcntInfo.form.cmbBldgSeCd","readonly","dsAtrb","roTAS00233");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item24","divAplcntInfo.form.edt00_02_00_00_00","readonly","dsAtrb","roTAS00233");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item25","divAplcntInfo.form.edt00_03_01_00_00_00","readonly","dsAtrb","roTAS00233");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item26","divAplcntInfo.form.edtHwrtInptPstnInfoCn","readonly","dsAtrb","roTAS00233");
            this.addChild(obj.name, obj);
            obj.bind();
