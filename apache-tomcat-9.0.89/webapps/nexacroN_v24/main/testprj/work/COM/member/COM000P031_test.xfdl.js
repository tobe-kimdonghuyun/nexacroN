(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("Div00","0","0","800","550",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("Div00");
            this.addChild(obj.name, obj);

            obj = new Static("staState","20","20",null,"30","20",null,null,null,null,null,this.Div00.form);
            obj.set_taborder("0");
            obj.set_text("표는 필수 입력 사항입니다.");
            obj.set_cssclass("sta_WF_EsentialTxt");
            this.Div00.addChild(obj.name, obj);

            obj = new Button("Button00_00","80","75","420","90",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("1");
            obj.set_text("회원가입 신청");
            obj.set_cssclass("btn_WF_Yes");
            this.Div00.addChild(obj.name, obj);

            obj = new Button("Button00_00_00","80","190","420","90",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("2");
            obj.set_text("회원가입 신청_ori");
            obj.set_cssclass("btn_WF_Yes");
            this.Div00.addChild(obj.name, obj);

            obj = new Button("Button00_00_00_00","80","310","420","90",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("3");
            obj.set_text("회원가입 신청_ori_backgound");
            obj.set_cssclass("btn_WF_Yes");
            this.Div00.addChild(obj.name, obj);

            obj = new Button("Button00","538","81","176","78",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("4");
            obj.set_text("DIV 테스트");
            this.Div00.addChild(obj.name, obj);

            obj = new Div("Div01","0","0","800","650",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Div01");
            ...
            //-- Default Layout : this
            obj = new Layout("default","Desktop_screen,Phone_screen",600,550,this,function(p){});
        ...
        // User Script
        this.registerScript("COM000P031_test.xfdl", function() {
        /********************************************************************
            created:	  2024/08/08
        ...
        *******************************************************************************************************************************/
        this.form_onload = function(obj,e)
        {
        	...
        	this.parent.titlebar.normalbutton.visible = false;


        	this.Div01.url = "work::COM/member/COM000P032_ori.xfdl";
        ...
        //
        // 	this.fnInit();
        	//this.Div00.form.Button00.visible
        ...
        *******************************************************************************************************************************/
        ...
        this.Div01_Button00_onclick = function(obj,e)
        {
        	...
        	this.parent.titlebar.maxbutton.width = 0;
        	this.parent.titlebar.maxbutton.height = 0;

        	this.parent.titlebar.normalbutton.width = 0;
        	this.parent.titlebar.normalbutton.height = 0;
        	//this.parent.titlebar.minbutton = null;
        	//this.parent.titlebar.maxbutton = null;

        	this.parent.titlebar.titleicon.set_text("회원가입");
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onsize",this.COM000P032_onsize,this);
            this.Div00.form.Button00_00.addEventHandler("onclick",this.divPopBtn_Button00_00_onclick,this);
            this.Div00.form.Button00_00_00.addEventHandler("onclick",this.Button00_00_00_onclick,this);
            this.Div00.form.Button00_00_00_00.addEventHandler("onclick",this.Button00_00_00_00_onclick,this);
            this.Div00.form.Button00.addEventHandler("onclick",this.Div01_Button00_onclick,this);
        };
        this.loadIncludeScript("COM000P031_test.xfdl");
