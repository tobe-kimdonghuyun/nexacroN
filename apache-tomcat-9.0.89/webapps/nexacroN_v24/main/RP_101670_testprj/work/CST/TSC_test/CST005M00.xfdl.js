(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            divBtn_form_cmbTest_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">TAS00246</Col><Col id=\"datacolumn\">TAS00246 신청서작성</Col></Row><Row><Col id=\"codecolumn\">TAS00488</Col><Col id=\"datacolumn\">TAS00488 신청서보완</Col></Row><Row><Col id=\"codecolumn\">TAS00248</Col><Col id=\"datacolumn\">TAS00248 담당자접수</Col></Row><Row><Col id=\"codecolumn\">TAS00476</Col><Col id=\"datacolumn\">TAS00476 사전미팅확인</Col></Row><Row><Col id=\"codecolumn\">TAS00477</Col><Col id=\"datacolumn\">TAS00477 관련부서처리</Col></Row><Row><Col id=\"codecolumn\">TAS00249</Col><Col id=\"datacolumn\">TAS00249 일정협의</Col></Row><Row><Col id=\"codecolumn\">TAS00251</Col><Col id=\"datacolumn\">TAS00251 착공승인검토</Col></Row><Row><Col id=\"codecolumn\">TAS00324</Col><Col id=\"datacolumn\">TAS00324 관련부서처리</Col></Row><Row><Col id=\"codecolumn\">TAS00325</Col><Col id=\"datacolumn\">TAS00325 검토및승인</Col></Row><Row><Col id=\"codecolumn\">TAS10424</Col><Col id=\"datacolumn\">TAS10424 원상회복확인요청</Col></Row><Row><Col id=\"codecolumn\">TAS00255</Col><Col id=\"datacolumn\">TAS00255 원상회복확인</Col></Row><Row><Col id=\"codecolumn\">TAS00328</Col><Col id=\"datacolumn\">TAS00328 관련부서처리</Col></Row><Row><Col id=\"codecolumn\">TAS10423</Col><Col id=\"datacolumn\">TAS10423 신청자조치사항보완</Col></Row><Row><Col id=\"codecolumn\">TAS00329</Col><Col id=\"datacolumn\">TAS00329 검토및심사</Col></Row><Row><Col id=\"codecolumn\">TAS10455</Col><Col id=\"datacolumn\">TAS10455 조건부완료</Col></Row><Row><Col id=\"codecolumn\">TAS00323</Col><Col id=\"datacolumn\">TAS00323 만족도조사</Col></Row><Row><Col id=\"codecolumn\">TAS00256</Col><Col id=\"datacolumn\">TAS00256 종료</Col></Row></Rows>");
            ...
            obj.set_async("false");
            obj.set_url("work::CST/TSC/CST005S02.xfdl");
            this.addChild(obj.name, obj);
            ...
            obj.set_async("false");
            obj.set_url("work::CST/TSC/CST005S03.xfdl");
            this.addChild(obj.name, obj);
            ...
            obj.set_async("false");
            obj.set_url("work::CST/TSC/CST005S05.xfdl");
            this.addChild(obj.name, obj);
            ...
            obj.set_async("false");
            obj.set_url("work::CST/TSC/CST005S04.xfdl");
            this.addChild(obj.name, obj);
            // Layout Functions
            ...
            obj = new Layout("default","Desktop_screen",1480,900,this,
                ...
                p.divForm00.set_url("work::CST/TSC/CST005S02.xfdl");
                ...
                p.divForm00_00.set_url("work::CST/TSC/CST005S03.xfdl");
                ...
                p.divForm00_00_00.set_url("work::CST/TSC/CST005S05.xfdl");
                ...
                p.divForm00_00_00_00.set_url("work::CST/TSC/CST005S04.xfdl");
        ...
        this.loadPreloadList = function()
        {
            ...
            this._addPreloadList("fdl","work::CST/TSC/CST005S02.xfdl");
            this._addPreloadList("fdl","work::CST/TSC/CST005S03.xfdl");
            this._addPreloadList("fdl","work::CST/TSC/CST005S05.xfdl");
            this._addPreloadList("fdl","work::CST/TSC/CST005S04.xfdl");
        };
        ...
        *******************************************************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
            ...
            // 전달받은 데이터 확인 및 처리
        	var pvAplyNo = this.getOwnerFrame().pvAplyNo; // || "TSC2410_00001";   // 신청번호
        ...
        this.cfnSrvcCall = function(srvcId) {
        	...
        	switch(strSrvcId)
        	{
        		case "select" :  // 조회
        			...
        			outData   = "dsMst=dsMst dsRtosAplcfm=dsRtosAplcfm dsCnvyMttr=dsCnvyMttr dsAtfl=dsAtfl dsTaskPrcsFlwWf=dsTaskPrcsFlwWf dsRvwOpnn=dsRvwOpnn";
        			break;
