(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.divGuide00.form.addLayout(obj.name, obj);
            //-- Default Layout : this
            obj = new Layout("default","Desktop_screen,Phone_screen,desktop",1480,1800,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
        ...
        // User Script
        this.addIncludeScript("LIF052M00_1.xfdl","xjs::TaskCom.xjs");
        this.registerScript("LIF052M00_1.xfdl", function() {
        /**
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("LIF052M00_1.xfdl");
