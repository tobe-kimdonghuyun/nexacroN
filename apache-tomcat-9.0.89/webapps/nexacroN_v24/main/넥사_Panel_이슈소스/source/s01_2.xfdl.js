(function()
{
    return function()
    {
        ...
        {
            this.set_name("s01_2");
            this.set_titletext("URL아이템 불러오기 2 [Div & Panel]");
            ...
            obj = new Panel("Panel00","0","0",null,"150","0",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_fittocontents("height");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"Div00\"/></Contents>");
            this.addChild(obj.name, obj);

            obj = new Div("Div00","10","10","1280","150",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Div00");
            ...
            obj.set_taborder("2");
            obj.set_text("<b v=\'true\'>[Div를 Panel로 감싸면]</b> URL로 s01.xfdl을 불러왔을 때 <b v=\'true\'>높이 조절이 안됨</b>");
        ...
        this.loadIncludeScript("s01_2.xfdl");
