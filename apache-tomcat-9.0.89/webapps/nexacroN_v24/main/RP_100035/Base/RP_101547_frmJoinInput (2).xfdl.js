(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new MaskEdit("MaskEdit00_00","70","Static00_02_01_00_00_00_00_00:-45",null,"60","70",null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_cssclass("msk_WF_TxtLeft");
            ...
            obj = new Button("Button00_01",null,"1324","123","60","70",null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_text("주소검색");
            this.addChild(obj.name, obj);
            ...
            obj = new Combo("Combo00_00",null,"Static00_02_01_00_00_00_00_00_00_00_00:15","45%","60","70",null,null,null,null,null,this);
            obj.set_taborder("35");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_accessibilityaction("alt+아래방향키 선택 후 ctrl+방향키로 값 선택 엔터 탭키 이동");
            ...
            obj = new Static("Static00_02_00","323.00","2497","476","77",null,null,null,null,null,null,this);
            obj.set_taborder("39");
        ...
        this.loadIncludeScript("RP_101547_frmJoinInput (2).xfdl");
