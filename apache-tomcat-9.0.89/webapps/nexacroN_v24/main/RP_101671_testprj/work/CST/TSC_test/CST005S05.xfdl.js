(function()
{
    return function()
    {
        ...
        {
            this.set_name("CST005S06");
            this.set_titletext("만족도조사(퇴거)");
        ...
        // User Script
        this.addIncludeScript("CST005S05.xfdl","xjs::TaskCom.xjs");
        this.registerScript("CST005S05.xfdl", function() {
        /**
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("CST005S05.xfdl");
