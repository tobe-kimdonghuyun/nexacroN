(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"deptId\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"deptId\">1</Col></Row><Row><Col id=\"deptId\">2</Col></Row><Row><Col id=\"deptId\">3</Col></Row><Row><Col id=\"deptId\">4</Col></Row><Row><Col id=\"deptId\">5</Col></Row><Row><Col id=\"deptId\">6</Col></Row><Row><Col id=\"deptId\">7</Col></Row><Row><Col id=\"deptId\">8</Col></Row><Row><Col id=\"deptId\">9</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("Button00","1079","10","155","19",null,null,null,null,null,null,this.divForm.form.div00.form);
            obj.set_taborder("2");
            ...
            obj = new Static("staLabel02","489","14","150","40",null,null,null,null,null,null,this.divForm.form.divSch00.form);
            obj.set_taborder("1");
            ...
            obj = new Layout("default","",0,0,this.divForm.form.tabSlm.tpg01.form,
                ...
                p.grpList.set_binddataset("dsTest");
            ...
            obj = new Layout("default","",0,0,this.divForm.form.div00.form,
                ...
                p.Button00.move("1079","10","155","19",null,null);
            	}
            );
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divSch00.form,
                ...
                p.staLabel02.set_flexshrink("0");
                p.staLabel02.set_maxwidth("");
                p.staLabel02.move("489","14","150","40",null,null);
        ...
        // User Script
        this.registerScript("COM021M01.xfdl", function() {
        /**
        *  PcMdi 프로젝트
        ...
        *******************************************************************************************************************************/
        ...
        this.divForm_div00_Button00_onclick = function(obj,e)
        {
        	trace(this.divForm.form.divSch00.form.DivCal03.form.cmbNotEvlScrCrtr.width);
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.divForm.form.div00.form.Button00.addEventHandler("onclick",this.divForm_div00_Button00_onclick,this);
        ...
        this.loadIncludeScript("COM021M01.xfdl");
