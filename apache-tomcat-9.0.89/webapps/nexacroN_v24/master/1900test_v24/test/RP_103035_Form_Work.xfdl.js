(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("Div00","60","145","443","135",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Div00");
            ...
            obj = new Layout("default","",0,0,this.Div00.form,
                ...
                p.sta03.set_text("학교간 소통");
                p.sta03.set_cssclass("sta_MF_ImgTxt");
                p.sta03.set_usedecorate("false");
            ...
            this.Div00.form.addLayout(obj.name, obj);
            //-- Default Layout : this
            obj = new Layout("default","desktopScr,Desktop_screen,Screen0,Screen1",1320,550,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                ...
                p.Div00.move("60","145","443","135",null,null);
            	}
            );
        ...
        this.loadIncludeScript("RP_103035_Form_Work.xfdl");
