(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"Column0\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"Column0\">우리나라1</Col></Row><Row><Col id=\"Column0\">우리나라2</Col></Row><Row><Col id=\"Column0\">우리나라3</Col></Row></Rows>");
        ...
        // User Script
        this.registerScript("comm_extCombo_copy0.xfdl", function() {
        ...
        this.loadIncludeScript("comm_extCombo_copy0.xfdl");
