if (nexacro.Environment)
{
    ...
    {
        this.set_themeid("theme::TobesoftPro");
        this.set_datatyperule("2.0");
        this.set_userfontid("font::Pretendard.xfont");
    };
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("proPortal", "file", "./_extlib_/proPortalLib/", "session", null, "", "0", "0");
        ...
        nexacro._addService("svcUrl", "JSP", "http://localhost:8080/", "session", null, "", "0", "0");
        nexacro._addService("prst", "form", "./prst/", "session", null, "", "0", "0");
