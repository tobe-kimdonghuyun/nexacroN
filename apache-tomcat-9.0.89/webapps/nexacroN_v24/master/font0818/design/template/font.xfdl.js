(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta00_00","30","50","590","300",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("가나다라마바사아자차카타파하\r\n갈날달랄말발\r\n투비소프트 폰트 테스트\r\n\r\n0123456789\r\n\r\nABCDEFGHIJKLMNOPQRSTUVWXYZ\r\nabcdefghijklmnopqrstuvwxyz");
            obj.set_cssclass("sta_M13");
            this.addChild(obj.name, obj);

            obj = new Static("sta00_00_00","580","50","590","300",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("가나다라마바사아자차카타파하\r\n갈날달랄말발\r\n투비소프트 폰트 테스트\r\n\r\n0123456789\r\n\r\nABCDEFGHIJKLMNOPQRSTUVWXYZ\r\nabcdefghijklmnopqrstuvwxyz");
            ...
            obj = new Static("sta00_00_01","580","350","400","300",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("가나다라마바사아자차카타파하\r\n갈날달랄말발\r\n투비소프트 폰트 테스트\r\n\r\n0123456789\r\n\r\nABCDEFGHIJKLMNOPQRSTUVWXYZ\r\nabcdefghijklmnopqrstuvwxyz");
            ...
            obj = new Static("sta00_00_01_00","580","650","400","300",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("가나다라마바사아자차카타파하\r\n갈날달랄말발\r\n투비소프트 폰트 테스트\r\n\r\n0123456789\r\n\r\nABCDEFGHIJKLMNOPQRSTUVWXYZ\r\nabcdefghijklmnopqrstuvwxyz");
