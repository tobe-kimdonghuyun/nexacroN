(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnAdd","12","32","47","31",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("추가");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid00","10","71","820","201",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Button("btnSave","61","32","47","31",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("전송");
            this.addChild(obj.name, obj);

            obj = new ProgressBar("ProgressBar00","610","32","200","31",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_min("0");
            obj.set_max("100");
            this.addChild(obj.name, obj);

            obj = new Edit("Edit00","435","32","165","30",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            this.addChild(obj.name, obj);

            obj = new Button("Button00","110","32","310","30",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("setHTTPHeaderVariable(\"header0\", \"modify value\");");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.registerScript("FileUpTransfer_FileDownTransfer_Sample00.xfdl", function() {
        ...
        this.fileUpTrans_onsuccess = function(obj,e)
        {
        	...
        	trace("전송완료 ");
        	this.Edit00.set_value(objCallDs.getColumn(0,"httpheadervalue"));
        };
