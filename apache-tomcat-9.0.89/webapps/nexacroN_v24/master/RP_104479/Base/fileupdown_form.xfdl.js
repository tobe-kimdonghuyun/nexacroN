(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "CHK","type" : "STRING","size" : "256"},{"id" : "FILE_NAME","type" : "STRING","size" : "256"},{"id" : "FILE_URL","type" : "STRING","size" : "256"},{"id" : "FILE_ID","type" : "STRING","size" : "256"},{"id" : "DEPTH","type" : "STRING","size" : "256"},{"id" : "STATUS","type" : "STRING","size" : "256"},{"id" : "FiLE_SIZE","type" : "STRING","size" : "256"}]}});
            ...
            obj = new Grid("Grid01","28","355","791","201",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new Button("btnDonwload","719","317","100","31",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("전체 다운로드");
            this.addChild(obj.name, obj);

            obj = new Button("btnSearch","28","317","100","31",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            ...
            obj = new Button("Button00","385","23","95","38",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("get/set header");
            this.addChild(obj.name, obj);

            obj = new Button("Button01","150","319","140","22",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("임의다운로드");
            this.addChild(obj.name, obj);

            obj = new Edit("Edit00","308","318","406","28",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_value("http://localhost:8080/tomcat.png");
            obj.set_text("http://localhost:8080/tomcat.png");
            this.addChild(obj.name, obj);

            obj = new Button("Button02","485","26","130","35",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("getResponse");
            this.addChild(obj.name, obj);

            obj = new Button("Button03","717","292","97","28",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("getResponse");
            this.addChild(obj.name, obj);

            obj = new Button("Button04","193","289","213","25",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("download(promise)");
            this.addChild(obj.name, obj);

            obj = new Button("Button05","255","34","114","27",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("전송(promise)");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",840,560,this,function(p){});
