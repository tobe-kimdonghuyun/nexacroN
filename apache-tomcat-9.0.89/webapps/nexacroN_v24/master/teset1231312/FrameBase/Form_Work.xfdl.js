(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("Edit00","45","167","605","46",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);
        ...
        this.Button00_onclick = function(obj,e)
        {
        	...
        	{
        		req.then(res => {
        			trace("✅ 사용자 조회 완료: req.then 이후 확인 errorcode= [",res,"]");
        ...
        {
        	this.Edit00.set_value("sID = "+sID+", errorcode = "+ErrorCode+", errormsg = "+ErrorMsg);
        }
