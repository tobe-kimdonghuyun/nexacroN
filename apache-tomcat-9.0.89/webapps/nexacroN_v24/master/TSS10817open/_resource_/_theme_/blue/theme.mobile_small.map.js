            ...
            "Form" :
            			{
            				"self" :
            				{
            					"enabled" :
            					{
            						"font" : nexacro.FontObject("12px \"Meiryo\", \"Verdana\", \"Roboto\", \"Droid Sans\", \"游ゴシック\", \"YuGothic\", \"ヒラギノ角ゴ ProN W3\", \"Hiragino Kaku Gothic ProN\", \"ＭＳ Ｐゴシック\", \"MS Gothic\", \"sans-serif\""),
            								...
            								"parent" :
            								{
            									"Grid" :
            									{
            										"self" :
            										{
            											"enabled" :
            											{
            												"font" : nexacro.FontObject("bold 12px \"Meiryo\", \"Verdana\", \"Roboto\", \"Droid Sans\", \"游ゴシック\", \"YuGothic\", \"ヒラギノ角ゴ ProN W3\", \"Hiragino Kaku Gothic ProN\", \"ＭＳ Ｐゴシック\", \"MS Gothic\", \"sans-serif\""),
            				...
            				"parent" :
            				{
            					"Menu" :
            					{
            						"self" :
            						{
            							"enabled" :
            							{
            								"font" : nexacro.FontObject("bold 13px \"Meiryo\", \"Verdana\", \"Roboto\", \"Droid Sans\", \"游ゴシック\", \"YuGothic\", \"ヒラギノ角ゴ ProN W3\", \"Hiragino Kaku Gothic ProN\", \"ＭＳ Ｐゴシック\", \"MS Gothic\", \"sans-serif\""),
            								"color" : nexacro.ColorObject("#ffffff"),
