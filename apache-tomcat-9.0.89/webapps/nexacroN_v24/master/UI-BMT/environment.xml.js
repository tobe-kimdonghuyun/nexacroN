if (nexacro.Environment)
{
    ...
    env.on_init = function ()
    {
        ...
        this.set_userfontid("font::BMT_Font.xfont");
    };
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("ct_img", "file", "./_resource_/_images_/", "session", null, "", "0", "");
        nexacro._addService("font", "file", "./_resource_/_font_/", "session", null, "", "0", "");
        nexacro._addService("extlib", "file", "./_extlib_/", "session", null, "", "0", "");
        nexacro._addService("svc", "JSP", "http://localhost:8080/daewooenc/", "none", null, "", "0", "0");
        nexacro._addService("xeni", "JSP", "http://localhost:8080/daewooenc/", "none", null, "", "0", "0");
        nexacro._addService("lib", "js", "./lib/", "session", null, "", "0", "0");
        nexacro._addService("web", "file", "./web/", "session", null, "", "0", "0");
        nexacro._addService("Frame", "form", "./Frame/", "session", null, "", "0", "0");
        nexacro._addService("BMT", "form", "./BMT/", "session", null, "", "0", "0");
