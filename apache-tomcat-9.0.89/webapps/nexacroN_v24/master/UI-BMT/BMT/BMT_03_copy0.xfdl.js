(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text("TAB1");
            obj.set_url("BMT::BMT_01_copy0.xfdl");
            obj.set_async("true");
        ...
        {
            this._addPreloadList("fdl","BMT::BMT_01_copy0.xfdl");
        };
        
        // User Script
        this.registerScript("BMT_03_copy0.xfdl", function() {
        /**
        *  Nexacro DEMO
        ...
        *******************************************************************************************************************************/
        ...
        this.btn_addTab_onclick = function(obj,e)
        {
        	...
        	this.tab_multi.insertTabpage('TAB'+this.tabIdx, -1, "BMT::BMT_01_copy0.xfdl", 'TAB'+this.tabIdx);
        ...
        this.tab_multi_canchange = function(obj,e)
        {
        	let form = obj.tabpages[e.postindex];
        	//form.fnShowComponent();
        	if(form._complist)
        		nexacro._applyComponents(form, form._complist, undefined, true);
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.tab_multi.addEventHandler("canchange",this.tab_multi_canchange,this);
        ...
        this.loadIncludeScript("BMT_03_copy0.xfdl");
