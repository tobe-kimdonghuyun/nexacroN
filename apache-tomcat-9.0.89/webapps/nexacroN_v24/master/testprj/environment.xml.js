if (nexacro.Environment)
{
    ...
    env.on_init = function ()
    {
        ...
        this.set_loadingimage("url(\'theme::tsp/images/loadingimage.gif\')");
        this.set_accessibilitytype("standard");
        this.set_accessibilitydescreadtype("label,action,description");
        this.set_locale("ko_KR");
        this.set_tabkeycirculation("frame,cycle");
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("Service0", "file", "./_extlib_/DesktopMDILib/", "session", null, "", "0", "0");
