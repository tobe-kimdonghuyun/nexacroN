(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","Desktop_screen",1480,280,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
            ...
            //-- Normal Layout : this
            obj = new Layout("default0","",480,438,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
        ...
        this.loadIncludeScript("frm_Bottom_copy1.xfdl");
