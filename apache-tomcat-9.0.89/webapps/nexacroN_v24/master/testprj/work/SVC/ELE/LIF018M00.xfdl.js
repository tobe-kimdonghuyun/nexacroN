(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            divForm_form_divSch_form_cboAplyKnd_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\"/><Col id=\"datacolumn\">선택</Col></Row><Row><Col id=\"codecolumn\">TSPELE</Col><Col id=\"datacolumn\">전기신청/해지</Col></Row></Rows>");
            ...
            obj = new Panel("Panel08","637","200","560","1",null,null,null,null,null,null,this.divForm.form.divSch.form);
            obj.set_taborder("27");
            obj.set_type("horizontal");
            obj.set_horizontalgap("10");
            obj.set_flexgrow("1");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"150\"/><Column size=\"150\"/><Column size=\"200\"/><Column size=\"150\"/><Column size=\"256\"/><Column size=\"214\"/><Column size=\"200\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"120\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"56\" band=\"head\"/><Row size=\"48\"/></Rows><Band id=\"head\"><Cell text=\"신청번호\"/><Cell col=\"1\" text=\"단계\"/><Cell col=\"2\" text=\"신청구분\"/><Cell col=\"3\" text=\"서비스구분\"/><Cell col=\"4\" text=\"위치정보(룸번호)\"/><Cell col=\"5\" text=\"위치구분\"/><Cell col=\"6\" text=\"회사\"/><Cell col=\"7\" text=\"신청자\"/><Cell col=\"8\" text=\"등록자\"/><Cell col=\"9\" text=\"신청자&#13;&#10;(수기입력)\"/><Cell col=\"10\" text=\"최초신청일시\"/><Cell col=\"11\" text=\"최종신청일시\"/><Cell col=\"12\" text=\"처리자\"/><Cell col=\"13\" text=\"연락처\"/><Cell col=\"14\" text=\"처리작업그룹\"/><Cell col=\"15\" cssclass=\"CellEnd\" text=\"완료일시\"/></Band><Band id=\"body\"><Cell text=\"bind:aplyNo\" textAlign=\"center\" cssclass=\"CellLink\" cursor=\"pointer\"/><Cell col=\"1\" text=\"bind:taskNm\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:aplySeNm\" textAlign=\"center\"/><Cell col=\"3\" text=\"bind:docNm\" textAlign=\"center\"/><Cell col=\"4\" text=\"bind:rnb\"/><Cell col=\"5\" text=\"bind:pstnSeNm\"/><Cell col=\"6\" text=\"bind:aplcntInstNm\" textAlign=\"center\"/><Cell col=\"7\" text=\"bind:aplcntNm\" textAlign=\"center\"/><Cell col=\"8\" text=\"bind:rgtrNm\" textAlign=\"center\"/><Cell col=\"9\" text=\"bind:hwrtInptAplcntNm\" textAlign=\"center\"/><Cell col=\"10\" text=\"bind:aplyDt\" textAlign=\"center\" displaytype=\"mask\" maskeditformat=\"####-##-## ##:##\" maskedittype=\"string\"/><Cell col=\"11\" text=\"bind:frstRegDt\" textAlign=\"center\" displaytype=\"mask\" maskeditformat=\"####-##-## ##:##\" maskedittype=\"string\"/><Cell col=\"12\" text=\"bind:prcrNm\" textAlign=\"center\" tooltiptext=\"bind:prcrNm\"/><Cell col=\"13\" text=\"bind:prcrTelno\" textAlign=\"center\" tooltiptext=\"bind:prcrTelno\"/><Cell col=\"14\" text=\"bind:prcrJobGroupNm\" textAlign=\"center\"/><Cell col=\"15\" cssclass=\"CellEnd\" text=\"bind:endDt\" textAlign=\"center\" displaytype=\"mask\" maskeditformat=\"####-##-## ##:##\" maskedittype=\"string\"/></Band></Format></Formats>");
            this.divForm.form.divGrd.addChild(obj.name, obj);
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divSch.form,
                ...
                p.Panel08.move("637","200","560","1",null,null);
            	}
            );
        ...
        // User Script
        this.addIncludeScript("LIF018M00.xfdl","xjs::TaskCom.xjs");
        this.registerScript("LIF018M00.xfdl", function() {
        /**
        *  PcMdi 프로젝트
        ...
        *******************************************************************************************************************************/
        ...
        this.fnSearch = function(pgNo)
        {
        	...
        	var strSvcUrl   = "elctySrvcPrcs/elctySrvcPrcsListInq.do";
        ...
        *******************************************************************************************************************************/
        	...
        	if(e.row > -1){
        		if(cellIdx == e.cell){
        			...
        			var objArg   = {
        				...
        				"pvJobCd"  : this.dsSrvcPrcsList.getColumn(e.row, "jobCd"),
        				"view"   : "popup"
        			};
        			...
        			var popUpUrl = {
        				TSPELE001 : "work::LIF/ELE/LIF053M00.xfdl", 	// 사용신청(공사건물)
        				TSPELE002 : "work::LIF/ELE/LIF053M00.xfdl", 	// 사용신청(공사미소유건물,옥외)
        				TSPELE003 : "work::LIF/ELE/LIF086M00.xfdl", 	// 해지신청(공사건물)
        				TSPELE004 : "work::LIF/ELE/LIF086M00.xfdl", 	// 해지신청(공사미소유건물,옥외)
        				TSPELE006 : "work::LIF/ELE/LIF064M00.xfdl",  	// 사용신청(램프교체)
        				TSPELE007 : "work::LIF/ELE/LIF065M00.xfdl",  	// 사용신청(난로사용신청)
        				TSPELE008 : "work::LIF/ELE/LIF064M00.xfdl"  	// 해지신청(난로)
        			}
        ...
        this.loadIncludeScript("LIF018M00.xfdl");
