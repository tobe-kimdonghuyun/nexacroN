(function()
{
    return function()
    {
        ...
        {
            this.set_name("LIF031M00");
            this.set_titletext("배정룸도면 서비스처리목록");
            ...
            obj._setContents("<ColumnInfo><Column id=\"rnum\" type=\"STRING\" size=\"256\"/><Column id=\"rno\" type=\"STRING\" size=\"256\"/><Column id=\"aplyNo\" type=\"STRING\" size=\"256\"/><Column id=\"jobCd\" type=\"STRING\" size=\"256\"/><Column id=\"taskNm\" type=\"STRING\" size=\"256\"/><Column id=\"endNm\" type=\"STRING\" size=\"256\"/><Column id=\"aplySeCd\" type=\"STRING\" size=\"256\"/><Column id=\"aplySeNm\" type=\"STRING\" size=\"256\"/><Column id=\"aplcntInstNm\" type=\"STRING\" size=\"256\"/><Column id=\"aplcntNm\" type=\"STRING\" size=\"256\"/><Column id=\"rgtrNm\" type=\"STRING\" size=\"256\"/><Column id=\"flrplnStgRbprsnNm\" type=\"STRING\" size=\"256\"/><Column id=\"aplyDt\" type=\"STRING\" size=\"256\"/><Column id=\"frstRegDt\" type=\"STRING\" size=\"256\"/><Column id=\"prcrNm\" type=\"STRING\" size=\"256\"/><Column id=\"prcrTelno\" type=\"STRING\" size=\"256\"/><Column id=\"prcrJobGroupNm\" type=\"STRING\" size=\"256\"/><Column id=\"endDt\" type=\"STRING\" size=\"256\"/><Column id=\"allCnt\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staRnb01","1570","60","100","40",null,null,null,null,null,null,this.divForm.form.divSch.form);
            obj.set_taborder("22");
            obj.set_text("신청번호");
            obj.set_cssclass("sta_WF_SchLabel");
            obj.set_flexshrink("0");
            ...
            obj.set_horizontalgap("10");
            obj.set_flexgrow("1");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"staAplcntNm\"/><PanelItem id=\"PanelItem01\" componentid=\"edtCoNm\"/></Contents>");
            this.divForm.form.divSch.addChild(obj.name, obj);
            ...
            obj.set_horizontalgap("10");
            obj.set_flexgrow("1");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"staRnb01\"/><PanelItem id=\"PanelItem02\" componentid=\"edtAplNo\"/></Contents>");
            this.divForm.form.divSch.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"150\"/><Column size=\"150\"/><Column size=\"100\"/><Column size=\"200\"/><Column size=\"200\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"120\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"56\" band=\"head\"/><Row size=\"48\"/></Rows><Band id=\"head\"><Cell text=\"신청번호\"/><Cell col=\"1\" text=\"단계\"/><Cell col=\"2\" text=\"종료구분\"/><Cell col=\"3\" text=\"신청구분\"/><Cell col=\"4\" text=\"회사\"/><Cell col=\"5\" text=\"신청자\"/><Cell col=\"6\" text=\"등록자\"/><Cell col=\"7\" text=\"도면보관책임자\"/><Cell col=\"8\" text=\"최초신청일시\"/><Cell col=\"9\" text=\"최종신청일시\"/><Cell col=\"10\" text=\"처리자\"/><Cell col=\"11\" text=\"연락처\"/><Cell col=\"12\" text=\"처리작업그룹\"/><Cell col=\"13\" cssclass=\"CellEnd\" text=\"완료일시\"/></Band><Band id=\"body\"><Cell text=\"bind:aplyNo\" textAlign=\"center\" cssclass=\"CellLink\" cursor=\"pointer\"/><Cell col=\"1\" text=\"bind:taskNm\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:endNm\" textAlign=\"center\"/><Cell col=\"3\" text=\"bind:aplySeNm\" textAlign=\"center\"/><Cell col=\"4\" text=\"bind:aplcntInstNm\" textAlign=\"center\"/><Cell col=\"5\" text=\"bind:aplcntNm\" textAlign=\"center\"/><Cell col=\"6\" text=\"bind:rgtrNm\" textAlign=\"center\"/><Cell col=\"7\" text=\"bind:flrplnStgRbprsnNm\" textAlign=\"center\"/><Cell col=\"8\" text=\"bind:aplyDt\" textAlign=\"center\" displaytype=\"mask\" maskeditformat=\"####-##-## ##:##\" maskedittype=\"string\"/><Cell col=\"9\" text=\"bind:frstRegDt\" textAlign=\"center\" displaytype=\"mask\" maskeditformat=\"####-##-## ##:##\" maskedittype=\"string\"/><Cell col=\"10\" text=\"bind:prcrNm\" textAlign=\"center\" tooltiptext=\"bind:prcrNm\"/><Cell col=\"11\" text=\"bind:prcrTelno\" textAlign=\"center\" tooltiptext=\"bind:prcrTelno\"/><Cell col=\"12\" text=\"bind:prcrJobGroupNm\" textAlign=\"center\"/><Cell col=\"13\" cssclass=\"CellEnd\" text=\"bind:endDt\" textAlign=\"center\" displaytype=\"mask\" maskeditformat=\"####-##-## ##:##\" maskedittype=\"string\"/></Band></Format></Formats>");
            this.divForm.form.divGrd.addChild(obj.name, obj);
            ...
            obj = new BindItem("item5","divForm.form.divSch.form.edtCoNm","value","dsSearch","pstnRnb");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("LIF126M00.xfdl","xjs::TaskCom.xjs");
        this.registerScript("LIF126M00.xfdl", function() {
        /**
        *  PcMdi 프로젝트
        *  @FileName 	LIF031M00.xfdl
        *  @Creator 	김병조
        ...
        *******************************************************************************************************************************/
        ...
        this.fnSearch = function(pgNo)
        {
        	...
        	var strSvcUrl   = "altmntRmFlrplnSrvcPrcs/altmntRmFlrplnSrvcPrcsListInq.do";
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("LIF126M00.xfdl");
