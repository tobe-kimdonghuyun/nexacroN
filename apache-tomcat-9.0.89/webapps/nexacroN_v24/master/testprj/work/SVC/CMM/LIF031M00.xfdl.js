(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Panel("Panel02","1694.00","398","560","1",null,null,null,null,null,null,this.divForm.form.divSch.form);
            obj.set_taborder("3");
            obj.set_type("horizontal");
            obj.set_horizontalgap("10");
            obj.set_flexgrow("1");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"150\"/><Column size=\"150\"/><Column size=\"200\"/><Column size=\"150\"/><Column size=\"256\"/><Column size=\"200\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"120\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"56\" band=\"head\"/><Row size=\"48\"/></Rows><Band id=\"head\"><Cell text=\"신청번호\"/><Cell col=\"1\" text=\"단계\"/><Cell col=\"2\" text=\"신청구분\"/><Cell col=\"3\" text=\"서비스구분\"/><Cell col=\"4\" text=\"위치정보(룸번호)\"/><Cell col=\"5\" text=\"회사\"/><Cell col=\"6\" text=\"신청자\"/><Cell col=\"7\" text=\"등록자\"/><Cell col=\"8\" text=\"신청자&#13;&#10;(수기입력)\"/><Cell col=\"9\" text=\"최초신청일시\"/><Cell col=\"10\" text=\"최종신청일시\"/><Cell col=\"11\" text=\"처리자\"/><Cell col=\"12\" text=\"연락처\"/><Cell col=\"13\" text=\"처리작업그룹\"/><Cell col=\"14\" cssclass=\"CellEnd\" text=\"완료일시\"/></Band><Band id=\"body\"><Cell text=\"bind:aplyNo\" textAlign=\"center\" cssclass=\"CellLink\" cursor=\"pointer\"/><Cell col=\"1\" text=\"bind:taskNm\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:aplySeNm\" textAlign=\"center\"/><Cell col=\"3\" text=\"bind:docNm\" textAlign=\"center\"/><Cell col=\"4\" text=\"bind:rnb\"/><Cell col=\"5\" text=\"bind:aplcntInstNm\" textAlign=\"center\"/><Cell col=\"6\" text=\"bind:aplcntNm\" textAlign=\"center\"/><Cell col=\"7\" text=\"bind:rgtrNm\" textAlign=\"center\"/><Cell col=\"8\" text=\"bind:hwrtInptAplcntNm\" textAlign=\"center\"/><Cell col=\"9\" text=\"bind:aplyDt\" textAlign=\"center\" displaytype=\"mask\" maskeditformat=\"####-##-## ##:##\" maskedittype=\"string\"/><Cell col=\"10\" text=\"bind:frstRegDt\" textAlign=\"center\" displaytype=\"mask\" maskeditformat=\"####-##-## ##:##\" maskedittype=\"string\"/><Cell col=\"11\" text=\"bind:prcrNm\" textAlign=\"center\" tooltiptext=\"bind:prcrNm\"/><Cell col=\"12\" text=\"bind:prcrTelno\" textAlign=\"center\" tooltiptext=\"bind:prcrTelno\"/><Cell col=\"13\" text=\"bind:prcrJobGroupNm\" textAlign=\"center\"/><Cell col=\"14\" cssclass=\"CellEnd\" text=\"bind:endDt\" textAlign=\"center\" displaytype=\"mask\" maskeditformat=\"####-##-## ##:##\" maskedittype=\"string\"/></Band></Format></Formats>");
            this.divForm.form.divGrd.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("LIF031M00.xfdl","xjs::TaskCom.xjs");
        this.registerScript("LIF031M00.xfdl", function() {
        /**
        *  PcMdi 프로젝트
        ...
        *******************************************************************************************************************************/
        ...
        this.fnSearch = function(pgNo)
        {
        	...
        	var strSvcUrl   = "cmnctSrvcPrcs/cmnctSrvcPrcsListInq.do";
        ...
        *******************************************************************************************************************************/
        ...
        this.grdList_oncellclick = function(obj,e)
        {
        	...
        	if(e.row > -1){
        		if(cellIdx == e.cell){
        			...
        			var popUpUrl = {
        				TSPCMM001 : "work::LIF/CMM/LIF056M00.xfdl", 	// 사용신청
        				TSPCMM002 : "work::LIF/CMM/LIF090M00.xfdl", 	// 해지신청
        				TSPCMM003 : "work::LIF/CMM/LIF066M00.xfdl", 	// 변경신청
        				TSPCMM004 : "work::LIF/CMM/LIF067M00.xfdl", 	// 일시이용중단
        				TSPCMM005 : "work::LIF/CMM/LIF068M00.xfdl", 	// 일시이용중단해제
        				TSPCMM007 : "work::CST/CMM/CST015M00.xfdl", 	// 통신실출입작업계획서
        			}
        ...
        this.loadIncludeScript("LIF031M00.xfdl");
