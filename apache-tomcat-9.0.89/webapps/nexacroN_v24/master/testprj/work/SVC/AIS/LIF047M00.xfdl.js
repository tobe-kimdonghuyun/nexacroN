(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"jobCd\" type=\"STRING\" size=\"256\"/><Column id=\"key\" type=\"STRING\" size=\"256\"/><Column id=\"aplyNo\" type=\"STRING\" size=\"256\"/><Column id=\"jobNm\" type=\"STRING\" size=\"256\"/><Column id=\"regDt\" type=\"STRING\" size=\"256\"/><Column id=\"aplyDt\" type=\"STRING\" size=\"256\"/><Column id=\"actlEndDt\" type=\"STRING\" size=\"256\"/><Column id=\"endDt\" type=\"STRING\" size=\"256\"/><Column id=\"aplcntId\" type=\"STRING\" size=\"256\"/><Column id=\"aplcntNm\" type=\"STRING\" size=\"256\"/><Column id=\"rgtrNm\" type=\"STRING\" size=\"256\"/><Column id=\"prcrNm\" type=\"STRING\" size=\"256\"/><Column id=\"rgtrInstNm\" type=\"STRING\" size=\"256\"/><Column id=\"custTypeNm\" type=\"STRING\" size=\"256\"/><Column id=\"bldgSeNm\" type=\"STRING\" size=\"256\"/><Column id=\"prcrOnlnNo\" type=\"STRING\" size=\"256\"/><Column id=\"prcrJobGroupCd\" type=\"STRING\" size=\"256\"/><Column id=\"prcrJobGroupNm\" type=\"STRING\" size=\"256\"/><Column id=\"aplySeNm\" type=\"STRING\" size=\"256\"/><Column id=\"endNm\" type=\"STRING\" size=\"256\"/><Column id=\"docNm\" type=\"STRING\" size=\"256\"/><Column id=\"aplyKndNm\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"225\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"56\" band=\"head\"/><Row size=\"48\"/></Rows><Band id=\"head\"><Cell text=\"신청번호\"/><Cell col=\"1\" text=\"단계\"/><Cell col=\"2\" text=\"서비스구분\"/><Cell col=\"3\" text=\"신청종류\"/><Cell col=\"4\" text=\"고객유형\"/><Cell col=\"5\" text=\"지역구분\"/><Cell col=\"6\" text=\"신청자회사\"/><Cell col=\"7\" text=\"신청자\"/><Cell col=\"8\" text=\"신청일시\"/><Cell col=\"9\" text=\"처리자\"/><Cell col=\"10\" text=\"연락처\"/><Cell col=\"11\" cssclass=\"CellEnd\" text=\"처리작업그룹\"/></Band><Band id=\"body\"><Cell text=\"bind:aplyNo\" displaytype=\"text\" textAlign=\"center\" cssclass=\"CellLink\" cursor=\"pointer\"/><Cell col=\"1\" text=\"bind:jobNm\" displaytype=\"text\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:docNm\" displaytype=\"text\" textAlign=\"center\"/><Cell col=\"3\" text=\"bind:aplyKndNm\" displaytype=\"text\" textAlign=\"center\"/><Cell col=\"4\" text=\"bind:custTypeNm\" displaytype=\"text\" textAlign=\"center\"/><Cell col=\"5\" text=\"bind:bldgSeNm\" displaytype=\"text\" cssclass=\"expr:state==&apos;0&apos;?&apos;CellTxtRed&apos;:&apos;CellTxtBlue&apos;\" textAlign=\"center\"/><Cell col=\"6\" text=\"bind:rgtrInstNm\" displaytype=\"text\" textAlign=\"center\"/><Cell col=\"7\" text=\"bind:aplcntNm\" textAlign=\"center\"/><Cell col=\"8\" text=\"bind:aplyDt\" textAlign=\"center\" displaytype=\"mask\" maskeditformat=\"####-##-## ##:##\" maskedittype=\"string\"/><Cell col=\"9\" text=\"bind:prcrNm\" textAlign=\"center\"/><Cell col=\"10\" text=\"bind:prcrOnlnNo\" textAlign=\"center\"/><Cell col=\"11\" cssclass=\"CellEnd\" text=\"bind:prcrJobGroupNm\" textAlign=\"center\"/></Band></Format></Formats>");
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divStep.form.palStepConGroup.form.divNvWrap.form,
                ...
                p.staNvLabel01.set_text("전동차허가신청");
        ...
        // User Script
        this.registerScript("LIF047M00.xfdl", function() {
        /**
        *  PcMdi 프로젝트
        *  @FileName 	LIF047M00.xfdl
        *  @Creator 	CHG
        ...
        *******************************************************************************************************************************/
        ...
        this.fnJobSeSearch = function()
        {
        	...
        	this.dsJobSearch.setColumn(0, "jobSeCd", "CAR");
        ...
        this.fnCntSeSearch = function()
        {
        	...
        	var strSvcId    = "elcttrPrcsNocsInq";
        	var strSvcUrl   = "elcttrSrvcPrcs/elcttrPrcsNocsInq.do";
        ...
        this.fnSearch = function()
        {
        	...
        	var strSvcId    = "search";
        	var strSvcUrl   = "cad/flrplnAplyTmprInq.do";
        	var inData      = "dsSearch=dsSearch";
        	var outData     = "dsCadMaster=dsCadMaster dsRltwfCadList=dsRltwfCadList dsWfEmps=dsWfEmps";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        	var isAsync   	= true;
        ...
        this.fnListSearch = function(seCd, taskPrcsId){
        	...
        	var strSvcId    = "elcttrPrcsInq";
        	var strSvcUrl   = "elcttrSrvcPrcs/elcttrPrcsInq.do";
        		...
        		case "elcttrPrcsNocsInq" : // 건수조회
        			...
        			if(this.dsCntList1.getRowCount() > 0){
        				for(var i = 0; i < this.dsCntList1.getRowCount(); i++){
        					...
        					if(this.dsJobList.getColumn(jobRow, "taskSeCd") == "ACT10165"){
        						act10165Cnt = act10165Cnt + nexacro.toNumber(this.dsCntList1.getColumn(i, "cnt"), 0);

        					}else if(this.dsJobList.getColumn(jobRow, "taskSeCd") == "ACT10166"){
        						act10166Cnt = act10166Cnt + nexacro.toNumber(this.dsCntList1.getColumn(i, "cnt"), 0);

        					}
        				}
        			}

        			this.divForm.form.divStep.form.palStepGroup.form.btnCountP01.text = act10165Cnt;
        			this.divForm.form.divStep.form.palStepGroup.form.btnCountP02.text = act10166Cnt;
        			...
        			if(this.dsCntList2.getRowCount() > 0){
        				for(var i = 0; i < this.dsCntList2.getRowCount(); i++){
        					...
        					if(this.dsJobList.getColumn(jobRow, "taskSeCd") == "ACT10165"){
        						act10165Cnt = act10165Cnt + nexacro.toNumber(this.dsCntList2.getColumn(i, "cnt"), 0);

        					}else if(this.dsJobList.getColumn(jobRow, "taskSeCd") == "ACT10166"){
        						act10166Cnt = act10166Cnt + nexacro.toNumber(this.dsCntList2.getColumn(i, "cnt"), 0);

        					}
        				}
        			}

        			this.divForm.form.divStep.form.palStepGroup.form.btnCountD01.text = act10165Cnt;
        			this.divForm.form.divStep.form.palStepGroup.form.btnCountD02.text = act10166Cnt;

        			break;

        		case "elcttrPrcsInq": // 리스트 조회
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("LIF047M00.xfdl");
