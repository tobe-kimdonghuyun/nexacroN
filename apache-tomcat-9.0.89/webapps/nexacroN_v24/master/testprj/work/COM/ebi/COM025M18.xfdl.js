(function()
{
    return function()
    {
        ...
        {
            this.set_name("COM025M18");
            this.set_titletext("EBI 차량안전검사결과정보");
            ...
            obj._setContents("<ColumnInfo><Column id=\"rno\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"90\"/><Column size=\"200\"/><Column size=\"200\"/><Column size=\"200\"/><Column size=\"200\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"56\" band=\"head\"/><Row size=\"48\"/></Rows><Band id=\"head\"><Cell text=\"순번\"/><Cell col=\"1\" text=\"청구일자\"/><Cell col=\"2\" text=\"청구고객코드\"/><Cell col=\"3\" text=\"청구고객명\"/><Cell col=\"4\" text=\"계량기관리번호\"/><Cell col=\"5\" text=\"계약구분\"/><Cell col=\"6\" text=\"사용료코드\"/><Cell col=\"7\" text=\"사용료명\"/><Cell col=\"8\" text=\"사용료유형코드\"/></Band><Band id=\"body\"><Cell text=\"bind:업체기관명\" displaytype=\"text\"/><Cell col=\"1\" text=\"bind:건물명\" displaytype=\"text\"/><Cell col=\"2\" text=\"bind:크기\" displaytype=\"text\"/><Cell col=\"3\" text=\"bind:용도\" displaytype=\"text\"/><Cell col=\"4\" text=\"bind:진행상태\" displaytype=\"text\" cssclass=\"expr:state==&apos;0&apos;?&apos;CellTxtRed&apos;:&apos;CellTxtBlue&apos;\"/><Cell col=\"5\"/><Cell col=\"6\"/><Cell col=\"7\"/><Cell col=\"8\"/></Band></Format></Formats>");
            ...
            obj = new Button("btnGrdExcel01","1310","8","167","31",null,null,null,null,null,null,this.divForm.form.divGrd.form);
            obj.set_taborder("9");
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divGrd.form,
                ...
                p.btnGrdExcel01.move("1310","8","167","31",null,null);
            	}
            );
            ...
            obj = new Layout("default","Desktop_screen",1480,900,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.set_titletext("EBI 차량안전검사결과정보");
        ...
        // User Script
        this.registerScript("COM025M18.xfdl", function() {
        /**
        ...
        *******************************************************************************************************************************/
        this.getSearchTransaction = function() {
        	...
        	var strSvcId    = "search";
        	var strSvcUrl   = "/ebi/ebiVhclSafeInspRsltInq.do";
        ...
        *******************************************************************************************************************************/
        ...
        this.divForm_divGrd_btnGrdExcel01_onclick = function(obj,e)
        {
        	...
        	var url = "/ebi/ebiVhclSafeInspRsltExcel.do";
        ...
        this.loadIncludeScript("COM025M18.xfdl");
