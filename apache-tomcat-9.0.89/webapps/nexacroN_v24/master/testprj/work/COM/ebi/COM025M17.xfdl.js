(function()
{
    return function()
    {
        ...
        {
            this.set_name("COM025M17");
            this.set_titletext("EBI 개인별 출입증 발급 정보");
            ...
            obj = new Button("btnGrdExcel01","1153","0","167","31",null,null,null,null,null,null,this.divForm.form.divGrd.form);
            obj.set_taborder("9");
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divGrd.form,
                ...
                p.btnGrdExcel01.move("1153","0","167","31",null,null);
            	}
            );
            ...
            obj = new Layout("default","Desktop_screen",1480,900,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.set_titletext("EBI 개인별 출입증 발급 정보");
        ...
        // User Script
        this.registerScript("COM025M17.xfdl", function() {
        /**
        ...
        *******************************************************************************************************************************/
        this.getSearchTransaction = function() {
        	...
        	var strSvcId    = "search";
        	var strSvcUrl   = "/ebi/ebiIndvAdpsIssuInq.do";
        ...
        *******************************************************************************************************************************/
        ...
        this.divForm_divGrd_btnGrdExcel01_onclick = function(obj,e)
        {
        	...
        	var url = "/ebi/ebiIndvAdpsIssuExcel.do";
        ...
        this.loadIncludeScript("COM025M17.xfdl");
