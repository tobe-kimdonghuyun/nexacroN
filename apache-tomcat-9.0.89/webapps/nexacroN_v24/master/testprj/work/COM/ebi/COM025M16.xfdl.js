(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("EBI 차량출입증발급반납정보");
            ...
            obj = new Layout("default","Desktop_screen",1480,900,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.set_titletext("EBI 차량출입증발급반납정보");
        ...
        // User Script
        this.registerScript("COM025M16.xfdl", function() {
        /**
        ...
        *******************************************************************************************************************************/
        this.getSearchTransaction = function() {
        	...
        	var strSvcId    = "search";
        	var strSvcUrl   = "/ebi/ebiVhclAdpsIssuRtnInq.do";
        ...
        *******************************************************************************************************************************/
        ...
        this.divForm_divGrd_btnGrdExcel01_onclick = function(obj,e)
        {
        	...
        	var url = "/ebi/ebiVhclAdpsIssuRtnExcel.do";
        ...
        this.loadIncludeScript("COM025M16.xfdl");
