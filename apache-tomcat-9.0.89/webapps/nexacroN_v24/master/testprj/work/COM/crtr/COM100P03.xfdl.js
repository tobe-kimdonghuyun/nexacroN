(function()
{
    return function()
    {
        ...
        {
            this.set_name("COM100P03");
            this.set_titletext("부서 선택 팝업");
            ...
            obj._setContents("<ColumnInfo><Column id=\"currentPageNo\" type=\"STRING\" size=\"256\"/><Column id=\"recordCountPerPage\" type=\"STRING\" size=\"256\"/><Column id=\"deptNm\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"recordCountPerPage\">10</Col><Col id=\"currentPageNo\">1</Col></Row></Rows>");
            ...
            obj.set_fittocontents("height");
            obj._setContents("<Contents><PanelItem id=\"PanelItem04\" componentid=\"Panel03\"/><PanelItem id=\"PanelItem02\" componentid=\"panSchBtn\"/></Contents>");
            this.divForm.form.divSch.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"200\"/><Column size=\"200\"/><Column size=\"200\"/></Columns><Rows><Row size=\"44\" band=\"head\"/><Row size=\"44\"/></Rows><Band id=\"head\"><Cell text=\"부서ID\"/><Cell col=\"1\" text=\"부서명\"/><Cell col=\"2\" text=\"업체명\"/></Band><Band id=\"body\"><Cell text=\"bind:deptId\"/><Cell col=\"1\" text=\"bind:deptNm\"/><Cell col=\"2\" text=\"bind:coNm\"/></Band></Format></Formats>");
            ...
            obj = new Button("Button00_00","121","22","68","40",null,null,null,null,null,null,this.divPopBtn.form);
            obj.set_taborder("0");
            obj.set_text("확인");
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divGrd.form,
                ...
                p.Grid00.set_binddataset("dsDept");
            ...
            obj = new Layout("default","",0,0,this.divPopBtn.form,
                ...
                p.Button00_00.move("121","22","68","40",null,null);
            	}
            );
            obj.set_type("horizontal");
            obj.set_flexmainaxisalign("center");
            ...
            //-- Normal Layout : this
            obj = new Layout("Layout0","Phone_screen",480,460,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
        ...
        // User Script
        this.registerScript("COM100P03.xfdl", function() {
        /**
        *  인천공항 원스톱 입주자서비스 프로젝트
        *  @FileName 	COM100P03.xfdl
        *  @Creator 	(주)이루온
        ...
        *******************************************************************************************************************************/
        this.getSearchTransaction = function() {
        	...
        	var outData     = "dsDept=dsDept dsPage=dsPage";
        	var strArg      = "";
        ...
        *******************************************************************************************************************************/
        ...
        {
        	var objRet = {
        		deptId : this.dsDept.getColumn(this.dsDept.rowposition, "deptId")
        		, coId : this.dsDept.getColumn(this.dsDept.rowposition, "coId")
        		, coNm : this.dsDept.getColumn(this.dsDept.rowposition, "coNm")
        		, upDeptId : this.dsDept.getColumn(this.dsDept.rowposition, "upDeptId")
        		, upDeptNm : this.dsDept.getColumn(this.dsDept.rowposition, "upDeptNm")
        		, deptNm : this.dsDept.getColumn(this.dsDept.rowposition, "deptNm")
        		, useYn : this.dsDept.getColumn(this.dsDept.rowposition, "useYn")
        		, deptRnk : this.dsDept.getColumn(this.dsDept.rowposition, "deptRnk")
        		, deptExpln : this.dsDept.getColumn(this.dsDept.rowposition, "deptExpln")
        		, deptLvl : this.dsDept.getColumn(this.dsDept.rowposition, "deptLvl")
        	}
        ...
        this.on_initEvent = function()
        {
            ...
            this.divPopBtn.form.Button00_00.addEventHandler("onclick",this.divForm_Button00_00_onclick,this);
        };
        this.loadIncludeScript("COM100P03.xfdl");
