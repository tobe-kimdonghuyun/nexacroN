(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new WebBrowser("WebBrowser00","0","0","100%","100%",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.registerScript("crtrUtztnPopup.xfdl", function() {
        /**
        *  인천공항 원스톱 입주자서비스 프로젝트
        *  @FileName 	crtrUtztnPopup.xfdl
        *  @Creator 	(주)이루온
        ...
        *******************************************************************************************************************************/
        this.form_onload = function(obj,e)
        {
        	...
        	{
        		this.param = {
        			"popId" : this.getOwnerFrame().popId,
        ...
        *******************************************************************************************************************************/
        this.fnInit = function() {
        	...
        	this.gfnWebBrowserSendPost(this, this.WebBrowser00, url, "type="+this.param.type+"&id=" + this.param.popId);
        };
        /*******************************************************************************************************************************
