(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divForm","20","0",null,"573","20",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("div00");
            obj.set_visible("true");
            this.addChild(obj.name, obj);

            obj = new Static("staSubTitle01","23","610","100%","50",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_WF_SubTitle");
            this.divForm.addChild(obj.name, obj);

            obj = new Button("btnMinDocInfo","1386","618","34","34",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("2");
            ...
            obj = new Panel("Panel01_00","731","610","10%","50",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("3");
            ...
            obj = new Div("Div01","0","0","100.00%","503",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("0");
            obj.set_text("Div00");
            ...
            obj = new Panel("pan04","0","950","100.00%","201",null,null,null,null,null,null,this.divForm.form.Div01.form);
            obj.set_taborder("12");
            obj.set_horizontalgap("20");
            obj.set_flexcrossaxiswrapalign("start");
            obj.set_flexwrap("wrap");
            ...
            obj = new WebBrowser("WebBrowser00","73","230","100%","180",null,null,null,null,null,null,this.divForm.form.Div01.form);
            obj.set_taborder("24");
            obj.set_accessibilitylabel("작업내용");
            this.divForm.form.Div01.addChild(obj.name, obj);
            ...
            obj = new Layout("default","",0,0,this.divForm.form.Div01.form,
                ...
                p.pan04.move("0","950","100.00%","201",null,null);

                p.WebBrowser00.set_taborder("24");
                p.WebBrowser00.set_accessibilitylabel("작업내용");
                p.WebBrowser00.move("73","230","100%","180",null,null);
            ...
            obj = new Layout("default","",0,0,this.divForm.form,
                ...
                p.staSubTitle01.move("23","610","100%","50",null,null);
                ...
                p.btnMinDocInfo.move("1386","618","34","34",null,null);
                ...
                p.Panel01_00.move("731","610","10%","50",null,null);
                ...
                p.Div01.move("0","0","100.00%","503",null,null);
            	}
            );
            obj.set_type("vertical");
            ...
            obj = new Layout("Phone_screen","",0,0,this.divForm.form,
                ...
                var rootobj = p;
                p = rootobj;
                p.sub_tit01.move("-31","645","100%","70",null,null);
            	}
            );
            obj.set_type("vertical");
            this.divForm.form.addLayout(obj.name, obj);
            ...
            obj = new Layout("default","Desktop_screen",1480,600,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.set_titletext("FAQ 상세");

                p.divForm.set_taborder("0");
                p.divForm.set_text("div00");
                p.divForm.set_visible("true");
                p.divForm.move("20","0",null,"573","20",null);
            ...
            obj = new BindItem("item1","divForm.form.Div01.form.edt00","value","dsGet","frstRegNm");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item0","divForm.form.staSubTitle01","text","dsGet","bbsNm");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("COM019P04.xfdl", function() {
        /**
        *  인천국제공항공사 입주자 원스톱 서비스 프로젝트
        *  @FileName 	COM019P04.xfdl
        *  @Creator 	ELUON INS
        ...
        this.fnCallback = function(svcID,errorCode,errorMsg)
        {
        	...
        	switch(svcID)
        	{
        		case "select":
        			...
        			this.gfnWebBrowserSendPost(this, this.divForm.form.Div01.form.WebBrowser00, url, "type=COM019P04&id=" + this.dsGet.getColumn(0, "bbsId"));
        ...
        *******************************************************************************************************************************/
        ...
        // 파일 그리드 더블클릭 이벤트
        this.divForm_Div01_Grid01_oncelldblclick = function(obj,e)
        {
        ...
        *******************************************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.divForm.form.Div01.form.Grid01.addEventHandler("oncelldblclick",this.divForm_Div01_Grid01_oncelldblclick,this);
        ...
        this.loadIncludeScript("COM019P04.xfdl");
