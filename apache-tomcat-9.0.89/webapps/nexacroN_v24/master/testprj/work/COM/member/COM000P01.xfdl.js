(function()
{
    return function()
    {
        ...
        {
            this.set_name("COM000P01");
            this.set_titletext("아이디찾기");
            if (Form == this.constructor)
            {
                this._setFormPosition(1480,550);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"userId\" type=\"STRING\" size=\"256\"/><Column id=\"userNm\" type=\"STRING\" size=\"256\"/><Column id=\"userMblTelno\" type=\"STRING\" size=\"256\"/><Column id=\"userBrdt\" type=\"STRING\" size=\"256\"/><Column id=\"certNo\" type=\"STRING\" size=\"256\"/><Column id=\"type\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"type\">id</Col></Row></Rows>");
            ...
            obj = new Div("divForm","0","0",null,"550","0",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("Div01");
            ...
            obj = new Panel("Panel00","4.00","-5","100.00%","500",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("18");
            obj.set_type("vertical");
            obj.set_verticalgap("20");
            obj.set_fittocontents("height");
            obj.set_flexmainaxisalign("start");
            obj._setContents("<Contents><PanelItem id=\"PanelItem07\" componentid=\"pan01\"/><PanelItem id=\"PanelItem04\" componentid=\"pan02\"/><PanelItem id=\"PanelItem03\" componentid=\"pan03\"/><PanelItem id=\"PanelItem01\" componentid=\"pan04\"/><PanelItem id=\"PanelItem00\" componentid=\"btnYes\"/><PanelItem id=\"PanelItem06\" componentid=\"btnSimple\"/></Contents>");
            ...
            obj = new Panel("pan05","0","20","100.00%","50",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("1");
            ...
            obj.set_fittocontents("height");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"pan05\"/></Contents>");
            this.divForm.addChild(obj.name, obj);

            obj = new Static("staNm","211","290","100%","25",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("3");
            obj.set_text("이름");
            obj.set_cssclass("sta_WF_LoginLabel");
            this.divForm.addChild(obj.name, obj);

            obj = new Edit("edtNm","214","340","100%","40",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("4");
            ...
            obj.set_type("vertical");
            obj.set_fittocontents("height");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"staNm\"/><PanelItem id=\"PanelItem01\" componentid=\"edtNm\"/></Contents>");
            this.divForm.addChild(obj.name, obj);
            ...
            obj = new Panel("pan03","172","321","100%","65",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("8");
            obj.set_type("vertical");
            obj.set_fittocontents("height");
            ...
            obj = new Button("btnCertNo","418","386","130","40",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("11");
            obj.set_text("인증번호받기");
            ...
            obj.set_fittocontents("height");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"edtCertNo\"/><PanelItem id=\"PanelItem01\" componentid=\"btnCertNo\"/></Contents>");
            this.divForm.addChild(obj.name, obj);
            ...
            obj = new Panel("pan06","316","337","100.00%","75",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("14");
            obj.set_type("vertical");
            ...
            obj.set_type("vertical");
            obj.set_fittocontents("height");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"staCertNo\"/><PanelItem id=\"PanelItem04\" componentid=\"pan06\"/></Contents>");
            this.divForm.addChild(obj.name, obj);
            ...
            obj = new Layout("default","",0,0,this.divForm.form,
                ...
                p.Panel00.move("4.00","-5","100.00%","500",null,null);
                ...
                p.pan05.set_cssclass("pan_WF_LoginInfo");
                p.pan05.set_spacing("8px 8px 8px 10px");
                p.pan05.set_type("vertical");
                p.pan05.set_fittocontents("height");
                p.pan05.move("0","20","100.00%","50",null,null);
                ...
                p.staNm.set_taborder("3");
                p.staNm.set_text("이름");
                p.staNm.set_cssclass("sta_WF_LoginLabel");
                p.staNm.move("211","290","100%","25",null,null);

                p.edtNm.set_taborder("4");
                p.edtNm.set_displaynulltext("이름 입력");
                p.edtNm.move("214","340","100%","40",null,null);
                ...
                p.pan03.move("172","321","100%","65",null,null);

                p.staCertNo.set_taborder("9");
                p.staCertNo.set_text("인증번호");
                p.staCertNo.set_cssclass("sta_WF_LoginLabel");
                p.staCertNo.move("232","381","100%","25",null,null);

                p.edtCertNo.set_taborder("10");
                p.edtCertNo.set_password("false");
                p.edtCertNo.set_displaynulltext("인증번호 입력");
                p.edtCertNo.move("222","425","100%","40",null,null);

                p.btnCertNo.set_taborder("11");
                p.btnCertNo.set_text("인증번호받기");
                p.btnCertNo.set_fittocontents("width");
                p.btnCertNo.move("418","386","130","40",null,null);
                ...
                p.pan06.move("316","337","100.00%","75",null,null);
            ...
            this.divForm.form.addLayout(obj.name, obj);
            //-- Default Layout : this
            obj = new Layout("default","Desktop_screen",1480,550,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                p = rootobj;
                p.set_titletext("아이디찾기");
                ...
                p.divForm.move("0","0",null,"550","0",null);
            	}
            );
            ...
            obj = new BindItem("item0","divForm.form.edtNm","value","dsSearch","userNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divForm.form.edtMblTelno","value","dsSearch","userMblTelno");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divForm.form.edtCertNo","value","dsSearch","certNo");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("COM000P01.xfdl", function() {
        /**
        *  인천공항 원스톱 입주자서비스 프로젝트
        *  @FileName 	COM000P01.xfdl
        *  @Creator 	(주)이루온
        ...
        *******************************************************************************************************************************/
        this.form_onload = function(obj,e)
        {
        	...
        	this.validateColumn.push({"title" : "이름", "com": this.divForm.form.edtNm});
        ...
        *******************************************************************************************************************************/
        	...
        	switch(svcID)
        	{
        		case "search":
        			if (!this.gfnIsNull(this.dsList.getColumn(0, "userId"))) {
        				console.log(this.dsList.saveJSON());
        				this.fnSendUserId();
        //				this.close();
        			} else {
        ...
        this.msgCallback = function(svcID, ret)
        {
        	switch(svcID) {
        		case "smsUserId":
        			this.close();
        	...
        	switch(svcID) {
        		case "sms":
        			...
        			if (this.dsList.rowcount > 0) {
        				this.gfnAlertMsg("smsUserId", "MSG_027", "ID가 전송되었습니다.", "msgCallback");
        			} else {
        				this.gfnAlertMsg("smsCertNo", "MSG_027", "인증번호가 전송되었습니다.", "msgCallback");
        			}
        			break;
        	}
        }
        ...
        *******************************************************************************************************************************/
        ...
        this.fnSendUserId = function()
        {
        	var send_num = "15881234";
        	var recipient_num = this.dsList.getColumn(0, "userMblTelno");
        	var contentId = "TSP_36R1";

        	var userId = this.dsList.getColumn(0, "userId");

        	this.dsSms.addColumn("userId", "STRING");
        	...
        	this.dsSms.setColumn(0, "userId", userId);
        ...
        *******************************************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.divForm.form.edtNm.addEventHandler("onkeyup",this.divWork_Div00_Edit00_onkeyup,this);
            this.divForm.form.edtMblTelno.addEventHandler("onkeyup",this.divLogin_Div00_pswd_onkeyup,this);
            this.divForm.form.edtCertNo.addEventHandler("onkeyup",this.divLogin_Div00_pswd_onkeyup,this);
            this.divForm.form.btnCertNo.addEventHandler("onclick",this.divForm_btnCertNo_onclick,this);
        ...
        this.loadIncludeScript("COM000P01.xfdl");
