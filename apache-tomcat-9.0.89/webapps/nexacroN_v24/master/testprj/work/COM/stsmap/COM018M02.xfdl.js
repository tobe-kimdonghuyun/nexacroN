(function()
{
    return function()
    {
        ...
        {
            this.set_name("COM018M02");
            this.set_titletext("현황도 섹터정보 목록");
            ...
            obj.set_fittocontents("height");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"pan01\"/><PanelItem id=\"PanelItem04\" componentid=\"pan02\"/><PanelItem id=\"PanelItem02\" componentid=\"pan03\"/><PanelItem id=\"PanelItem03\" componentid=\"pan04\"/></Contents>");
            ...
            obj = new Grid("grdMapSector","0","PanelGrdBtn:10","100%","500",null,null,null,null,null,null,this.divForm.form.divGrd.form);
            obj.set_taborder("10");
            obj.set_binddataset("dsList");
            obj.set_autofittype("col");
            obj.getSetter("uFunction").set("checkbox");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"217\"/><Column size=\"150\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"65\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"44\" band=\"head\"/><Row size=\"44\"/></Rows><Band id=\"head\"><Cell text=\"섹터번호\"/><Cell col=\"1\" text=\"현황도명\"/><Cell col=\"2\" text=\"섹터명\"/><Cell col=\"3\" text=\"건물번호\"/><Cell col=\"4\" text=\"건물명\"/><Cell col=\"5\" text=\"층\"/><Cell col=\"6\" text=\"등록자명\"/><Cell col=\"7\" cssclass=\"CellEnd\" text=\"등록일시\"/></Band><Band id=\"body\"><Cell text=\"bind:stsmapSctrId\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:stsmapNm\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:stsmapSctrNm\" textAlign=\"center\"/><Cell col=\"3\" text=\"bind:stsmapBno\" textAlign=\"center\"/><Cell col=\"4\" text=\"bind:stsmapBldgNm\" textAlign=\"center\"/><Cell col=\"5\" text=\"bind:stsmapFlr\" textAlign=\"center\"/><Cell col=\"6\" text=\"bind:frstRegNm\" textAlign=\"center\"/><Cell col=\"7\" cssclass=\"CellEnd\" text=\"bind:frstRegDt\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd HH:mm:ss\" calendareditformat=\"yyyy-MM-dd HH:mm:ss\" textAlign=\"center\"/></Band></Format></Formats>");
            this.divForm.form.divGrd.addChild(obj.name, obj);

            obj = new Div("divPage","0","grdMapSector:10",null,"36","0",null,null,null,"36",null,this.divForm.form.divGrd.form);
            obj.set_taborder("0");
            obj.set_text("Div00");
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divGrd.form,
                ...
                p.grdMapSector.set_taborder("10");
                p.grdMapSector.set_binddataset("dsList");
                p.grdMapSector.set_autofittype("col");
                p.grdMapSector.getSetter("uFunction").set("checkbox");
                p.grdMapSector.move("0","PanelGrdBtn:10","100%","500",null,null);
                ...
                p.divPage.move("0","grdMapSector:10",null,"36","0",null);
            ...
            obj = new Layout("mobile","",0,0,this.divForm.form.divGrd.form,
                ...
                var rootobj = p;
                p = rootobj;
                p.grdMapSector.set_autofittype("none");
            	}
            );
            obj.set_verticalgap("20");
            this.divForm.form.divGrd.form.addLayout(obj.name, obj);
            ...
            obj = new BindItem("item3","divForm.form.divSch.form.edt00_01_00","value","dsSearch","frstRegId");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divForm.form.divSch.form.edt00_01_00_00","value","dsSearch","stsmapNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","divForm.form.divSch.form.edt00_01_00_01","value","dsSearch","frstRegNm");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("COM018M02.xfdl", function() {
        /**
        *  인천공항 원스톱 입주자서비스 프로젝트
        *  @FileName 	COM018M02.xfdl
        *  @Creator 	(주)이루온
        ...
        *******************************************************************************************************************************/
        ...
        this.gridSaveTransaction = function()
        {
        	...
        	var inData      = "dsSectorList=dsList:U";
        	var outData     = "";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        	var isAsync   	= false;
        ...
        *******************************************************************************************************************************/
        ...
        this.divForm_divGrd_btnGrdExcel_onclick = function(obj,e)
        {
        	...
        	var ret = this.exportObj.addExportItem(nexacro.ExportItemTypes.GRID, this.divForm.form.divGrd.form.grdMapSector, "Sheet1!A1");
        ...
        this.divForm_divGrd_btnGrdExcel01_onclick = function(obj,e)
        {
        	...
        	var url = "/stsmap/mapSectorExcel.do";
        ...
        this.divPopBtn_Button00_00_onclick = function(obj,e)
        {
        	...
        	if(this.objApp.screenid == "Desktop_screen") {
        		...
        		var sMenuUrl = 'work::COM/stsmap/COM018P02.xfdl';
        		var actNm = '추가/상세';
        	...
        	// 		, height: 800			//width,height 지정하지 않음 popup form size적용
        		...
        		this.gfnOpenPopup("COM018P02", "work::COM/stsmap/COM018P02.xfdl", param, sPopupCallBack, objOption);
        	}
        };

        this.divForm_divGrd_grdMapSector_oncellclick = function(obj,e)
        {
        	if(e.cell == 1)
        	{
        		var stsmapId = this.dsList.getColumn(e.row, "stsmapId");
        		var stsmapSctrId = this.dsList.getColumn(e.row, "stsmapSctrId");
        		var param = {
        			"stsmapId" : stsmapId,
        ...
        this.on_initEvent = function()
        {
            ...
            this.divForm.form.divGrd.form.grdMapSector.addEventHandler("oncellclick",this.divForm_divGrd_grdMapSector_oncellclick,this);
        ...
        this.loadIncludeScript("COM018M02.xfdl");
