(function()
{
    return function()
    {
        ...
        {
            this.set_name("COM018M01");
            this.set_titletext("현황도 이미지 목록");
            ...
            obj.set_fittocontents("height");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"pan01\"/><PanelItem id=\"PanelItem01\" componentid=\"pan02\"/><PanelItem id=\"PanelItem05\" componentid=\"pan03\"/><PanelItem id=\"PanelItem04\" componentid=\"pan04\"/></Contents>");
            ...
            obj = new Panel("pan03","20.00","67","560","40",null,null,null,null,null,null,this.divForm.form.divSch.form);
            obj.set_taborder("6");
            obj.set_type("horizontal");
            ...
            obj.set_fittocontents("height");
            obj.set_flexgrow("1");
            obj._setContents("<Contents><PanelItem id=\"PanelItem03\" componentid=\"staLabel03_00\"/><PanelItem id=\"PanelItem01\" componentid=\"edt00_01_00_00_00\"/></Contents>");
            this.divForm.form.divSch.addChild(obj.name, obj);
            ...
            obj.set_fittocontents("height");
            obj.set_flexgrow("1");
            obj._setContents("<Contents><PanelItem id=\"PanelItem03\" componentid=\"staLabel03_02\"/><PanelItem id=\"PanelItem02\" componentid=\"edt00_01_00_00\"/></Contents>");
            this.divForm.form.divSch.addChild(obj.name, obj);
            ...
            obj = new Grid("grdStsImg","0","PanelGrdBtn:10","100%","500",null,null,null,null,null,null,this.divForm.form.divGrd.form);
            obj.set_taborder("10");
            obj.set_binddataset("dsList");
            obj.set_autofittype("col");
            obj.getSetter("uFunction").set("checkbox");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"150\"/><Column size=\"50\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"200\"/><Column size=\"100\"/><Column size=\"150\"/></Columns><Rows><Row size=\"44\" band=\"head\"/><Row size=\"44\"/></Rows><Band id=\"head\"><Cell text=\"현황도명\"/><Cell col=\"1\" text=\"유형\"/><Cell col=\"2\" text=\"위치\"/><Cell col=\"3\" text=\"이미지명\"/><Cell col=\"4\" text=\"이미지경로\"/><Cell col=\"5\" text=\"등록자명\"/><Cell col=\"6\" cssclass=\"CellEnd\" text=\"등록일시\"/></Band><Band id=\"body\"><Cell text=\"bind:stsmapNm\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:stsmapTyNm\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:stsmapPstnNm\" textAlign=\"center\"/><Cell col=\"3\" text=\"bind:orgnlFileNm\" textAlign=\"center\"/><Cell col=\"4\" text=\"bind:flpth\" textAlign=\"center\"/><Cell col=\"5\" text=\"bind:frstRegNm\" textAlign=\"center\"/><Cell col=\"6\" cssclass=\"CellEnd\" text=\"bind:frstRegDt\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd HH:mm:ss\" calendareditformat=\"yyyy-MM-dd HH:mm:ss\" textAlign=\"center\"/></Band></Format></Formats>");
            this.divForm.form.divGrd.addChild(obj.name, obj);

            obj = new Div("divPage","0","grdStsImg:10",null,"36","0",null,null,null,"36",null,this.divForm.form.divGrd.form);
            obj.set_taborder("0");
            obj.set_text("Div00");
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divSch.form,
                ...
                p.pan03.move("20.00","67","560","40",null,null);
                ...
                p.staLabel.set_taborder("10");
                p.staLabel.set_text("등록자명");
                ...
                p.staLabel03_02.set_taborder("13");
                p.staLabel03_02.set_text("등록자ID");
                ...
                p.edt00_01_00_00.set_taborder("15");
                ...
                p.edt00_01_00_00_00.set_displaynulltext("현황도명");
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divGrd.form,
                ...
                p.grdStsImg.set_taborder("10");
                p.grdStsImg.set_binddataset("dsList");
                p.grdStsImg.set_autofittype("col");
                p.grdStsImg.getSetter("uFunction").set("checkbox");
                p.grdStsImg.move("0","PanelGrdBtn:10","100%","500",null,null);
                ...
                p.divPage.move("0","grdStsImg:10",null,"36","0",null);
            ...
            obj = new Layout("mobile","",0,0,this.divForm.form.divGrd.form,
                ...
                var rootobj = p;
                p = rootobj;
                p.grdStsImg.set_autofittype("none");
            	}
            );
            obj.set_verticalgap("20");
            this.divForm.form.divGrd.form.addLayout(obj.name, obj);
            ...
            obj = new BindItem("item2","divForm.form.divSch.form.edt00_01_00_00","value","dsSearch","frstRegId");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divForm.form.divSch.form.edt00_01_00_00_00","value","dsSearch","stsmapNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divForm.form.divSch.form.edt00_01_00","value","dsSearch","frstRegNm");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item6","divForm.form.divGrd.form.cmbGrdList","value","dsSearch","recordCountPerPage");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("COM018M01.xfdl", function() {
        /**
        *  인천공항 원스톱 입주자서비스 프로젝트
        *  @FileName 	COM018M01.xfdl
        *  @Creator 	(주)이루온
        ...
        *******************************************************************************
        * 2024/11/06				김완성						최초생성
        * 2024/12/31				조규완						삭제기능 추가, 디자인 수정, 엑셀 다운로드 추가
        *******************************************************************************
        */
        ...
        *******************************************************************************************************************************/
        ...
        {
        	var strSvcId    = "save";
        	var strSvcUrl   = "stsmap/malImgInfoStrg.do";
        ...
        *******************************************************************************************************************************/
        ...
        this.divForm_divGrd_btnGrdExcel_onclick = function(obj,e)
        {
        	...
        	var ret = this.exportObj.addExportItem(nexacro.ExportItemTypes.GRID, this.divForm.form.divGrd.form.grdStsImg, "Sheet1!A1");
        ...
        this.divPopBtn_Button00_00_onclick = function(obj,e)
        {
        	...
        	if(this.objApp.screenid == "Desktop_screen") {
        		...
        		var sMenuUrl = 'work::COM/stsmap/COM018P01.xfdl';
        		var actNm = '추가/상세';
        	...
        	// 		, height: 800			//width,height 지정하지 않음 popup form size적용
        		...
        		this.gfnOpenPopup("COM018P01", "work::COM/stsmap/COM018P01.xfdl", objArg, sPopupCallBack, objOption);
        	}
        };

        this.divForm_divGrd_grdStsImg_oncellclick = function(obj,e)
        {
        	if(e.cell == 1)
        	{
        		var stsmapId = this.dsList.getColumn(e.row, "stsmapId");
        		var objArg = {
        			"stsmapId" : stsmapId
        		};
        ...
        this.on_initEvent = function()
        {
            ...
            this.divForm.form.divGrd.form.grdStsImg.addEventHandler("oncellclick",this.divForm_divGrd_grdStsImg_oncellclick,this);
        ...
        this.loadIncludeScript("COM018M01.xfdl");
