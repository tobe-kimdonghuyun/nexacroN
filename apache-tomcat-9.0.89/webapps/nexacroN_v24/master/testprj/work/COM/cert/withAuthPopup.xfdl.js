(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("WITH AUTH POPUP");
        ...
        // User Script
        this.registerScript("withAuthPopup.xfdl", function() {
        /**
        ...
        *******************************************************************************************************************************/
        ...
        {
        	//this.WebBrowser00.url = this.objSrv.url + "withauth/auth_request.jsp";
        	var url = "/withauth/auth_request.jsp";
        ...
        *******************************************************************************************************************************/
        ...
        {
        	this.dsToken.setColumn(0, "token", e.userdata.resMessage.token);
        ...
        this.loadIncludeScript("withAuthPopup.xfdl");
