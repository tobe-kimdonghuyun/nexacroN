(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("HANDY POPUP");
        ...
        // User Script
        this.registerScript("handyPopup.xfdl", function() {
        /**
        ...
        *******************************************************************************************************************************/
        this.form_onload = function(obj,e)
        {
        	if(this.opener)
        	{
        		this.dsMap.setColumn(0, "K", this.getOwnerFrame().K);
        		this.dsMap.setColumn(0, "formid", this.getOwnerFrame().formid);
        		this.dsMap.setColumn(0, "empcode", this.getOwnerFrame().empcode);
        		this.dsMap.setColumn(0, "deptcode", this.getOwnerFrame().deptcode);
        		this.dsMap.setColumn(0, "miskey", this.getOwnerFrame().miskey);
        	}

        	var url = "handy.html";
        	this.gfnWebBrowserSendPostDs(this, this.WebBrowser00, url, this.dsMap);
        	this.fnInit();
        };
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("handyPopup.xfdl");
