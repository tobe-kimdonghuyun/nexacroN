(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"업무분류\" type=\"STRING\" size=\"256\"/><Column id=\"업체기관명\" type=\"STRING\" size=\"256\"/><Column id=\"건물명\" type=\"STRING\" size=\"256\"/><Column id=\"크기\" type=\"STRING\" size=\"256\"/><Column id=\"용도\" type=\"STRING\" size=\"256\"/><Column id=\"제출일\" type=\"STRING\" size=\"256\"/><Column id=\"진행상태\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"업무분류\">공항운영그룹</Col><Col id=\"업체기관명\">AAA공항</Col><Col id=\"건물명\">정부합동청사</Col><Col id=\"크기\">60</Col><Col id=\"용도\">사무실</Col><Col id=\"제출일\">2024-06-27</Col><Col id=\"진행상태\">임차 대기중</Col></Row><Row><Col id=\"업무분류\">공항운영그룹</Col><Col id=\"업체기관명\">AAA공항</Col><Col id=\"건물명\">정부합동청사</Col><Col id=\"크기\">60</Col><Col id=\"용도\">사무실</Col><Col id=\"제출일\">2024-06-27</Col><Col id=\"진행상태\">임차 대기중</Col></Row><Row><Col id=\"업무분류\">공항운영그룹</Col><Col id=\"업체기관명\">AAA공항</Col><Col id=\"건물명\">정부합동청사</Col><Col id=\"크기\">60</Col><Col id=\"용도\">사무실</Col><Col id=\"제출일\">2024-06-27</Col><Col id=\"진행상태\">임차 대기중</Col></Row><Row><Col id=\"업무분류\">공항운영그룹</Col><Col id=\"업체기관명\">AAA공항</Col><Col id=\"건물명\">정부합동청사</Col><Col id=\"크기\">60</Col><Col id=\"용도\">사무실</Col><Col id=\"제출일\">2024-06-27</Col><Col id=\"진행상태\">임차 대기중</Col></Row><Row><Col id=\"업무분류\">공항운영그룹</Col><Col id=\"업체기관명\">AAA공항</Col><Col id=\"건물명\">정부합동청사</Col><Col id=\"크기\">60</Col><Col id=\"용도\">사무실</Col><Col id=\"제출일\">2024-06-27</Col><Col id=\"진행상태\">임차적합성 검토중</Col></Row><Row><Col id=\"업무분류\">공항운영그룹</Col><Col id=\"업체기관명\">AAA공항</Col><Col id=\"건물명\">정부합동청사</Col><Col id=\"크기\">60</Col><Col id=\"용도\">사무실</Col><Col id=\"제출일\">2024-06-27</Col><Col id=\"진행상태\">임차적합성 검토중</Col></Row><Row><Col id=\"업무분류\">공항운영그룹</Col><Col id=\"업체기관명\">AAA공항</Col><Col id=\"건물명\">정부합동청사</Col><Col id=\"크기\">60</Col><Col id=\"용도\">사무실</Col><Col id=\"제출일\">2024-06-27</Col><Col id=\"진행상태\">임차 대기중</Col></Row><Row><Col id=\"업무분류\">공항운영그룹</Col><Col id=\"업체기관명\">AAA공항</Col><Col id=\"건물명\">정부합동청사</Col><Col id=\"크기\">60</Col><Col id=\"용도\">사무실</Col><Col id=\"제출일\">2024-06-27</Col><Col id=\"진행상태\">임차 대기중</Col></Row><Row><Col id=\"업무분류\">공항운영그룹</Col><Col id=\"업체기관명\">AAA공항</Col><Col id=\"건물명\">정부합동청사</Col><Col id=\"크기\">60</Col><Col id=\"용도\">사무실</Col><Col id=\"제출일\">2024-06-27</Col><Col id=\"진행상태\">임차 대기중</Col></Row><Row><Col id=\"업무분류\">공항운영그룹</Col><Col id=\"업체기관명\">AAA공항</Col><Col id=\"건물명\">정부합동청사</Col><Col id=\"크기\">60</Col><Col id=\"용도\">사무실</Col><Col id=\"제출일\">2024-06-27</Col><Col id=\"진행상태\">임차 대기중</Col></Row></Rows>");
            ...
            obj = new Panel("PanelLabel","20.00","14","100%","103",null,null,null,null,null,null,this.divForm.form.divSch.form);
            obj.set_taborder("0");
            ...
            obj.set_horizontalgap("10");
            obj._setContents("<Contents><PanelItem id=\"PanelItem04\" componentid=\"staTotal00\"/><PanelItem id=\"PanelItem01\" componentid=\"Combo00\"/><PanelItem id=\"PanelItem05\" componentid=\"btnGrdDw\"/></Contents>");
            this.divForm.form.divGrd.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"59\"/><Column size=\"90\"/><Column size=\"200\"/><Column size=\"200\"/><Column size=\"200\"/><Column size=\"200\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"56\" band=\"head\"/><Row size=\"48\"/></Rows><Band id=\"head\"><Cell text=\"사용자ID\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"순번\"/><Cell col=\"2\" text=\"청구일자\"/><Cell col=\"3\" text=\"청구고객코드\"/><Cell col=\"4\" text=\"청구고객명\"/><Cell col=\"5\" text=\"계량기관리번호\"/><Cell col=\"6\" text=\"계약구분\"/><Cell col=\"7\" text=\"사용료코드\"/><Cell col=\"8\" text=\"사용료명\"/><Cell col=\"9\" text=\"사용료유형코드\"/></Band><Band id=\"body\"><Cell text=\"bind:chk\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"bind:업체기관명\" displaytype=\"text\"/><Cell col=\"2\" text=\"bind:건물명\" displaytype=\"text\"/><Cell col=\"3\" text=\"bind:크기\" displaytype=\"text\"/><Cell col=\"4\" text=\"bind:용도\" displaytype=\"text\"/><Cell col=\"5\" text=\"bind:진행상태\" displaytype=\"text\" cssclass=\"expr:state==&apos;0&apos;?&apos;CellTxtRed&apos;:&apos;CellTxtBlue&apos;\"/><Cell col=\"6\"/><Cell col=\"7\"/><Cell col=\"8\"/><Cell col=\"9\"/></Band></Format></Formats>");
            this.divForm.form.divGrd.addChild(obj.name, obj);
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divSch.form,
                ...
                p.PanelLabel.move("20.00","14","100%","103",null,null);
