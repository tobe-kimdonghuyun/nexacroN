(function()
{
    return function()
    {
        ...
        {
            this.set_name("COM031M21");
            this.set_titletext("통계기준정보관리");
            ...
            obj._setContents("<ColumnInfo><Column id=\"currentPageNo\" type=\"STRING\" size=\"256\"/><Column id=\"recordCountPerPage\" type=\"STRING\" size=\"256\"/><Column id=\"sDate\" type=\"STRING\" size=\"256\"/><Column id=\"eDate\" type=\"STRING\" size=\"256\"/><Column id=\"useYn\" type=\"STRING\" size=\"256\"/><Column id=\"ttl\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"recordCountPerPage\">99999</Col><Col id=\"currentPageNo\">1</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj.set_fittocontents("height");
            obj._setContents("<Contents><PanelItem id=\"PanelItem02\" componentid=\"pan00\"/><PanelItem id=\"PanelItem03\" componentid=\"pan01\"/><PanelItem id=\"PanelItem01\" componentid=\"pan02\"/></Contents>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"50\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"44\" band=\"head\"/><Row size=\"44\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"순번\"/><Cell col=\"2\" text=\"제목\"/><Cell col=\"3\" text=\"설명\"/><Cell col=\"4\" text=\"사용여부\"/><Cell col=\"5\" text=\"등록자명\"/><Cell col=\"6\" cssclass=\"CellEnd\" text=\"등록일시\"/></Band><Band id=\"body\"><Cell text=\"bind:calYmd\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"bind:dowCd\"/><Cell col=\"2\" text=\"bind:hldyCd\"/><Cell col=\"3\" text=\"bind:frstRegDt\"/><Cell col=\"4\"/><Cell col=\"5\"/><Cell col=\"6\" cssclass=\"CellEnd\"/></Band></Format></Formats>");
            this.divForm.form.divGrd.addChild(obj.name, obj);
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divGrd.form,
                ...
                p.cmbGrdList.set_text("전체");
                p.cmbGrdList.set_value("0");
            ...
            obj = new BindItem("item3","divForm.form.divSch.form.cbo00_00","value","dsSearch","useYn");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divForm.form.divSch.form.Edit01_00","value","dsSearch","ttl");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("COM031M21.xfdl", function() {
        /**
        *  인천공항 원스톱 입주자서비스 프로젝트
        *  @FileName 	COM031M21.xfdl
        *  @Creator 	(주)이루온
        ...
        *******************************************************************************************************************************/
        this.getSearchTransaction = function() {
        	...
        	var strSvcId    = "search";
        	var strSvcUrl   = "stats/irglrStatsCrtrInfoListInq.do";
        ...
        *******************************************************************************************************************************/
        ...
        this.divPopBtn_Button00_00_onclick = function(obj,e)
        {
        	...
        	var sMenuUrl = 'work::COM/stats/COM031P21.xfdl';
        	var actNm = '추가/상세';
        ...
        this.loadIncludeScript("COM031M21.xfdl");
