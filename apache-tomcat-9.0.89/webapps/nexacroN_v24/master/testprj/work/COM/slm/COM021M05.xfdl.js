(function()
{
    return function()
    {
        ...
        {
            this.set_name("COM021M05");
            this.set_titletext("SLM 평가대상 서비스그룹 현황");
            ...
            obj = new Div("divForm","0","70",null,"1080","60",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("div00");
            ...
            obj = new Grid("Grid00","0","94","100.00%","310",null,null,null,null,null,null,this.divForm.form.divGrdL.form);
            obj.set_taborder("0");
            obj.set_binddataset("dsSrvcGroupList");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"200\"/><Column size=\"200\"/></Columns><Rows><Row size=\"44\" band=\"head\"/><Row size=\"44\"/></Rows><Band id=\"head\"><Cell text=\"평가대상 서비스그룹 ID\"/><Cell col=\"1\" text=\"설정 상태\"/></Band><Band id=\"body\"><Cell text=\"bind:srvcGroupId\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:evlStat\" textAlign=\"center\" expr=\"evlStat == &apos;Y&apos; ? &apos;사용&apos; : &apos;&apos;\"/></Band></Format></Formats>");
            this.divForm.form.divGrdL.addChild(obj.name, obj);
            ...
            obj = new Grid("Grid00","0","94","100.00%","310",null,null,null,null,null,null,this.divForm.form.divGrdR.form);
            obj.set_taborder("0");
            ...
            obj = new Div("divGrd","0","30","100.00%","468",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("5");
            obj.set_text("Div01");
            obj.set_fittocontents("height");
            obj.set_formscrollbartype("none none");
            ...
            obj = new Grid("Grid00","0","94","100.00%","380",null,null,null,null,null,null,this.divForm.form.divGrd.form);
            obj.set_taborder("0");
            ...
            obj = new Button("btnPop","615","5","162","40",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("평가대상 서비스그룹 관리");
            obj.set_fittocontents("width");
            this.addChild(obj.name, obj);

            obj = new Panel("panBtn","0","divForm:10","100.00%","50",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_horizontalgap("10");
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divGrdL.form,
                ...
                p.Grid00.move("0","94","100.00%","310",null,null);
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divGrd.form,
                ...
                p = rootobj;
                p.Static00.set_taborder("8");
                p.Static00.set_text("평가대상 서비스그룹 상세 현황");
                p.Static00.set_cssclass("sta_WF_Txt60018");
                p.Static00.move("0","0","100%","34",null,null);
                ...
                p.Grid00.set_autofittype("col");
                p.Grid00.move("0","94","100.00%","380",null,null);
            ...
            obj = new Layout("default","",0,0,this.divForm.form,
                ...
                p.divGrd.move("0","30","100.00%","468",null,null);
            	}
            );
            obj.set_type("vertical");
            obj.set_verticalgap("20");
            ...
            obj = new Layout("default","Desktop_screen",1480,1200,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.set_titletext("SLM 평가대상 서비스그룹 현황");
                ...
                p.divForm.move("0","70",null,"1080","60",null);
                ...
                p.btnPop.set_text("평가대상 서비스그룹 관리");
                p.btnPop.set_fittocontents("width");
                p.btnPop.move("615","5","162","40",null,null);
                ...
                p.panBtn.move("0","divForm:10","100.00%","50",null,null);
            	}
            );
            ...
            obj = new Layout("Layout0","Phone_screen",480,1200,this,
                ...
                p.divForm.move("0","70",null,"1080","0",null);
            	}
            );
            obj.set_mobileorientation("Landscape");
            obj.set_type("default");
        ...
        // User Script
        this.registerScript("COM021M05.xfdl", function() {
        /**
        *  인천국제공항공사 입주자 원스톱 서비스 프로젝트
        *  @FileName 	COM021M05.xfdl
        *  @Creator 	ELUON INS
        ...
        *******************************************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.btnPop.addEventHandler("onclick",this.divForm_tabSlm_tpg02_btnPop01_onclick,this);
            this.dsSrvcGroupList.addEventHandler("onrowposchanged",this.dsSrvcGroupList_onrowposchanged,this);
        };
        this.loadIncludeScript("COM021M05.xfdl");
