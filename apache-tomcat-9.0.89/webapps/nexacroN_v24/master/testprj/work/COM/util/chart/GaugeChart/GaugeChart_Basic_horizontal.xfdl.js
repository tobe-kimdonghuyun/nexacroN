(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new GaugeChart("GaugeChart01","0.65%","52%",null,null,"1.04%","2.08%",null,null,null,null,this);
            obj.getSetter("taborder").set("0");
            obj.getSetter("binddataset").set("ds_highlight");
            obj.getSetter("categorycolumn").set("bind:Column0");
            obj.getSetter("gaugetype").set("horizontal");
            this.addChild(obj.name, obj);

            obj = new GaugeChart("GaugeChart00","1.3%","2.08%",null,null,"2.34%","48%",null,null,null,null,this);
        ...
        this.loadIncludeScript("GaugeChart_Basic_horizontal.xfdl");
