(function()
{
    return function()
    {
        ...
        {
            this.set_name("COM010M04");
            this.set_titletext("부패신고등록");
            ...
            //-- Normal Layout : this
            obj = new Layout("Layout0","Phone_screen",480,1100,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                p = rootobj;
                p.divForm.move("0","0",null,"1672","0",null);
            	}
            );
            obj.set_mobileorientation("Landscape");
        ...
        // User Script
        this.registerScript("COM010M04.xfdl", function() {
        /**
        *  PcMdi 프로젝트
        *  @FileName 	COM010M04.xfdl
        *  @Creator 	TOBESOFT
        ...
        *******************************************************************************************************************************/
        this.form_onload = function(obj,e)
        {
        	...
        	this.dsGet.setColumn(0, "aplySe", "04"); // 신청구분
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("COM010M04.xfdl");
