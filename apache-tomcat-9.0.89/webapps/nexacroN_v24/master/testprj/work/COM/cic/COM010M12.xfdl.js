(function()
{
    return function()
    {
        ...
        {
            this.set_name("COM010M12");
            this.set_titletext("분야별통계");
            ...
            obj = new Panel("Panel00","20.00","14","320","40",null,null,null,null,null,null,this.divForm.form.divSch.form);
            obj.set_taborder("8");
            ...
            obj.set_flexgrow("1");
            obj.set_fittocontents("height");
            obj._setContents("<Contents><PanelItem id=\"PanelItem02\" componentid=\"staLabel03_00\"/><PanelItem id=\"PanelItem01\" componentid=\"cmbSrvcSe\"/></Contents>");
            this.divForm.form.divSch.addChild(obj.name, obj);
            ...
            obj = new Combo("cmbSrvcSe","788.00","145","20.42%","40",null,null,null,null,null,null,this.divForm.form.divSch.form);
            obj.set_taborder("6");
            obj.set_flexgrow("1");
            ...
            obj = new Panel("Panel00","1021","0","180","34",null,null,null,null,null,null,this.divForm.form.divGrd.form);
            obj.set_taborder("7");
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divSch.form,
                ...
                p.Panel00.move("20.00","14","320","40",null,null);
                ...
                p.cmbSrvcSe.move("788.00","145","20.42%","40",null,null);
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divGrd.form,
                ...
                p.Panel00.move("1021","0","180","34",null,null);
                ...
                p.grdList.move("0","54","100%","606",null,null);
            	}
            );
            ...
            obj = new Layout("Layout0","",0,0,this.divForm.form.divGrd.form,
                ...
                var rootobj = p;
                p = rootobj;
                p.grdList.move("0","54","100%","800",null,null);
            	}
            );
            obj.set_verticalgap("8");
            obj.set_type("vertical");
            ...
            obj = new Layout("Layout0","",0,0,this.divForm.form,
                ...
                p.divGrd.move("20","226","100%","847",null,null);
            	}
            );
            obj.set_type("vertical");
            ...
            obj = new Layout("Layout0","Phone_screen",480,600,this,
                ...
                p.divForm.move("0","70",null,"1089","0",null);
            ...
            obj = new BindItem("item1","divForm.form.divSch.form.cmbSrvcSe","value","dsSearch","aplySe");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("COM010M12.xfdl", function() {
        /**
        ...
        *******************************************************************************************************************************/
        ...
        {
        	var strSvcId    = "search";
        	var strSvcUrl   = "cic/statsPerFldInq.do";
        ...
        *******************************************************************************************************************************/
        	...
        	if(e.cell != 0) {
        		if(obj.getCellValue(e.row, e.cell) != 0) {
        			if(this.objApp.screenid == "Phone_screen") {
        				...
        				this.gfnOpenPopup("COM010M07", "work::COM/cic/COM010M07.xfdl", objArg, sPopupCallBack, objOption);
        			} else {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divForm.form.divSch.form.cmbYear.addEventHandler("onitemchanged",this.divForm_divSch_Combo01_onitemchanged,this);
        ...
        this.loadIncludeScript("COM010M12.xfdl");
