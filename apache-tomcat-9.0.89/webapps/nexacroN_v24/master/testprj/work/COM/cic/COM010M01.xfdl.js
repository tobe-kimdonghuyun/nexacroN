(function()
{
    return function()
    {
        ...
        {
            this.set_name("COM010M01");
            this.set_titletext("제안접수등록");
            if (Form == this.constructor)
            {
                this._setFormPosition(1480,978);
            }
            ...
            obj = new Div("divForm","0","50",null,"978","60",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("div00");
            ...
            obj = new Div("Div00","0","0","100.00%","898",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("0");
            obj.set_text("Div00");
            ...
            obj.set_type("vertical");
            obj.set_flexgrow("1");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"staLabel05_00_00\"/><PanelItem id=\"PanelItem02\" componentid=\"edtUserEml\"/></Contents>");
            this.divForm.form.Div00.addChild(obj.name, obj);
            ...
            obj = new Panel("pan04_02_00","10.00","98","300","86",null,null,null,null,null,null,this.divForm.form.Div00.form);
            obj.set_taborder("14");
            obj.set_type("vertical");
            obj.set_flexgrow("1");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"staLabel05_01_00\"/><PanelItem id=\"PanelItem02\" componentid=\"cmbSrvcSe\"/></Contents>");
            this.divForm.form.Div00.addChild(obj.name, obj);
            ...
            obj.set_spacing("0px 20px 10px 20px");
            obj.set_cssclass("pal_WF_DtlBg");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"pan04_01_00\"/><PanelItem id=\"PanelItem02\" componentid=\"pan04_02_00\"/></Contents>");
            this.divForm.form.Div00.addChild(obj.name, obj);
            ...
            obj.set_spacing("0px 20px 10px 20px");
            obj.set_cssclass("pal_WF_DtlBg");
            obj._setContents("<Contents><PanelItem id=\"PanelItem03\" componentid=\"pan00_01_00_00\"/></Contents>");
            this.divForm.form.Div00.addChild(obj.name, obj);

            obj = new Panel("pan02","0","60","100%","360",null,null,null,null,null,null,this.divForm.form.Div00.form);
            obj.set_taborder("10");
            obj.set_horizontalgap("20");
            obj.set_flexcrossaxiswrapalign("start");
            obj.set_flexwrap("wrap");
            ...
            obj = new TextArea("txtAskCn","0","265","100%","245",null,null,null,null,null,null,this.divForm.form.Div00.form);
            obj.set_taborder("39");
            this.divForm.form.Div00.addChild(obj.name, obj);

            obj = new Panel("panFile","0","42","100.00%","250",null,null,null,null,null,null,this.divForm.form.Div00.form);
            obj.set_taborder("28");
            obj.set_fittocontents("height");
            ...
            obj = new Panel("Panel04_02_00_00","0","270","100.00%","80",null,null,null,null,null,null,this.divForm.form.Div00.form);
            obj.set_taborder("38");
            obj.set_fittocontents("height");
            obj.set_type("vertical");
            obj.set_flexgrow("1");
            ...
            obj = new Layout("default","",0,0,this.divForm.form.Div00.form,
                ...
                p.staLabel05_00_00.set_text("이메일주소");
                ...
                p.pan02.move("0","60","100%","360",null,null);

                p.txtAskCn.set_taborder("39");
                p.txtAskCn.move("0","265","100%","245",null,null);

                p.panFile.set_taborder("28");
                ...
                p.edtEtcMttr.set_taborder("32");
                p.edtEtcMttr.set_readonly("true");
                p.edtEtcMttr.set_maxlength("33");
                p.edtEtcMttr.move("10.00","158","100%","40",null,null);

                p.pan00_01_00_00.set_taborder("33");
                ...
                p.Panel04_02_00_00.set_taborder("38");
                ...
                p.Panel04_02_00_00.move("0","270","100.00%","80",null,null);
            	}
            );
            obj.set_type("vertical");
            ...
            obj = new Layout("mobile","",0,0,this.divForm.form.Div00.form,
                ...
                p.pan04_00.move("0","60","100.00%","183",null,null);
            ...
            obj = new Layout("default","",0,0,this.divForm.form,
                ...
                p.Div00.move("0","0","100.00%","898",null,null);
            ...
            obj = new Layout("mobile","",0,0,this.divForm.form,
                ...
                var rootobj = p;
                p = rootobj;
                p.Div00.move("0","0","100%","1161",null,null);
            	}
            );
            ...
            //-- Default Layout : this
            obj = new Layout("default","Desktop_screen",1480,978,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                p = rootobj;
                p.set_titletext("제안접수등록");
                ...
                p.divForm.move("0","50",null,"978","60",null);
            ...
            obj = new Layout("mobile","Phone_screen",480,900,this,
                ...
                p.divForm.move("0","0","100.00%","1231",null,null);
            	}
            );
            obj.set_mobileorientation("Landscape");
            ...
            obj = new BindItem("item4","divForm.form.Div00.form.cmbSrvcSe","value","dsGet","srvcSe");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","divForm.form.Div00.form.edtEtcMttr","value","dsGet","etcMttr");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","divForm.form.Div00.form.txtAskCn","value","dsGet","askCn");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("COM010M01.xfdl", function() {
        /**
        *  PcMdi 프로젝트
        *  @FileName 	COM010M01.xfdl
        *  @Creator 	TOBESOFT
        ...
        *******************************************************************************************************************************/
        this.form_onload = function(obj,e)
        {
        	...
        	this.dsGet.setColumn(0, "aplySe", "01"); // 신청구분
        	...
        	if(sPopupId == "save_file") {
        		if(oRtn.result == "Y")
        		{
        			var obj = {
        				...
        				"bsnsSeCd" : "COM",			// 업무구분코드
        				"prgrmId" : "COM010M01" 	// 프로그램ID (화면 ID)
        			}
        ...
        *******************************************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.divForm.form.Div00.form.Button00.addEventHandler("onclick",this.divForm_Div00_btn_del_file_1_onclick,this);
        ...
        this.loadIncludeScript("COM010M01.xfdl");
