(function()
{
    return function()
    {
        ...
        {
            this.set_name("COM010M02");
            this.set_titletext("불편문의등록");
            ...
            obj = new Div("divForm","0","50",null,"983","60",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("div00");
            ...
            obj = new Div("Div00","0","0","100.00%","903",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("0");
            obj.set_text("Div00");
            ...
            obj.set_spacing("0px 20px 10px 20px");
            obj.set_cssclass("pal_WF_DtlBg");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"pan04_01_00_00_00\"/><PanelItem id=\"PanelItem01\" componentid=\"pan04_01_00_00\"/><PanelItem id=\"PanelItem02\" componentid=\"pan04_01_00\"/></Contents>");
            this.divForm.form.Div00.addChild(obj.name, obj);
            ...
            obj.set_type("vertical");
            obj.set_flexgrow("1");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"staLabel05_00_00_00\"/><PanelItem id=\"PanelItem02\" componentid=\"calOcrnPstn\"/></Contents>");
            this.divForm.form.Div00.addChild(obj.name, obj);
            ...
            obj = new Calendar("calOcrnPstn","0","0","200","40",null,null,null,null,null,null,this.divForm.form.Div00.form);
            obj.set_taborder("16");
            ...
            obj = new Layout("default","",0,0,this.divForm.form.Div00.form,
                ...
                p.pan04_01_00_00_00.set_taborder("11");
                ...
                p.staLabel05_00_00_00_00.set_taborder("12");
                ...
                p.staLabel05_00_00_00.set_taborder("15");
                ...
                p.calOcrnPstn.set_taborder("16");
                p.calOcrnPstn.set_dateformat("yyyy-MM-dd");
                p.calOcrnPstn.move("0","0","200","40",null,null);

                p.pan04_01_00.set_taborder("17");
                p.pan04_01_00.set_type("vertical");
                p.pan04_01_00.set_flexgrow("1");
                p.pan04_01_00.move("10.00","98","300","86",null,null);

                p.staLabel05_00_00.set_taborder("18");
                ...
                p.pan00_01_00_00.set_taborder("24");
                ...
                p.staLabel00_02.set_taborder("35");
            ...
            obj = new Layout("default","",0,0,this.divForm.form,
                ...
                p.Div00.move("0","0","100.00%","903",null,null);
            ...
            obj = new Layout("Layout0","",0,0,this.divForm.form,
                ...
                var rootobj = p;
                p = rootobj;
                p.Div00.move("0","0","100%","1333",null,null);
            	}
            );
            ...
            obj = new Layout("default","Desktop_screen",1480,1000,this,
                ...
                p.divForm.move("0","50",null,"983","60",null);
            ...
            //-- Normal Layout : this
            obj = new Layout("Layout0","Phone_screen",480,1000,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                p = rootobj;
                p.divForm.move("0","0","100.00%","1403",null,null);
            	}
            );
            obj.set_mobileorientation("Landscape");
            ...
            obj = new BindItem("item4","divForm.form.Div00.form.calOcrnPstn","value","dsGet","ocrnYmd");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item8","divForm.form.Div00.form.txtAskCn","value","dsGet","askCn");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("COM010M02.xfdl", function() {
        /**
        *  PcMdi 프로젝트
        *  @FileName 	COM010M02.xfdl
        *  @Creator 	TOBESOFT
        ...
        *******************************************************************************************************************************/
        this.form_onload = function(obj,e)
        {
        	...
        	this.dsGet.setColumn(0, "aplySe", "02"); // 신청구분
        	...
        	if(sPopupId == "save_file") {
        		if(oRtn.result == "Y")
        		{
        			var obj = {
        				...
        				"bsnsSeCd" : "COM",			// 업무구분코드
        				"prgrmId" : "COM010M02" 	// 프로그램ID (화면 ID)
        			}
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("COM010M02.xfdl");
