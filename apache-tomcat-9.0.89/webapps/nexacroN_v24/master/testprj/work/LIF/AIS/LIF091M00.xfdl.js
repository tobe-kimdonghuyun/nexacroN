(function()
{
    return function()
    {
        ...
        {
            this.set_name("LIF091M00");
            this.set_titletext("이동지역인허가말소신청");
        ...
        // User Script
        this.addIncludeScript("LIF091M00.xfdl","xjs::TaskCom.xjs");
        this.registerScript("LIF091M00.xfdl", function() {
        /******************************************************************************
        *  PcMdi 프로젝트
        *  @FileName 	LIF091M00.xfdl
        *  @Creator 	김진섭
        *  @CreateDate 	2024/11/22
        *  @Desction    생활>이동지역>이동지역인허가말소신청(LIF071M00-차량/장비말소신청) 같음
        ******************* 소스 수정 이력 ***********************************************
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("LIF091M00.xfdl");
