(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("영접카운터사용일정현황(사용자)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"schdlMngNo\" type=\"STRING\" size=\"256\"/><Column id=\"brno\" type=\"STRING\" size=\"256\"/><Column id=\"aplyNo\" type=\"STRING\" size=\"256\"/><Column id=\"evntFcltSeCd\" type=\"STRING\" size=\"256\"/><Column id=\"rgnSeCd\" type=\"STRING\" size=\"256\"/><Column id=\"ctrNo\" type=\"STRING\" size=\"256\"/><Column id=\"secNo\" type=\"STRING\" size=\"256\"/><Column id=\"evntNm\" type=\"STRING\" size=\"256\"/><Column id=\"evtozrNm\" type=\"STRING\" size=\"256\"/><Column id=\"useBgngYmd\" type=\"STRING\" size=\"256\"/><Column id=\"useEndYmd\" type=\"STRING\" size=\"256\"/><Column id=\"prcsSttsCd\" type=\"STRING\" size=\"256\"/><Column id=\"bzentyNm\" type=\"STRING\" size=\"256\"/><Column id=\"wrdTelno\" type=\"STRING\" size=\"256\"/><Column id=\"mblTelno\" type=\"STRING\" size=\"256\"/><Column id=\"rprsvNm\" type=\"STRING\" size=\"256\"/><Column id=\"crno\" type=\"STRING\" size=\"256\"/><Column id=\"fxno\" type=\"STRING\" size=\"256\"/><Column id=\"emlAddr\" type=\"STRING\" size=\"256\"/><Column id=\"rmrkCn\" type=\"STRING\" size=\"256\"/><Column id=\"rowSttsCd\" type=\"STRING\" size=\"256\"/><Column id=\"frstRegDt\" type=\"STRING\" size=\"256\"/><Column id=\"frstRegId\" type=\"STRING\" size=\"256\"/><Column id=\"lastChgDt\" type=\"STRING\" size=\"256\"/><Column id=\"lastChgId\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"useYmd\" type=\"STRING\" size=\"256\"/><Column id=\"evntYm\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_useclientlayout("false");
            obj._setContents("<ColumnInfo><Column id=\"ctrNo\" type=\"STRING\" size=\"256\"/><Column id=\"ctrNm\" type=\"STRING\" size=\"256\"/><Column id=\"evntYm\" type=\"STRING\" size=\"256\"/><Column id=\"rgnSeCd\" type=\"STRING\" size=\"256\"/><Column id=\"useIpbtBgngYmd\" type=\"STRING\" size=\"256\"/><Column id=\"useIpbtEndYmd\" type=\"STRING\" size=\"256\"/><Column id=\"aplyNo\" type=\"STRING\" size=\"256\"/><Column id=\"useBgngYmd\" type=\"STRING\" size=\"256\"/><Column id=\"useEndYmd\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divSch","0","0","100.00%","60",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("0");
            obj.set_text("Div00");
            ...
            obj = new Layout("default","",0,0,this.divForm.form,
                ...
                p.divSch.move("0","0","100.00%","60",null,null);
            ...
            obj = new Layout("default","Desktop_screen,Phone_screen",1480,900,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.set_titletext("영접카운터사용일정현황(사용자)");
        ...
        // User Script
        this.addIncludeScript("LIF081M01.xfdl","xjs::TaskCom.xjs");
        this.registerScript("LIF081M01.xfdl", function() {
        /******************************************************************************
        *  PcMdi 프로젝트
        *  @FileName 	LIF081M01.xfdl
        *  @Creator 	김진섭
        *  @CreateDate 	2024/12/22
        *  @Desction    생활 > 영접카운터사용일정현황
        ******************* 소스 수정 이력 ***********************************************
        ...
        *******************************************************************************************************************************/
        ...
        this.fnSearch = function()
        {
        	...
        	//KJS this.dsSearch.setColumn(0, "useYmd", this.divForm.form.divSch.form.calUseYmd.value);
        	this.dsSearch.setColumn(0, "evntYm", this.divForm.form.divSch.form.calUseYmd.value.substr(0,6));

        	var strSvcId    = "fnSearch";
        	//KJS var strSvcUrl   = "evntFcltSchdlAply/selectEvntFcltSchdlAplyListInq.do";
        	var strSvcUrl   = "evntCtrInfoMng/selectEvntCtrInfoMngListInq.do";
        	var inData      = "dsSearch=dsSearch";
        	//KJS var outData     = "dsList=dsList";
        	var outData     = "dsList_1=dsList";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        	var isAsync   	= true;
        ...
        this.fnCallback = function(svcID,errorCode,errorMsg)
        {
        	...
        	switch(svcID)
        	{
        		...
        		case "fnSearch" : // 리스트 조회
        			...
        			var ctrNo_Tmp = "";
        			for(var i = 0; i < this.dsList_1.rowcount; i++) {

        				trace("ffffff_ddd===>" + this.dsList_1.getColumn(i, "ctrNo") + " ; " +  ctrNo_Tmp );
        				if(this.dsList_1.getColumn(i, "ctrNo") == ctrNo_Tmp){
        					//trace("ee");

        				}else{//todo ROW단위로 콘트롤하는 방법??
        					var nRow = this.dsSchdlList.addRow();
        					this.dsSchdlList.setColumn(nRow, "rgnSeCd", this.dsList_1.getColumn(i, "rgnSeCd"));
        					this.dsSchdlList.setColumn(nRow, "ctrNo", this.dsList_1.getColumn(i, "ctrNo"));
        					//trace("nRow==>" + nRow);

        					ctrNo_Tmp = this.dsList_1.getColumn(i, "ctrNo");
        					//trace("ctrNo_Tmp===>" + ctrNo_Tmp );
        				}

        				var stDt = this.dsList_1.getColumn(i, "useIpbtBgngYmd");
        				var edDt = this.dsList_1.getColumn(i, "useIpbtEndYmd");
        				...
        				for(var j = stDd; j <= edDd; j++) {
        					...
        					var LL = "day" + k;
        					this.dsSchdlList.setColumn(nRow, LL, "사용불가");//2:사용불가
        				}

        				var stDt = this.dsList_1.getColumn(i, "useBgngYmd");
        				var edDt = this.dsList_1.getColumn(i, "useEndYmd");
        				var stDd = stDt.substring(6, 8);
        				var edDd = edDt.substring(6, 8);
        				//trace("stDd===>" + stDd );
        				//trace("edDd===>" + edDd );
        ...
        *******************************************************************************************************************************/
        ...
        this.grdList_oncellclick = function(obj,e)
        {
        	...
        	if(e.row > -1){
        		if(cellIdx == e.cell){
        			var sTitle = this.dsList_1.getColumn(e.row,"jobNm");
        			var objArg   = {
        				"aplyNo" : this.dsList_1.getColumn(e.row, "aplyNo"),
        				// "jobCd"  : this.dsList_1.getColumn(e.row, "jobCd"),
        				"view"   : "popup"
        			};
        ...
        this.divForm_divGrd00_grdList_oncellclick = function(obj,e)
        {
        	if(e.cell == 3) //접수번호
        	{
        		var aplyNo = this.dsList_1.getColumn(e.row, "aplyNo");
        		var schdlMngNo = this.dsList_1.getColumn(e.row, "schdlMngNo");
        		var param = {
        			 "aplyNo" : aplyNo
        ...
        this.loadIncludeScript("LIF081M01.xfdl");
