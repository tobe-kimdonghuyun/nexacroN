(function()
{
    return function()
    {
        ...
        {
            this.set_name("LIF090P01");
            this.set_titletext("과거통신신청이력불러오기팝업");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"44\" band=\"head\"/><Row size=\"44\"/></Rows><Band id=\"head\"><Cell text=\"신청번호\"/><Cell col=\"1\" text=\"신청구분명\"/><Cell col=\"2\" text=\"고객유형명\"/><Cell col=\"3\" text=\"계약자명\"/><Cell col=\"4\" text=\"대표자명\"/><Cell col=\"5\" text=\"요청기간&#13;&#10;시작일자\"/><Cell col=\"6\" text=\"요청기간&#13;&#10;종료일자\"/><Cell col=\"7\" cssclass=\"CellEnd\" text=\"완료일시\"/></Band><Band id=\"body\"><Cell text=\"bind:aplyNo\" textAlign=\"center\" cssclass=\"CellLink\" cursor=\"pointer\"/><Cell col=\"1\" text=\"bind:aplyKndNm\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:custTypeNm\" textAlign=\"center\"/><Cell col=\"3\" text=\"bind:aplcntInstNm\" textAlign=\"center\"/><Cell col=\"4\" text=\"bind:srvcAplySeNm\" textAlign=\"center\"/><Cell col=\"5\" text=\"bind:dmndPrdBgngYmd\" textAlign=\"center\" displaytype=\"mask\" maskeditformat=\"####-##-##\" maskedittype=\"string\"/><Cell col=\"6\" text=\"bind:dmndPrdEndYmd\" textAlign=\"center\" displaytype=\"mask\" maskeditformat=\"####-##-##\" maskedittype=\"string\"/><Cell col=\"7\" cssclass=\"CellEnd\" text=\"bind:endDt\" textAlign=\"center\" displaytype=\"mask\" maskeditformat=\"####-##-## ##:##:##\" maskedittype=\"string\"/></Band></Format></Formats>");
            this.divForm.form.divGrd.addChild(obj.name, obj);
            ...
            obj = new Layout("default","Desktop_screen,Phone_screen",1480,800,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.set_titletext("과거통신신청이력불러오기팝업");
        ...
        // User Script
        this.addIncludeScript("LIF090P01.xfdl","xjs::TaskCom.xjs");
        this.registerScript("LIF090P01.xfdl", function() {
        /******************************************************************************
        *  PcMdi 프로젝트
        *  @FileName 	LIF090P01.xfdl
        *  @Creator 	김진섭
        *  @CreateDate 	2024/12/12
        *  @Desction    과거통신신청이력불러오기 팝업
        ******************* 소스 수정 이력 ***********************************************
        ...
        *******************************************************************************************************************************/
        this.form_onload = function(obj,e)
        {
        	...
        	// 공통코드검색
        	this.cfnComCdLoad({ id:"dsAplyKndSearch", cbf:"fnCallback", dsAplyKnd:"FACREQTYPE:S" }); // 신청구분코드
        ...
        *******************************************************************************************************************************/
        ...
        this.fnSearch = function()
        {
        	...
        	var strSvcId    = "selectCmnctUseAplyHstry";
        	var strSvcUrl   = "cmnctUse/selectCmnctUseAplyHstry.do";
        ...
        *******************************************************************************************************************************/
        ...
        this.fnCallback = function(svcID,errorCode,errorMsg)
        {
        	...
        	switch(svcID)
        	{
        		...
        		case "selectCmnctUseAplyHstry": //조회
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("LIF090P01.xfdl");
