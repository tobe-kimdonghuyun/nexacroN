(function()
{
    return function()
    {
        ...
        {
            this.set_name("LIF068M00");
            this.set_titletext("통신일시이용중단해제");
            ...
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"aplyNo\" type=\"STRING\" size=\"256\"/><Column id=\"gnrlTelTlcrtCnt\" type=\"STRING\" size=\"256\"/><Column id=\"priAplyCnt\" type=\"STRING\" size=\"256\"/><Column id=\"chgHpeYmd\" type=\"STRING\" size=\"256\"/><Column id=\"gnrlTelAplyCntOrg\" type=\"STRING\" size=\"256\"/><Column id=\"priAplyCntOrg\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsGnrlTelCncltnDtlArtclList", this);
            obj.set_useclientlayout("true");
            ...
            obj = new Layout("default","",0,0,this.divForm.form.Div04.form,
                ...
                p.grdGnrlTelCncltn.set_binddataset("dsGnrlTelCncltnDtlArtclList");
            ...
            obj = new BindItem("item20","divForm.form.Div04.form.edtGnrlTelAplyCntOrg","value","dsTelSrvcChgAplyInfo","gnrlTelTlcrtCnt");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("LIF068M00.xfdl","xjs::TaskCom.xjs");
        this.registerScript("LIF068M00.xfdl", function() {
        /******************************************************************************
        *  PcMdi 프로젝트
        *  @FileName 	LIF068M00.xfdl
        *  @Creator 	김진섭
        *  @CreateDate 	2025/01/13
        *  @Desction    생활>유틸리티신청변경>통신일시이용중단해제
        ******************* 소스 수정 이력 ***********************************************
        ...
        *******************************************************************************************************************************/
        ...
        this.aplySeCd 	= "TSPCMM005"; // 신청구분코드 - (ASIS : CAR_CAT_CD (워크플로우 데이타업데이트TAB에서 확인))
        this.jobCd 		= "TAS00387"; // 작업코드(기본값 TAS00387 : 신청서작성)
        ...
        *******************************************************************************************************************************/
        ...
        this.btn_onclick = function(obj,e)
        {
        	...
        	*/
        	...
        	if(vBtnCd == "CTL00765"){ // 임시저장 버튼
        		this.vStrSvcId  = "saveCmnctTmprUtztnItrpRmvAplcfmWrtStrg";
        		this.vStrSvcUrl = "cmnctTmprUtztnItrpRmv/saveCmnctTmprUtztnItrpRmvAplcfmWrtStrg.do";

        	}else if(vBtnCd == "CTL00561" || vBtnCd == "CTL00562"){ // 신청서작성 - 신청, 신청서보완 - 재신청
        		// validation check
        	...
        	}else if(vBtnCd == "CTL00828" || vBtnCd == "CTL00594" || vBtnCd == "CTL00594"){ // 종료, 신청서보완 - 미처리종료, 담당자검토및승인 - 미처리종료
        	...
        	}else if(vBtnCd == "CTL00564"){ // 접수 - 접수, 접수 - 보완요청
        	//alert("cc11");
        		this.vStrSvcId  = "saveCmnctTmprUtztnItrpRmvAplcfmWrtStrg";
        		this.vStrSvcUrl = "cmnctTmprUtztnItrpRmv/saveCmnctTmprUtztnItrpRmvAplcfmWrtStrg.do";
        ...
        // 		}
        	...
        	}else if(vBtnCd == "CTL00566" || vBtnCd == "CTL00568" || vBtnCd == "CTL10854"){
        		this.vStrSvcId  = "saveCmnctTmprUtztnItrpRmvAplcfmWrtStrg";
        		this.vStrSvcUrl = "cmnctTmprUtztnItrpRmv/saveCmnctTmprUtztnItrpRmvAplcfmWrtStrg.do";
        ...
        // 		}
        	...
        	}else if(vBtnCd == "CTL00571" || vBtnCd == "CTL10857"){ // 설문응답완료 || 처리완료
        	...
        	if(vBtnCd == "CTL00828" || vBtnCd == "CTL00594" || vBtnCd == "CTL00594" ){
        		// 종료일자 세팅
        	...
        	//alert("cc66");
        	if(vBtnCd == "CTL00828" || vBtnCd == "CTL00594" || vBtnCd == "CTL00594"){ // 종료, 신청서보완 - 미처리종료, 담당자검토및승인 - 미처리종료
        		trace("sssss==>" + vBtnCd );
        		this.gfnConfirmMsg("endSaveConfirm", "CST_001", "msgCallback", ["확인", "취소"], ["Y", "N"], "", ["종료"]);

        	}else if(vBtnCd == "CTL00561") { // 신청
        ...
        // 통합청구
        	...
        	for(var i = 0; i < this.dsGnrlTelCncltnDtlArtclList.rowcount; i++) {

        		// 전화번호
        		if(this.gfnIsNull(this.dsGnrlTelCncltnDtlArtclList.getColumn(i, "cncltnTelNo"))){
        			this.gfnAlertMsg("msg", "MSG_009", ["[전화번호] \n"]);
        			return false;
        		}

        		// 설치장소&호수
        		if(this.gfnIsNull(this.dsGnrlTelCncltnDtlArtclList.getColumn(i, "instlPlcRmnmNm"))){
        ...
        // 		// TAS00387 : 신청서작성, TAS10433 : 신청서보완
        // 		if(sBfrJobCd == "TAS00387"){
        //
        //
        ...
        // 	// this.jobCd 가 TAS00387, TAS10433 일때는 신청서 작성/보완 이라 이외에는 컴포넌트 readOnly 처리해줌.
        // 	if(this.jobCd != "TAS00387" && this.jobCd != "TAS10433"){
        // //alert("bb66611==>" + this.jobCd);
        // 		// 이력 불러오기 버튼 신청성 작성일때만 노출
        // 		if(this.jobCd != "TAS00387"){
        ...
        this.fnCallback = function(svcID,errorCode,errorMsg)
        {
        	...
        	case "tspLocCdLoad" : // 지역구분코드
        		...
        		case "selectCmnctTmprUtztnItrpRmvAplcfmWrtInq" : // 통신사용신청 마스터 조회
        			//alert("마스터 정상조회!!!");
        		...
        		case "comSrvcAplySeCdSearch" : // 서비스신청구분코드 조회
        			...
        			this.dsSrvcAplySeList.filter("cdId == 'CMMCLA0501' || cdId == 'CMMCLA0502' || cdId == 'CMMCLA0503' || cdId == 'CMMCLA0504'");
        			this.dsSrvcAplySeList.insertRow(0);
         			this.dsSrvcAplySeList.setColumn(0, "cdId", "");
         			this.dsSrvcAplySeList.setColumn(0, "cdNm", "[서비스신청구분]");
        ...
        // 			this.dsBldgSeList.setColumn(0, "cdNm", "[건물구분]");
        		...
        		case "saveCmnctTmprUtztnItrpRmvAplcfmWrtStrg" : // 임시저장, 신청
        ...
        *******************************************************************************************************************************/
        ...
        this.fnSearch = function(paramAplyNo)
        {
        	...
        	var strSvcId    = "selectCmnctTmprUtztnItrpRmvAplcfmWrtInq";
        	var strSvcUrl   = "cmnctTmprUtztnItrpRmv/selectCmnctTmprUtztnItrpRmvAplcfmWrtInq.do";
        	var inData      = "dsSearch=dsSearch";
        	//var outData   = "dsCmmCmnctMst=dsCmmCmnctMst dsGnrlTelCncltnDtlArtclList=dsGnrlTelCncltnDtlArtclList dsCnvyMttr=dsCnvyMttr dsAtfl=dsAtfl dsMst=dsMst";
        	var outData     = "dsCmmCmnctMst=dsCmmCmnctMst"  // 통신사용신청마스타 DS
        					  + " dsTelSrvcChgAplyInfo=dsTelSrvcChgAplyInfo"   // 통신일반전화서비스변경신청 단건 DS
        					  + " dsGnrlTelCncltnDtlArtclList=dsGnrlTelCncltnDtlArtclList"   // 통신일반전화서비스변경신청 LIST DS
        ...
        this.fn_Save = function(vStrSvcId, vStrSvcUrl)
        {
        	...
        	inData    = "dsWfInfo=" + this.FV_DS_OTPT_WORK_FLOW_INFO + ":U"  // WorkFlow 정보
        					  ...
        					  + " dsGnrlTelCncltnDtlArtclList=dsGnrlTelCncltnDtlArtclList:U"   // 통신일반전화서비스일시이용중단신청 LIST DS
        			          + " dsCnvyMttr=dsCnvyMttr"                           // 전달사항 DS
        ...
        *******************************************************************************************************************************/
        ...
        {
        	var nRow = this.dsGnrlTelCncltnDtlArtclList.addRow();
        	this.dsGnrlTelCncltnDtlArtclList.setColumn(nRow, "rowSttsCd" , "I");
        	this.dsGnrlTelCncltnDtlArtclList.setColumn(nRow, "hpeYmd" , "");
        ...
        {
         	if(this.dsGnrlTelCncltnDtlArtclList.findRow("chk", 1) != -1) {
         		this.gfnConfirmMsg( this.divForm.form.Div04.form.btnGrdDel_CLA0301.name
         		                  , "MSG_005"   // 삭제하시겠습니까?
         						  , function(id, val) {
         						        if(JSON.parse(val).result == "Y") {
        			                        this.dsGnrlTelCncltnDtlArtclList.deleteMultiRows(this.dsGnrlTelCncltnDtlArtclList.extractRows("chk == " + 1));
        // 									this.dsGnrlTelCncltnDtlArtclList_oncolumnchanged();
         		                        }
         		                    }
         						  , ["확인", "취소"]
         						  , ["Y"  , "N" ]
        ...
        this.divForm_Div04_cmbSrvcAplySeCd_onitemchanged = function(obj,e)
        {
        	...
        	//CMMCLA0504:인터넷전화서비스
        	//CMMCLA0502:공항LAN서비스
        	//CMMCLA0503:공항CATV서비스

        	if(this.divForm.form.Div04.form.cmbSrvcAplySeCd.value == "CMMCLA0501"){
        		//일반전화서비스 그리드 행추가
        		this.divForm_Div04_btnGrdAdd_CLA0301_onclick();
        	}else if(this.divForm.form.Div04.form.cmbSrvcAplySeCd.value == "CMMCLA0502"){
        		//todo 추가해야 함
        		this.dsGnrlTelCncltnDtlArtclList.clearData();
        	}
        };
        ...
        this.loadIncludeScript("LIF068M00.xfdl");
