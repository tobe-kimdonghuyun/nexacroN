(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"currentPageNo\" type=\"STRING\" size=\"256\"/><Column id=\"recordCountPerPage\" type=\"STRING\" size=\"256\"/><Column id=\"sDate\" type=\"STRING\" size=\"256\"/><Column id=\"eDate\" type=\"STRING\" size=\"256\"/><Column id=\"searchText\" type=\"STRING\" size=\"256\"/><Column id=\"frstRegNm\" type=\"STRING\" size=\"256\"/><Column id=\"prgrmPathNm\" type=\"STRING\" size=\"256\"/><Column id=\"brno\" type=\"STRING\" size=\"256\"/><Column id=\"aplySeCd\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"recordCountPerPage\">10</Col><Col id=\"currentPageNo\">1</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Contents><PanelItem id=\"PanelItem02\" componentid=\"btnSch\"/><PanelItem id=\"PanelItem00\" componentid=\"btnBscInfoReg\"/></Contents>");
        ...
        *******************************************************************************************************************************/
        this.getSearchTransaction = function()
        {
        	...
        	this.dsSearch.setColumn(0, "brno", "1234321678");
        	this.dsSearch.setColumn(0, "aplySeCd", "01");/*01:신청,02:해지*/
        ...
        this.divForm_divGrd_Grid00_oncellclick = function(obj,e)
        {
        	...
        	//alert("ee==>" + this.dsList.getColumn(i,"chk1"));
        		...
        		if(this.dsList.getColumn(i,"chk2") == "1"){ //선택(전기)
        			...
        			var sMenuId = this.objApp.gvFrmLeft.form.currsMenuId;
        			var sMenuUrl = 'work::LIF/ELE/LIF053M00.xfdl';
        			var actNm = '전기사용신청 상세';
        		...
        		if(this.dsList.getColumn(i,"chk3") == "1"){ //선택(수도)
        			...
        			var sMenuId = this.objApp.gvFrmLeft.form.currsMenuId;
        			var sMenuUrl = 'work::LIF/WAT/LIF055M00.xfdl';
        			var actNm = '수도사용신청 상세';
        		...
        		if(this.dsList.getColumn(i,"chk4") == "1"){ //선택(통신)
        			...
        			var sMenuId = this.objApp.gvFrmLeft.form.currsMenuId;
        			var sMenuUrl = 'work::LIF/CMM/LIF056M00.xfdl';
        			var actNm = '통신사용신청 상세';
