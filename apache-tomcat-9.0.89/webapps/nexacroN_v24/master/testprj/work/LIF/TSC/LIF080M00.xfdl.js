(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"aplyNo\" type=\"STRING\" size=\"256\"/><Column id=\"Column0\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj.set_type("vertical");
            obj.set_visible("true");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"staLabel03_00_01_00_00\"/><PanelItem id=\"PanelItem02\" componentid=\"calEndYmd\"/></Contents>");
            this.divForm.form.Div03.addChild(obj.name, obj);
            ...
            obj = new Calendar("calEndYmd","200.00","728","100%","40",null,null,null,null,null,null,this.divForm.form.Div03.form);
            obj.set_taborder("17");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_type("normal");
            obj.set_readonly("true");
            ...
            obj = new Layout("default","",0,0,this.divForm.form.Div03.form,
                ...
                p.pan02_02_00_00.set_type("vertical");
                p.pan02_02_00_00.set_visible("true");
                p.pan02_02_00_00.move("10.00","98","100%","86",null,null);
                ...
                p.calEndYmd.set_taborder("17");
                p.calEndYmd.set_dateformat("yyyy-MM-dd");
                p.calEndYmd.set_type("normal");
                p.calEndYmd.set_readonly("true");
                p.calEndYmd.move("200.00","728","100%","40",null,null);
            ...
            obj = new BindItem("item15","divForm.form.Div03.form.calEndYmd","value","dsList","dmndPrdEndYmd");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        *******************************************************************************************************************************/
        this.form_onload = function(obj,e)
        {
        	...
        	// this.aplyNo = "CAR2411_00025"; // CAR2411_00024
        ...
        this.fnPopupCallback = function(sPopupId, sRtn)
        {
        	if (sPopupId == "wtohAgreYnPop"){
        		...
        		if(this.dsHstryInfo.getRowCount() > 0){
        			this.dsList.setColumn(0, "payPicSmYn"		   , this.dsHstryInfo.getColumn(0, "payPicSmYn"		    )); // 납부담당자동일여부
        			this.dsList.setColumn(0, "payPicNm"            , this.dsHstryInfo.getColumn(0, "payPicNm"           )); // 납부담당자명
        			this.dsList.setColumn(0, "payPicTelno"         , this.dsHstryInfo.getColumn(0, "payPicTelno"        )); // 납부담당자전화번호
        			this.dsList.setColumn(0, "payPicMblTelno"      , this.dsHstryInfo.getColumn(0, "payPicMblTelno"     )); // 납부담당자휴대전화번호
        			this.dsList.setColumn(0, "clmMtdCd"            , this.dsHstryInfo.getColumn(0, "clmMtdCd"           )); // 청구방식코드
        			this.dsList.setColumn(0, "clmCustCd"           , this.dsHstryInfo.getColumn(0, "clmCustCd"          )); // 청구고객코드
        			this.dsList.setColumn(0, "clmZip"              , this.dsHstryInfo.getColumn(0, "clmZip"             )); // 청구우편번호
        			this.dsList.setColumn(0, "clmAddr"             , this.dsHstryInfo.getColumn(0, "clmAddr"            )); // 청구주소
        			this.dsList.setColumn(0, "clmDtlAddr"          , this.dsHstryInfo.getColumn(0, "clmDtlAddr"         )); // 청구상세주소
        			this.dsList.setColumn(0, "clmEml1"             , this.dsHstryInfo.getColumn(0, "clmEml1"            )); // 청구이메일1
        			this.dsList.setColumn(0, "clmEml2"             , this.dsHstryInfo.getColumn(0, "clmEml2"            )); // 청구이메일2
        			this.dsList.setColumn(0, "txivEml1"            , this.dsHstryInfo.getColumn(0, "txivEml1"           )); // 세금계산서이메일1
        			this.dsList.setColumn(0, "txivEml2"            , this.dsHstryInfo.getColumn(0, "txivEml2"           )); // 세금계산서이메일2
        			this.dsList.setColumn(0, "aplyKndCd"           , this.dsHstryInfo.getColumn(0, "aplyKndCd"          )); // 신청종류코드
        			this.dsList.setColumn(0, "aplyKndNm"           , this.dsHstryInfo.getColumn(0, "aplyKndNm"          )); // 신청종류명
        			this.dsList.setColumn(0, "custTypeCd"          , this.dsHstryInfo.getColumn(0, "custTypeCd"         )); // 고객유형코드
        			this.dsList.setColumn(0, "dmndPrdBgngYmd"      , this.dsHstryInfo.getColumn(0, "dmndPrdBgngYmd"     )); // 요청기간시작일자
        			this.dsList.setColumn(0, "dmndPrdEndYmd"       , this.dsHstryInfo.getColumn(0, "dmndPrdEndYmd"      )); // 요청기간종료일자
        			this.dsList.setColumn(0, "bldgSeCd"            , this.dsHstryInfo.getColumn(0, "bldgSeCd"           )); // 건물구분코드
        			this.dsList.setColumn(0, "zoneSeCd"            , this.dsHstryInfo.getColumn(0, "zoneSeCd"           )); // 구역구분코드
        			this.dsList.setColumn(0, "srvcAplySeCd"        , this.dsHstryInfo.getColumn(0, "srvcAplySeCd"       )); // 서비스신청구분코드
        ...
        *******************************************************************************************************************************/
        ...
        this.btn_onclick = function(obj,e)
        {
        	...
        	*/
        	...
        	}else if(vBtnCd == "CTL11017"){ // 설문응답완료
        		this.vStrSvcId  = "elcttrAplyStrg";
        		this.vStrSvcUrl = "elcttr/elcttrAplyStrg.do";
        	...
        	if(vBtnCd == "CTL11005"){
        		...
        		this.gfnOpenPopup("wtohAgreYnPop", "work::LIF/TSC/LIF080P08.xfdl", objArg, sPopupCallBack, objOption);
        ...
        {
        	// this.jobCd 가 TAS10438, TAS10439 일때는 신청서 작성/보완일때만 처리해줌.
        	if(this.jobCd == "TAS10438" || this.jobCd == "TAS10439"){
        		alert("우편번호 찾기!!! 임시데이터");
        ...
        {
        	var sTitle = "전동차등록및운전허가 과거신청이력팝업";
        	...
        	this.gfnOpenPopup("aplyHstryPop", "work::LIF/TSC/LIF080P07.xfdl", objArg, sPopupCallBack, objOption);
        };
        ...
        /**************************************************************************
         * @name : calDmndBgngYmd_onchanged
         * @description : 요청시작일자 수정 완료 시
         ***************************************************************************/
        this.calDmndBgngYmd_onchanged = function(obj,e)
        {
        	var objVal = obj.value;

        	var sEndYmd = this.gfnAddMonth(objVal, 24);
        	this.divForm.form.Div03.form.calEndYmd.value = sEndYmd;
        ...
        this.on_initEvent = function()
        {
            ...
            this.divForm.form.Div03.form.calDmndBgngYmd.addEventHandler("onchanged",this.calDmndBgngYmd_onchanged,this);
