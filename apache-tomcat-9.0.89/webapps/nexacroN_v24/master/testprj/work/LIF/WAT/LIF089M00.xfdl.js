(function()
{
    return function()
    {
        ...
        {
            this.set_name("LIF089M00");
            this.set_titletext("수도해지신청서작성");
            ...
            obj = new Div("divForm","0","divTitle:10",null,"6312.99","60",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("div00");
            ...
            obj = new Panel("sub_tit00","955","18","100%","52",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("26");
            ...
            obj = new Div("Div05","0","30","100%","1880.99",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("4");
            obj.set_text("Div00");
            obj.set_cssclass("div_WF_Bg");
            obj.set_fittocontents("height");
            ...
            obj.set_flexmainaxisalign("end");
            obj.set_horizontalgap("10");
            obj._setContents("<Contents><PanelItem id=\"PanelItem02\" componentid=\"btnstaRmtqtPhotoSample\"/><PanelItem id=\"PanelItem00\" componentid=\"btnRmtqtPhotoFile\"/></Contents>");
            this.divForm.form.Div05.addChild(obj.name, obj);
            ...
            obj = new Layout("default","",0,0,this.divForm.form.Div05.form,
                ...
                p.sta00.set_text("수도해지신청 구분의 용어정의\r\n- 상수 : 인천시 상수도사업본부에서 생성하여 공급하는 일반 수도용수\r\n- 중수 : 공항지역 내 발생한 하수를 인천국제공항 중수도시설에서 재처리하여 생산한 재활용수로  화장실,조경,청소용수 등으로 사용됨\r\n- 중온수 : 인천공항에너지㈜에서 생산하는 냉난방용 열에너지 공급용수\r\n- 급탕 : 상수를 고온으로 가열한 용수\r\n- 냉수 : 인천국제공항에서 생산하는 냉방에너지 공급용수\r\n- 폐수 : 물에 액체성 또는 고체성의 수질오염물질이 섞여 있어 그대로는 사용할 수 없는 물\r\n\r\n본 신청인은 공항지역 내 수도 등 유틸리티(상수,중수,중온수,급탕,냉수,폐수) 해지 신청함에 있어 [수도 등에 대한 이용안내서]를 숙지하고 위의 제반 사항에 동의하며, 안전하고 효율적인 공항운영을 위하여 공사의 제 요구사항을 이행할 것을 서약 합니다.");
                ...
                p.Panel00_02_01.set_taborder("37");
                ...
                p.staRmtqtPhoto.set_taborder("43");
                ...
                p.btnstaRmtqtPhotoSample.set_taborder("44");
                ...
                p.btnRmtqtPhotoFile.set_taborder("45");
                ...
                p.panBtnFile00.set_taborder("46");
                ...
                p.grdstaRmtqtPhoto.set_taborder("48");
                p.grdstaRmtqtPhoto.set_binddataset("dsFile");
                p.grdstaRmtqtPhoto.set_autofittype("col");
                p.grdstaRmtqtPhoto.set_cssclass("grd_WF_FileAdd");
                p.grdstaRmtqtPhoto.set_scrollbartype("none none");
                p.grdstaRmtqtPhoto.move("20.00","114","100%","40",null,null);

                p.sta00_00_00_01_00.set_taborder("49");
            ...
            obj = new Layout("default","",0,0,this.divForm.form,
                ...
                p.sub_tit00.move("955","18","100%","52",null,null);
                ...
                p.Div05.move("0","30","100%","1880.99",null,null);
            ...
            obj = new Layout("mobile","",0,0,this.divForm.form,
                ...
                var rootobj = p;
                p = rootobj;
                p.staSubTitle02_00_03.move("0","-53","100%","50",null,null);

                p.Panel01_02_03.move("505","-53","30%","50",null,null);
            ...
            obj = new Layout("default","Desktop_screen,Phone_screen",1480,900,this,
                ...
                p.divForm.move("0","divTitle:10",null,"6312.99","60",null);
        ...
        // User Script
        this.addIncludeScript("LIF089M00.xfdl","xjs::TaskCom.xjs");
        this.registerScript("LIF089M00.xfdl", function() {
        /**
        *  PcMdi 프로젝트
        *  @FileName 	LIF089M00.xfdl
        *  @Creator 	CHG
        *  @CreateDate 	2024/12/03
        *  @Desction   퇴거 > 유틸리티해지신청 > 수도해지신청
        ************** 소스 수정 이력 ***********************************************
        ...
        *******************************************************************************************************************************/
        ...
        this.aplySeCd = "TSPWAT002"; // 신청구분코드(수도해지신청 : "TSPWAT002")
        this.jobCd = "TAS00172"; // 작업코드(기본값 TAS00172 : 신청서작성)
        ...
        *******************************************************************************************************************************/
        ...
        this.fnCallback = function(svcID,errorCode,errorMsg)
        {
        	...
        	switch(svcID)
        	{
        		...
        		case "_cfnBtnCrt_" : // 버튼 생성 callback
        			...
        			if(this.jobCd == "TAS00172" && this.gfnIsNull(this.aplyNo)){
        				Array.from(this.btnDiv.form.components).forEach(oComp => {
        					if(oComp.id == "CTL01005"){
        						oComp.visible = false;
        ...
        this.msgCallback = function(sPopupId, sRtn) {
        	...
        	if(sPopupId == "save_confirm") {
        		...
        		this.cfnSetAtflInfo(this.RaonkUpload, this.divForm.form.Div05.form.grdstaRmtqtPhoto).cfnDelAtfl();
        ...
        *******************************************************************************************************************************/
        ...
        this.fnValiChk = function(){
        	...
        	if(this.dsWtspUseList.getRowCount() > 0){
        		...
        		for(var i = 0; i < this.dsWtspUseList.getRowCount(); i++){
        			...
        			if(this.gfnIsNull(this.dsWtspUseList.getColumn(i, "cncltnPrnmntYmd"))){
        				cellIdx = this.divForm.form.Div05.form.divGrd.form.grdCtrtInfoList.getBindCellIndex("body", "cncltnPrnmntYmd");
        				this.divForm.form.Div05.form.divGrd.form.grdCtrtInfoList.setFocus();
        				this.divForm.form.Div05.form.divGrd.form.grdCtrtInfoList.setCellPos(cellIdx, i);
        				this.gfnAlertMsg("msg", "MSG_009", ["해지예정일 \n"]);
        				return false;
        ...
        this.fnScrnSetting = function(){
        	...
        	/*
        		...
        		TAS00288	만족도조사
        	*/
        	if(this.gfnDecode(this.jobCd, "TAS00178", 1, "TAS00179", 1, "TAS00289", 1, "TAS00180", 1, "TAS00288", 1, 0) == 1){
        		this.divForm.form.Div05.form.divGrd.form.grdCtrtInfoList.setFormat("default2");
        		this.divForm.form.Div05.form.panFile00.visible = true;
        	...
        	// this.jobCd 가 TAS00172, TAS00521 일때는 신청서 작성/보완 이라 이외에는 컴포넌트 readOnly 처리해줌.
        	if(this.jobCd != "TAS00172" && this.jobCd != "TAS00521"){
        		// 검침및단수가 아닐때
        		if(this.jobCd != "TAS00178"){
        			// 해지목록 그리드 readOnly 처리
        		...
        		function fnReadonly (oComp, bReadonly) {
        			if (oComp instanceof nexacro.Div) {
        				...
        				if (oComp instanceof nexacro.Button) {
        					...
        					if(oComp.id.indexOf("btnRmtqtPhotoFile") > -1 && this.jobCd == "TAS00178") return;
        					try {
        						// enable 처리할거
        ...
        *******************************************************************************************************************************/
        ...
        this.btn_onclick = function(obj,e)
        {
        	...
        	/* vBtnCd 정보
        		TAS00172	2211.신청서작성	CTL00287	신청
        		TAS00172	2211.신청서작성	CTL00756	임시저장
        		TAS00172	2211.신청서작성	CTL00822	종료
        		TAS00172	2211.신청서작성	CTL01005	신청취소
        		TAS00174	2221.협력사접수	CTL00289	접수
        		TAS00175	2222.담당자지정	CTL00290	담당자변경
        		TAS00175	2222.담당자지정	CTL00291	담당자지정완료
        		TAS00175	2222.담당자지정	CTL00885	미처리종료
        		TAS00521	2212.신청서보완	CTL01034	재신청
        		TAS00521	2212.신청서보완	CTL01035	미처리종료
        		TAS00178	2251.검침및단수	CTL00296	검침값확인완료
        		TAS00178	2251.검침및단수	CTL00625	담당자변경
        		TAS00178	2251.검침및단수	CTL00886	미처리종료
        		TAS00178	2251.검침및단수	CTL01036	보완요청
        		TAS00179	2262.승인		CTL00298	담당자변경
        		TAS00179	2262.승인		CTL00300	승인
        		TAS00179	2262.승인		CTL00918	보완요청
        		TAS00179	2262.승인		CTL11131	미처리종료
        		TAS00289	2261.현업접수		CTL00297	접수
        		TAS00180	종료				N/A			N/A
        		TAS00288	2271.만족도조사	CTL00301	설문응답완료
        	*/

        	// 임시저장, 신청취소, 담당자지정완료, 보완요청, 접수, 승인
        	if(vBtnCd == "CTL00756" || vBtnCd == "CTL01005" || vBtnCd == "CTL00289" || vBtnCd == "CTL00291" || vBtnCd == "CTL01036"
        	  || vBtnCd == "CTL00296" || vBtnCd == "CTL01034" || vBtnCd == "CTL00297" || vBtnCd == "CTL00918" || vBtnCd == "CTL00300"){
        		// CTL00296 : 검침값확인완료 일떄
        		if(vBtnCd == "CTL00296"){
        			var cellIdx = -1;
        			for(var i = 0; i < this.dsWtspUseList.getRowCount(); i++){
        				if(this.gfnIsNull(this.dsWtspUseList.getColumn(i, "gageMngNo"))){
        					cellIdx = this.divForm.form.Div05.form.divGrd.form.grdCtrtInfoList.getBindCellIndex("body", "gageMngNo");
        					this.divForm.form.Div05.form.divGrd.form.grdCtrtInfoList.setFocus();
        					this.divForm.form.Div05.form.divGrd.form.grdCtrtInfoList.setCellPos(cellIdx, i);
        				...
        				if(this.gfnIsNull(this.dsWtspUseList.getColumn(i, "cncltnRmtqtIdntyYmd"))){
        					cellIdx = this.divForm.form.Div05.form.divGrd.form.grdCtrtInfoList.getBindCellIndex("body", "cncltnRmtqtIdntyYmd");
        					this.divForm.form.Div05.form.divGrd.form.grdCtrtInfoList.setFocus();
        					this.divForm.form.Div05.form.divGrd.form.grdCtrtInfoList.setCellPos(cellIdx, i);
        				...
        				if(this.gfnIsNull(this.dsWtspUseList.getColumn(i, "cncltnRmtqt"))){
        					cellIdx = this.divForm.form.Div05.form.divGrd.form.grdCtrtInfoList.getBindCellIndex("body", "cncltnRmtqt");
        					this.divForm.form.Div05.form.divGrd.form.grdCtrtInfoList.setFocus();
        					this.divForm.form.Div05.form.divGrd.form.grdCtrtInfoList.setCellPos(cellIdx, i);
        			...
        			if(this.gfnIsNull(this.dsFile.getColumn(0, "B110"))){
        				...
        				this.gfnAlertMsg("msg", "MSG_011", ["검침값사진을 \n등록하여 주세요."]);
        				return;
        	...
        	}else if(vBtnCd == "CTL00287"){ // 신청서작성 - 신청
        		// validation check
        	...
        	}else if(vBtnCd == "CTL00822" || vBtnCd == "CTL00885" || vBtnCd == "CTL00886"
        	  || vBtnCd == "CTL01035" || vBtnCd == "CTL11131"){
        	  // 신청서작성 - 종료, 담당자지정 - 미처리종료, 검침및단수 - 미처리종료, 신청서보완 - 미처리종료, 승인 - 미처리종료
        	...
        	}else if(vBtnCd == "CTL00290" || vBtnCd == "CTL00625" || vBtnCd == "CTL00298"){ // 담당자변경
        		alert("담당자변경 팝업 완료 시 연결 예정!!");
        		return;

        	}else if(vBtnCd == "CTL00301"){ // 설문응답완료
        		this.vStrSvcId  = "wtspUseAplcfmWrtTmprStrg";
        		this.vStrSvcUrl = "wtsp/wtspUseAplcfmWrtTmprStrg.do";
        	...
        	if(this.gfnIsNull(this.dsWtspMst.getColumn(0, "docCd"))){
        		this.dsWtspMst.setColumn(0, "docCd", "TSPDOC220"); // 공통코드 TSPDOC220 : 수도해지신청
        	...
        	if(this.gfnIsNull(this.dsMst.getColumn(0, "docCd"))){
        		this.dsMst.setColumn(0, "docCd", "TSPDOC220"); // 공통코드 TSPDOC220 : 수도해지신청
        	...
        	// 종료, 미처리종료, 승인
        	if(vBtnCd == "CTL00822" || vBtnCd == "CTL00885" || vBtnCd == "CTL00886" || vBtnCd == "CTL01035"
        	  || vBtnCd == "CTL11131" || vBtnCd == "CTL00300"){
        		// 승인
        		if(vBtnCd == "CTL00300"){
        	...
        	// 접수
        	if(vBtnCd == "CTL00289"){
        		this.dsWtspMst.setColumn(0, "rcptDt", curDt);
        	...
        	// 1 : 신청자정보와 동일
        	if(this.dsWtspMst.getColumn(0, "payPicSmYn") == "1"){
        		// 납부담당자개인정보수집이용동의서 삭제.
        		this.cfnSetAtflInfo(this.RaonkUpload, this.divForm.form.Div04.form.grdPayPicPrvcClctUtztnWtcs).cfnDelAtfl();
        ...
        this.RaonkUpload_RAONKUPLOAD_CreationComplete = function(obj,  paramObj)
        {
        	...
        	this.RaonkUpload.SetConfig('FolderNameRule', '/LIF/WAT/YYYY/MM/DD/');
        ...
        this.grd_oncellclick = function(obj,e)
        {
        	...
        	if(e.cell == 0){
        		...
        		// 검침값사진은 검침및단수시에 삭제 가능하게
        		if(obj.name == "grdstaRmtqtPhoto"){
        			if(this.jobCd == "TAS00178"){
        				// 첨부 파일 삭제
        ...
        this.on_initEvent = function()
        {
            ...
            this.divForm.form.Div05.form.grdstaRmtqtPhoto.addEventHandler("oncellclick",this.grd_oncellclick,this);
        ...
        this.loadIncludeScript("LIF089M00.xfdl");
