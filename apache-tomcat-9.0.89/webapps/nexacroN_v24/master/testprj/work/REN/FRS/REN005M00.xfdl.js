(function()
{
    return function()
    {
        ...
        {
            this.set_name("REN005M00");
            this.set_titletext("후보공간확인요청 목록 (신청자)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"currentPageNo\" type=\"STRING\" size=\"256\"/><Column id=\"recordCountPerPage\" type=\"STRING\" size=\"256\"/><Column id=\"pPstnCd\" type=\"STRING\" size=\"256\"/><Column id=\"pBldgCd\" type=\"STRING\" size=\"256\"/><Column id=\"pLoiSeCd\" type=\"STRING\" size=\"256\"/><Column id=\"pSesUserId\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"recordCountPerPage\">10</Col><Col id=\"currentPageNo\">1</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"cdTypeId\" type=\"STRING\" size=\"256\"/><Column id=\"cdId\" type=\"STRING\" size=\"256\"/><Column id=\"cdNm\" type=\"STRING\" size=\"256\"/><Column id=\"cdVl01\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsCboPstnCd", this);
            obj._setContents("<ColumnInfo><Column id=\"cdTypeId\" type=\"STRING\" size=\"256\"/><Column id=\"cdId\" type=\"STRING\" size=\"256\"/><Column id=\"cdNm\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj.set_fittocontents("height");
            obj._setContents("<Contents><PanelItem id=\"PanelItem05\" componentid=\"panPstnCd\"/><PanelItem id=\"PanelItem06\" componentid=\"panBldgCd\"/></Contents>");
            ...
            obj = new Panel("panPstnCd","1694.00","398","480","45",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("8");
            obj.set_type("horizontal");
            ...
            obj = new Panel("panBldgCd","1694.00","398","480","45",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("10");
            obj.set_type("horizontal");
            obj.set_horizontalgap("10");
            obj.set_fittocontents("height");
            ...
            obj = new Div("divPage","0","637","100.00%","36",null,null,null,null,null,null,this.divGrd.form);
            obj.set_taborder("0");
            obj.set_text("Div00");
            ...
            obj.set_horizontalgap("10");
            obj._setContents("<Contents><PanelItem id=\"PanelItem04\" componentid=\"staTotal00\"/><PanelItem id=\"PanelItem01\" componentid=\"grdListCnt\"/><PanelItem id=\"PanelItem00\" componentid=\"btnRegi\"/><PanelItem id=\"PanelItem05\" componentid=\"btnGrdDw\"/></Contents>");
            this.divGrd.addChild(obj.name, obj);
            ...
            obj = new Button("btnRegi","774.00","10","56","34",null,null,null,null,null,null,this.divGrd.form);
            obj.set_taborder("6");
            obj.set_text("등록");
            ...
            obj = new Button("btnGrdDw","1368","3","134","34",null,null,null,null,null,null,this.divGrd.form);
            obj.set_taborder("7");
            ...
            obj = new Layout("default","",0,0,this.divSch.form,
                ...
                p.panBldgCd.move("1694.00","398","480","45",null,null);
            ...
            obj = new Layout("default","",0,0,this.divGrd.form,
                ...
                p.btnRegi.set_taborder("6");
                p.btnRegi.set_text("등록");
                p.btnRegi.set_cssclass("btn_WF_SmallBlack");
                p.btnRegi.set_visible("true");
                p.btnRegi.move("774.00","10","56","34",null,null);
            ...
            obj = new Layout("default","Desktop_screen",1420,900,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.set_titletext("후보공간확인요청 목록 (신청자)");
        ...
        // User Script
        this.addIncludeScript("REN005M00.xfdl","xjs::TaskCom.xjs");
        this.registerScript("REN005M00.xfdl", function() {
        /**
        *  인천공항 원스톱 입주자서비스 프로젝트
        *  @FileName 	REN005M00.xfdl
        *  @Creator 	(주)이루온
        *  @CreateDate 	2024/10/10
        *  @Desction    후보공간확인요청 목록
        ******************** 소스 수정 이력 ***********************************************
        ...
        *******************************************************************************************************************************/
        this.fnInit = function()
        {
        	...
        	this.cfnComCdLoad({dsCboPerPageCnt:"REN9000"});
        ...
        this.selectBldgCdList = function() {
        	...
        	var strSvcUrl   = "ren/com/selectBldgPstnCdList.do";
        	var inData      = "";
        	var outData     = "dsCboBldgCd=dsList dsCboPstnCd=dsList02";
        	var strArg      = "pInqSe=A pTaskSe=LOH pSttsCd='22,23'"	// 22.추천전달 23.현장확인요청
        ...
        *******************************************************************************************************************************/
        ...
        this.getSearchTransaction = function() {
        	...
        	var strSvcId    = "search";
        	var strSvcUrl   = "ren/frs/selectCnddSpceIdntyDmndList.do";
        ...
        *******************************************************************************************************************************/
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg)
        {
        	...
        	switch(svcID)
        	{
        		// 콤보조회
        		case "_cfnComCdLoad_":
        			this.divGrd.form.grdListCnt.set_index(0);	// 목록수
        ...
        *******************************************************************************************************************************/
        this.divGrd_grdList_oncellclick = function(obj,e)
        {
        	...
        	if (this.objApp.screenid == "Desktop_screen") {
        		...
        		var sMenuUrl = 'work::REN/FRS/REN005M01.xfdl';
        		var actNm = '상세';
        		...
        		this.gfnOpenPopup("REN002M01", "work::REN/FRS/REN005M01.xfdl", objArg, sPopupCallBack, objOption);
        	}
        };
        ...
        *******************************************************************************************************************************/
         ...
         * 등록 버튼 클릭시
        *******************************************************************************************************************************/
        this.divGrd_btnRegi_onclick = function(obj,e)
        {
        	var hireLohNo = this.dsList.getColumn( this.dsList.rowposition, "hireLohNo");
        ...
        this.on_initEvent = function()
        {
            ...
            this.divGrd.form.btnRegi.addEventHandler("onclick",this.divGrd_btnRegi_onclick,this);
        };
        this.loadIncludeScript("REN005M00.xfdl");
