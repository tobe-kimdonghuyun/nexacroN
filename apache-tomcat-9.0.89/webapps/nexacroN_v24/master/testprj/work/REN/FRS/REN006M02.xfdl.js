(function()
{
    return function()
    {
        ...
        {
            this.set_name("REN006M02");
            this.set_titletext("현장확인요청 목록(신청자)");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"210\"/><Column size=\"210\"/><Column size=\"210\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"56\" band=\"head\"/><Row size=\"48\"/></Rows><Band id=\"head\"><Cell text=\"임차문의&#13;&#10;접수번호\"/><Cell col=\"1\" text=\"업체명\"/><Cell col=\"2\" text=\"위치\"/><Cell col=\"3\" text=\"건물명\"/><Cell col=\"4\" text=\"호실번호\"/><Cell col=\"5\" text=\"면적(m2)\"/><Cell col=\"6\" text=\"방문희망일자\"/><Cell col=\"7\" text=\"현장확인일자\"/><Cell col=\"8\" text=\"현장확인담당자\"/><Cell col=\"9\" text=\"상태\"/></Band><Band id=\"body\"><Cell textAlign=\"center\" text=\"bind:rcptNo\"/><Cell col=\"1\" suppressalign=\"middle\" textAlign=\"left\" text=\"bind:bzentyNm\"/><Cell col=\"2\" text=\"bind:pstnNm\" textAlign=\"left\"/><Cell col=\"3\" text=\"bind:bldgNm\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:rmnmNo\" textAlign=\"center\"/><Cell col=\"5\" text=\"bind:rntar\" textAlign=\"right\"/><Cell col=\"6\" text=\"bind:vstHpeYmd\" textAlign=\"center\" displaytype=\"mask\" maskeditformat=\"####-##-##\" maskedittype=\"string\" maskeditmaskchar=\" \"/><Cell col=\"7\" text=\"bind:sptIdntyYmd\" textAlign=\"center\" displaytype=\"mask\" maskeditformat=\"####-##-##\" maskedittype=\"string\" maskeditmaskchar=\" \"/><Cell col=\"8\" text=\"bind:sptIdntyPicNm\" textAlign=\"left\"/><Cell col=\"9\" text=\"bind:prgrsSttsNm\" textAlign=\"left\"/></Band></Format></Formats>");
            this.divGrd.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("REN006M02.xfdl","xjs::TaskCom.xjs");
        this.registerScript("REN006M02.xfdl", function() {
        /**
        *  인천공항 원스톱 입주자서비스 프로젝트
        *  @FileName 	REN006M02.xfdl
        *  @Creator 	(주)이루온
        *  @CreateDate 	2024/10/21
        *  @Desction    현장확인요청 목록(신청자)
        ******************** 소스 수정 이력 ***********************************************
        ...
        *******************************************************************************************************************************/
        this.fnInit = function()
        {
        	...
        	this.cfnComCdLoad({dsCboPerPageCnt:"REN9000:S"});
        ...
        *******************************************************************************************************************************/
        ...
        this.getSearchTransaction = function() {
        	...
        	var strSvcId    = "search";
        	var strSvcUrl   = "ren/frs/selectSptIdntySchdlAplcntList.do";
        ...
        //	var strArg      = "pInqSe=A pTaskSe=LOH"
        	var strArg      = "pInqSe=A pTaskSe=LOH pSttsCd='24,25'"
        	var callBackFnc = "fnCallback";
        	var isAsync   	= true;
        ...
        *******************************************************************************************************************************/
        this.divGrd_grdList_oncellclick = function(obj,e)
        {
        	...
        	if (this.objApp.screenid == "Desktop_screen") {
        		...
        		var sMenuUrl = 'work::REN/FRS/REN006M04.xfdl';
        		var actNm = '상세';
        		...
        		this.gfnOpenPopup("REN006M04", "work::REN/FRS/REN006M04.xfdl", objArg, sPopupCallBack, objOption);
        	}
        };
        ...
        this.loadIncludeScript("REN006M02.xfdl");
