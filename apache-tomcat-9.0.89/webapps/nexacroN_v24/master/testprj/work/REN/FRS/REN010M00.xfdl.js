(function()
{
    return function()
    {
        ...
        {
            this.set_name("REN010M00");
            this.set_titletext("임대배정문서 목록");
            ...
            obj._setContents("<ColumnInfo><Column id=\"hireLoiNo\" type=\"STRING\" size=\"256\"/><Column id=\"docWrtDt\" type=\"STRING\" size=\"256\"/><Column id=\"docTitl\" type=\"STRING\" size=\"256\"/><Column id=\"docWrtUserNm\" type=\"STRING\" size=\"256\"/><Column id=\"prgrsSttsCd\" type=\"STRING\" size=\"256\"/><Column id=\"prgrsSttsNm\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"currentPageNo\" type=\"STRING\" size=\"256\"/><Column id=\"recordCountPerPage\" type=\"STRING\" size=\"256\"/><Column id=\"pLoiSeCd\" type=\"STRING\" size=\"256\"/><Column id=\"pDocTitl\" type=\"STRING\" size=\"256\"/><Column id=\"pDocWrtNm\" type=\"STRING\" size=\"256\"/><Column id=\"pPrgrsSttsCd\" type=\"STRING\" size=\"256\"/><Column id=\"pBgngYmd\" type=\"STRING\" size=\"256\"/><Column id=\"pEndYmd\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"recordCountPerPage\">10</Col><Col id=\"currentPageNo\">1</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divSch","0","divTitle:0",null,"206","60",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Div00");
            ...
            obj = new Combo("cboSttsCd","851","24","100%","40",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("3");
            ...
            obj.set_fittocontents("height");
            obj.set_flexgrow("1");
            obj._setContents("<Contents><PanelItem id=\"PanelItem02\" componentid=\"staPrgsSttsCd\"/><PanelItem id=\"PanelItem01\" componentid=\"cboSttsCd\"/></Contents>");
            this.divSch.addChild(obj.name, obj);
            ...
            obj = new Div("divCal","553","54","320","48",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("15");
            obj.set_text("Div00");
            obj.set_flexgrow("1");
            obj.set_formscrollbartype("none none");
            ...
            obj.set_horizontalgap("10");
            obj._setContents("<Contents><PanelItem id=\"PanelItem04\" componentid=\"staTotal02\"/><PanelItem id=\"PanelItem01\" componentid=\"grdListCnt\"/><PanelItem id=\"PanelItem02\" componentid=\"panSapSend\"/></Contents>");
            this.divGrd.addChild(obj.name, obj);

            obj = new Div("divPage","0","592","100.00%","36",null,null,null,null,null,null,this.divGrd.form);
            obj.set_taborder("0");
            obj.set_text("Div00");
            ...
            obj = new Panel("panSapSend","290","0","160","34",null,null,null,null,null,null,this.divGrd.form);
            obj.set_taborder("9");
            obj.set_verticalgap("0");
            obj.set_horizontalgap("8");
            obj.set_fittocontents("width");
            obj._setContents("<Contents><PanelItem id=\"PanelItem01\" componentid=\"btnDocWrt\"/></Contents>");
            this.divGrd.addChild(obj.name, obj);
            // Layout Functions
            ...
            obj = new Layout("default","",0,0,this.divSch.form,
                ...
                p.cboSttsCd.set_taborder("3");
                p.cboSttsCd.set_innerdataset("dsCboSttsCd");
                p.cboSttsCd.set_codecolumn("codecolumn");
                p.cboSttsCd.set_datacolumn("datacolumn");
                p.cboSttsCd.set_minwidth("");
                p.cboSttsCd.set_text("전체");
                p.cboSttsCd.set_value("");
                p.cboSttsCd.set_index("-1");
                p.cboSttsCd.move("851","24","100%","40",null,null);
                ...
                p.divCal.move("553","54","320","48",null,null);
            	}
            );
            ...
            obj = new Layout("default","",0,0,this.divGrd.form,
                ...
                p.divPage.move("0","592","100.00%","36",null,null);
            ...
            obj = new Layout("default","Desktop_screen",1480,900,this,
                ...
                p.divSch.move("0","divTitle:0",null,"206","60",null);
            ...
            obj = new BindItem("item1","divSch.form.cboSttsCd","value","dsSearch","pPrgrsSttsCd");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("REN010M00.xfdl","xjs::TaskCom.xjs");
        this.registerScript("REN010M00.xfdl", function() {
        /**
        *  인천공항 원스톱 입주자서비스 프로젝트
        *  @FileName 	REN010M00.xfdl
        *  @Creator 	(주)이루온
        ...
        *******************************************************************************************************************************/
        ...
        {
        	this.cfnComCdLoad({dsCboPerPageCnt:"REN9000:S", dsCboSttsCd:"HIRE_ASN_STTS_CD:A"});
        };
        ...
        *******************************************************************************************************************************/
        ...
        this.getSearchTransaction = function() {
        	...
        	var strSvcId    = "search";
        	var strSvcUrl   = "ren/frs/selectRentAsnDocList.do";
        ...
        *******************************************************************************************************************************/
        ...
        {
        	var sTitle = "임차의향서 선택(팝업)";
        	var objArg   = {"loiSeCd" : this.dsSearch.getColumn(0,"pLoiSeCd")
        	               };
        	...
        	this.gfnOpenPopup("hireLoiPopup", "work::REN/FRS/REN010P01.xfdl", objArg, sPopupCallBack, objOption);
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSch.form.cboSttsCd.addEventHandler("onitemchanged",this.divSch_bldgCombo_onitemchanged,this);
        ...
        this.loadIncludeScript("REN010M00.xfdl");
