(function()
{
    return function()
    {
        ...
        {
            this.set_name("REN006M03");
            this.set_titletext("현장확인요청 목록(현장확인담당자)");
            ...
            obj.set_fittocontents("height");
            obj._setContents("<Contents><PanelItem id=\"PanelItem02\" componentid=\"panBzentyNm\"/><PanelItem id=\"PanelItem01\" componentid=\"panPstnCd\"/><PanelItem id=\"PanelItem06\" componentid=\"panBldgCd\"/><PanelItem id=\"PanelItem03\" componentid=\"panYmd\"/></Contents>");
            ...
            obj.set_taborder("1");
            obj.set_flexgrow("0");
            obj.set_displaynulltext("입체명 입력");
            this.divSch.addChild(obj.name, obj);
            ...
            obj = new Layout("default","",0,0,this.divSch.form,
                ...
                p.edtBzentyNm.set_displaynulltext("입체명 입력");
                p.edtBzentyNm.move("841","24","100%","40",null,null);

                p.panBzentyNm.set_taborder("12");
                ...
                p.cboPstnCd.set_index("0");
                p.cboPstnCd.move("146","80","100%","40",null,null);

                p.panBldgCd.set_taborder("11");
            ...
            obj = new Layout("default","Desktop_screen",1420,900,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.set_titletext("현장확인요청 목록(현장확인담당자)");
        ...
        // User Script
        this.addIncludeScript("REN006M03.xfdl","xjs::TaskCom.xjs");
        this.registerScript("REN006M03.xfdl", function() {
        /**
        *  인천공항 원스톱 입주자서비스 프로젝트
        *  @FileName 	REN006M03.xfdl
        *  @Creator 	(주)이루온
        *  @CreateDate 	2024/10/18
        *  @Desction    현장확인요청 목록(현장확인담당자)
        ******************** 소스 수정 이력 ***********************************************
        ...
        *******************************************************************************************************************************/
        ...
        this.getSearchTransaction = function() {
        	...
        	var strSvcId    = "search";
        	var strSvcUrl   = "ren/frs/selectSptIdntySchdlSptPicList.do";
        ...
        *******************************************************************************************************************************/
        this.divGrd_grdList02_oncellclick = function(obj,e)
        {
        	...
        	if (this.objApp.screenid == "Desktop_screen") {
        		...
        		this.gfnOpenPopup("REN002M01", "work::REN/FRS/REN006M04.xfdl", objArg, sPopupCallBack, objOption);
        	}
        };
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("REN006M03.xfdl");
