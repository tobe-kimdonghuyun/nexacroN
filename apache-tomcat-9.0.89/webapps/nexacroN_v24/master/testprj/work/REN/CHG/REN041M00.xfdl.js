(function()
{
    return function()
    {
        ...
        {
            this.set_name("REN041M00");
            this.set_titletext("임차의향서(변경) 목록");
            ...
            obj._setContents("<ColumnInfo><Column id=\"currentPageNo\" type=\"STRING\" size=\"256\"/><Column id=\"recordCountPerPage\" type=\"STRING\" size=\"256\"/><Column id=\"pPstnCd\" type=\"STRING\" size=\"256\"/><Column id=\"pBldgCd\" type=\"STRING\" size=\"256\"/><Column id=\"pYmdSe\" type=\"STRING\" size=\"256\"/><Column id=\"pBgngYmd\" type=\"STRING\" size=\"256\"/><Column id=\"pEndYmd\" type=\"STRING\" size=\"256\"/><Column id=\"pLoiSeCd\" type=\"STRING\" size=\"256\"/><Column id=\"pSesUserId\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"recordCountPerPage\">10</Col><Col id=\"currentPageNo\">1</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divSch","0","70",null,"153","30",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Div00");
            ...
            obj.set_fittocontents("height");
            obj._setContents("<Contents><PanelItem id=\"PanelItem06\" componentid=\"panBldgCd\"/><PanelItem id=\"PanelItem03\" componentid=\"panYmd\"/></Contents>");
            ...
            obj.set_horizontalgap("10");
            obj._setContents("<Contents><PanelItem id=\"PanelItem04\" componentid=\"staTotal00\"/><PanelItem id=\"PanelItem01\" componentid=\"grdListCnt\"/><PanelItem id=\"PanelItem02\" componentid=\"btnGrdRegi\"/></Contents>");
            this.divGrd.addChild(obj.name, obj);
            ...
            obj = new Button("btnGrdRegi","250.00","0","56","34",null,null,null,null,null,null,this.divGrd.form);
            obj.set_taborder("8");
            obj.set_text("등록");
            ...
            obj = new Layout("default","",0,0,this.divGrd.form,
                ...
                p.btnGrdRegi.move("250.00","0","56","34",null,null);
            	}
            );
            obj.set_verticalgap("20");
            ...
            obj = new Layout("default","Desktop_screen",1420,900,this,
                ...
                p.divSch.move("0","70",null,"153","30",null);
        ...
        // User Script
        this.addIncludeScript("REN041M00.xfdl","xjs::TaskCom.xjs");
        this.registerScript("REN041M00.xfdl", function() {
        /**
        *  인천공항 원스톱 입주자서비스 프로젝트
        *  @FileName 	REN041M00.xfdl
        *  @Creator 	(주)이루온
        *  @CreateDate 	2024/12/02
        *  @Desction    임차의향서(변경) 목록
        ******************** 소스 수정 이력 ***********************************************
        ...
        *******************************************************************************************************************************/
        this.fnInit = function()
        {
        	...
        	this.dsSearch.setColumn(0, "pSesUserId"	, gdsUser.getColumn(0, "userId"));
        ...
        *******************************************************************************************************************************/
        ...
        this.getSearchTransaction = function() {
        	...
        	var strSvcId    = "search";
        	var strSvcUrl   = "ren/chg/selectChgHireLoiList.do";
        ...
        *******************************************************************************************************************************/
        this.divGrd_grdList_oncellclick = function(obj,e)
        {
        	...
        	if (this.objApp.screenid == "Desktop_screen") {
        		...
        		var sMenuUrl = 'work::REN/CHG/REN041M01.xfdl';
        		var actNm = '상세';
        		...
        		this.gfnOpenPopup("REN002M01", "work::REN/CHG/REN041M01.xfdl", objArg, sPopupCallBack, objOption);
        	}
        };
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("REN041M00.xfdl");
