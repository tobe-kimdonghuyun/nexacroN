(function()
{
    return function()
    {
        ...
        {
            this.set_name("REN043M00");
            this.set_titletext("임대배정변경문서 목록");
            ...
            obj = new Combo("cboPrgsSttsCd","851","24","100%","40",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("3");
            ...
            obj.set_fittocontents("height");
            obj.set_flexgrow("1");
            obj._setContents("<Contents><PanelItem id=\"PanelItem02\" componentid=\"staPrgsSttsCd\"/><PanelItem id=\"PanelItem01\" componentid=\"cboPrgsSttsCd\"/></Contents>");
            this.divSch.addChild(obj.name, obj);
            ...
            obj = new Div("divPage","0","592","100.00%","36",null,null,null,null,"36",null,this.divGrd.form);
            obj.set_taborder("0");
            obj.set_text("Div00");
            ...
            obj = new Layout("default","",0,0,this.divSch.form,
                ...
                p.cboPrgsSttsCd.set_taborder("3");
                ...
                p.cboPrgsSttsCd.move("851","24","100%","40",null,null);
            ...
            obj = new Layout("mobile","Phone_screen",480,900,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.divSch.move("20","divTitle:20",null,"198","20",null);
        ...
        // User Script
        this.addIncludeScript("REN043M00.xfdl","xjs::TaskCom.xjs");
        this.registerScript("REN043M00.xfdl", function() {
        /**
        *  인천공항 원스톱 입주자서비스 프로젝트
        *  @FileName 	REN043M00.xfdl
        *  @Creator 	(주)이루온
        *  @CreateDate 	2024/12/10
        *  @Desction    임대배정변경문서 목록
        ************** 소스 수정 이력 *****************************************************
        ...
        *******************************************************************************************************************************/
        ...
        {
        	this.cfnComCdLoad({dsCboPerPageCnt:"REN9000:S", dsCboPrgsSttsCd:"HIRE_ASN_STTS_CD:A"});
        };
        ...
        *******************************************************************************************************************************/
        ...
        this.getSearchTransaction = function() {
        	...
        	var strSvcId    = "search";
        	var strSvcUrl   = "ren/chg/selectChgRentAsnDocList.do";
        ...
        *******************************************************************************************************************************/
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg)
        {
        	...
        	switch(svcID)
        	{
        		// 콤보조회
        		case "_cfnComCdLoad_":
        			//this.dsCboPrgsSttsCd.filter("cdVl01 == 'REN_ASN_DOC' || cdNm == '전체' ");
        			break;
        ...
        *******************************************************************************************************************************/
        ...
        {
        	var sTitle = "임차의향서(변경) 신청 선택(팝업)";
        	var objArg   = {"loiSeCd" : this.dsSearch.getColumn(0,"pLoiSeCd")
        				   ,"sttsSe" : "1"		// 진행상태구분 : 1.확정 2.미확정
        	               };
        	...
        	this.gfnOpenPopup("hireLoiPopup", "work::REN/CHG/REN043P01.xfdl", objArg, sPopupCallBack, objOption);
        };
        ...
        this.fnPopupCallback = function(sPopupId, sRtn)
        {
        	...
        	if(sPopupId =="hireLoiPopup") {
        		...
        		if(this.gfnIsNull(objRtn.hireLoiNo)) {
        			...
        			// 변경임차의향서 선택한 경우 임대배정변경문서 상세 화면 호출 함.
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onkeyup",this.REN023M02_onkeyup,this);
        ...
        this.loadIncludeScript("REN043M00.xfdl");
