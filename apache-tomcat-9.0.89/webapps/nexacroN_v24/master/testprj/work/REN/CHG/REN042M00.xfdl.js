(function()
{
    return function()
    {
        ...
        {
            this.set_name("REN042M00");
            this.set_titletext("임차의향서(변경) 접수목록");
            ...
            obj._setContents("<ColumnInfo><Column id=\"hireLoiNo\" type=\"STRING\" size=\"256\"/><Column id=\"rcptNo\" type=\"STRING\" size=\"256\"/><Column id=\"bzentyNm\" type=\"STRING\" size=\"256\"/><Column id=\"bldgNm\" type=\"STRING\" size=\"256\"/><Column id=\"rentPrd\" type=\"STRING\" size=\"256\"/><Column id=\"rtfeYnNm\" type=\"STRING\" size=\"256\"/><Column id=\"hpePrlgYmd\" type=\"STRING\" size=\"256\"/><Column id=\"cfmtnPrlgYmd\" type=\"STRING\" size=\"256\"/><Column id=\"prgrsSttsCd\" type=\"STRING\" size=\"256\"/><Column id=\"prgrsSttsNm\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"currentPageNo\" type=\"STRING\" size=\"256\"/><Column id=\"recordCountPerPage\" type=\"STRING\" size=\"256\"/><Column id=\"pPstnCd\" type=\"STRING\" size=\"256\"/><Column id=\"pBldgCd\" type=\"STRING\" size=\"256\"/><Column id=\"pSttsCd\" type=\"STRING\" size=\"256\"/><Column id=\"pYmdSe\" type=\"STRING\" size=\"256\"/><Column id=\"pBgngYmd\" type=\"STRING\" size=\"256\"/><Column id=\"pEndYmd\" type=\"STRING\" size=\"256\"/><Column id=\"pLoiSeCd\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"recordCountPerPage\">10</Col><Col id=\"currentPageNo\">1</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj.set_fittocontents("height");
            obj._setContents("<Contents><PanelItem id=\"PanelItem01\" componentid=\"panRcptNo\"/><PanelItem id=\"PanelItem02\" componentid=\"panBzentyNm\"/><PanelItem id=\"PanelItem06\" componentid=\"panBldgCd\"/><PanelItem id=\"PanelItem04\" componentid=\"panSttsCd\"/><PanelItem id=\"PanelItem03\" componentid=\"panYmd\"/></Contents>");
            ...
            obj = new Combo("cboCalSe","12","4","150","40",null,null,null,null,null,null,this.divSch.form.divCal.form);
            obj.set_taborder("1");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            var divSch_form_divCal_form_cboCalSe_innerdataset = new nexacro.NormalDataset("divSch_form_divCal_form_cboCalSe_innerdataset", obj);
            divSch_form_divCal_form_cboCalSe_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">희망연장일자</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">확정연장일자</Col></Row></Rows>");
            obj.set_innerdataset(divSch_form_divCal_form_cboCalSe_innerdataset);
            obj.set_text("희망연장일자");
            obj.set_value("1");
            obj.set_index("0");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"150\"/><Column size=\"297\"/><Column size=\"217\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"56\" band=\"head\"/><Row size=\"48\"/></Rows><Band id=\"head\"><Cell text=\"접수번호\"/><Cell col=\"1\" text=\"업체명\"/><Cell col=\"2\" text=\"건물명(호실번호)\"/><Cell col=\"3\" text=\"계약기간\"/><Cell col=\"4\" text=\"임대료\"/><Cell col=\"5\" text=\"희망연장일자\"/><Cell col=\"6\" text=\"확정연장일자\"/><Cell col=\"7\" text=\"상태\"/></Band><Band id=\"body\"><Cell textAlign=\"center\" text=\"bind:rcptNo\"/><Cell col=\"1\" text=\"bind:bzentyNm\" textAlign=\"center\" displaytype=\"normal\" maskeditformat=\"####-##-##\" maskedittype=\"string\" maskeditmaskchar=\" \"/><Cell col=\"2\" text=\"bind:bldgNm\" textAlign=\"left\"/><Cell col=\"3\" text=\"bind:rentPrd\" textAlign=\"center\" displaytype=\"normal\" maskedittype=\"string\"/><Cell col=\"4\" text=\"bind:rtfeYnNm\" textAlign=\"left\"/><Cell col=\"5\" text=\"bind:hpePrlgYmd\" textAlign=\"center\" displaytype=\"date\" maskedittype=\"string\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"6\" text=\"bind:cfmtnPrlgYmd\" textAlign=\"center\" displaytype=\"date\" maskedittype=\"string\"/><Cell col=\"7\" text=\"bind:prgrsSttsNm\" textAlign=\"left\"/></Band></Format></Formats>");
            this.divGrd.addChild(obj.name, obj);
            ...
            obj = new Layout("default","",0,0,this.divSch.form.divCal.form,
                ...
                var rootobj = p;
                p = rootobj;
                p.cboCalSe.set_taborder("1");
                p.cboCalSe.set_innerdataset(divSch_form_divCal_form_cboCalSe_innerdataset);
                p.cboCalSe.set_codecolumn("codecolumn");
                p.cboCalSe.set_datacolumn("datacolumn");
                p.cboCalSe.set_text("희망연장일자");
                p.cboCalSe.set_value("1");
            ...
            obj = new BindItem("item6","Edit01_00_00","value","dsSearch","pHirerNm");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item2","divSch.form.divCal.form.cboCalSe","value","dsSearch","pYmdSe");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item14","divSch.form.cboSttsCd","value","dsSearch","pSttsCd");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("REN042M00.xfdl","xjs::TaskCom.xjs");
        this.registerScript("REN042M00.xfdl", function() {
        /**
        *  인천공항 원스톱 입주자서비스 프로젝트
        *  @FileName 	REN042M00.xfdl
        *  @Creator 	(주)이루온
        *  @CreateDate 	2024/12/09
        *  @Desction    임차의향서(변경) 접수목록
        ******************** 소스 수정 이력 ***********************************************
        ...
        *******************************************************************************************************************************/
        ...
        {
        	// 임차의향서구분: M.변경
        	this.dsSearch.setColumn(0, "pLoiSeCd"	, "M");
        ...
        *******************************************************************************************************************************/
        ...
        this.cfnSearch = function(page)
        {
        	if (this.dsSearch.getColumn(0, "pBgngYmd") > this.dsSearch.getColumn(0, "pEndYmd")) {
        		this.gfnAlertMsg("msg", "MSG_012", [ this.divSch.form.divCal.form.cboCalSe.text ]);		//{0} 시작일자가 종료일자보다 큽니다.
        		return;
        	}
        ...
        *******************************************************************************************************************************/
        ...
        this.getSearchTransaction = function() {
        	...
        	var strSvcId    = "search";
        	var strSvcUrl   = "ren/chg/selectChgHireLoiRcptList.do";
        ...
        *******************************************************************************************************************************/
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg)
        {
        	...
        	switch(svcID)
        	{
        		//콤보조회
        		case "_cfnComCdLoad_":
        			this.dsCboSttsCd.filter("cdNm == '전체' || String(cdVl03).indexOf('REN042M00') >= 0");
        			...
        			this.divSch.form.divCal.form.cboCalSe.set_index(0);		// 일자구분
        ...
        *******************************************************************************************************************************/
        ...
        this.form_onkeyup = function(obj,e)
        {
        	if (e.keycode==13 && e.fromobject.id != "grdList") {
        		if (e.fromobject.taborder >= 1 && e.fromobject.taborder <= 7) {
        ...
        *******************************************************************************************************************************/
        this.divGrd_grdList_oncellclick = function(obj,e)
        {
        	...
        	if (this.objApp.screenid == "Desktop_screen") {
        		...
        		var sMenuUrl = 'work::REN/CHG/REN042M01.xfdl';
        		var actNm = '상세';
        		...
        		this.gfnOpenPopup("REN002M01", "work::REN/CHG/REN042M01.xfdl", objArg, sPopupCallBack, objOption);
        	}
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSch.form.cboSttsCd.addEventHandler("onitemchanged",this.divSch_cboPstnCd_onitemchanged,this);
        ...
        this.loadIncludeScript("REN042M00.xfdl");
