(function()
{
    return function()
    {
        ...
        {
            this.set_name("REN042M01");
            this.set_titletext("임차의향서(변경) 접수");
            ...
            obj = new Div("Div00","990","16","100%","96",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("24");
            obj.set_text("div00");
            ...
            obj = new Static("staLabel01_00_00","0","0","100%","46",null,null,null,null,null,null,this.divForm.form.Div00.form);
            obj.set_taborder("0");
            obj.set_text("접수번호");
            obj.set_cssclass("sta_WF_Label");
            this.divForm.form.Div00.addChild(obj.name, obj);

            obj = new Edit("edt00_01_01","0","46","100%","40",null,null,null,null,null,null,this.divForm.form.Div00.form);
            obj.set_taborder("1");
            obj.set_readonly("true");
            obj.set_text("");
            this.divForm.form.Div00.addChild(obj.name, obj);

            obj = new Panel("Panel03","20","0","300","86",null,null,null,null,null,null,this.divForm.form.Div00.form);
            obj.set_taborder("2");
            obj.set_flexgrow("1");
            ...
            obj = new Static("staLabel01_00","10","10","100%","46",null,null,null,null,null,null,this.divForm.form.Div00.form);
            obj.set_taborder("3");
            obj.set_text("상태");
            obj.set_cssclass("sta_WF_Label");
            this.divForm.form.Div00.addChild(obj.name, obj);

            obj = new Edit("edt00_01","10","56","100%","40",null,null,null,null,null,null,this.divForm.form.Div00.form);
            obj.set_taborder("4");
            obj.set_readonly("true");
            obj.set_value("신청서 제출");
            obj.set_text("신청서 제출");
            this.divForm.form.Div00.addChild(obj.name, obj);

            obj = new Panel("Panel01_00","720","0","300","86",null,null,null,null,null,null,this.divForm.form.Div00.form);
            obj.set_taborder("5");
            obj.set_type("vertical");
            obj.set_flexgrow("1");
            ...
            obj = new Panel("Panel01","1006","28","300","1",null,null,null,null,null,null,this.divForm.form.Div00.form);
            obj.set_taborder("7");
            obj._setContents("");
            this.divForm.form.Div00.addChild(obj.name, obj);
            ...
            obj = new Panel("PanTotalBtn","0","40","100.00%","50",null,null,null,null,null,null,this.divForm.form.divSpceListGrp.form);
            obj.set_taborder("0");
            obj.set_horizontalgap("20");
            obj.set_flexcrossaxiswrapalign("start");
            obj.set_flexwrap("wrap");
            ...
            obj = new Static("staTotal_00","10.00","0","55","34",null,null,null,null,null,null,this.divForm.form.divSpceListGrp.form);
            obj.set_taborder("3");
            obj.set_text("변경");
            ...
            obj = new Static("staTotalCnt","0","0","40","34",null,null,null,null,null,null,this.divForm.form.divSpceListGrp.form);
            obj.set_taborder("4");
            obj.set_text("2");
            ...
            obj = new Static("staTotal02_00","0","0","30","34",null,null,null,null,null,null,this.divForm.form.divSpceListGrp.form);
            obj.set_taborder("5");
            obj.set_text("건");
            obj.set_usedecorate("true");
            this.divForm.form.divSpceListGrp.addChild(obj.name, obj);

            obj = new Panel("PanelTotal00_00","10.00","0","100","34",null,null,null,null,null,null,this.divForm.form.divSpceListGrp.form);
            obj.set_taborder("6");
            ...
            obj = new Panel("PanelTotal","0","0","480","34",null,null,null,null,null,null,this.divForm.form.divSpceListGrp.form);
            obj.set_taborder("7");
            obj.set_horizontalgap("20");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"101\"/><Column size=\"85\"/><Column size=\"98\"/><Column size=\"120\"/><Column size=\"142\"/><Column size=\"149\"/><Column size=\"155\"/><Column size=\"150\"/></Columns><Rows><Row size=\"44\" band=\"head\"/><Row size=\"44\"/></Rows><Band id=\"head\"><Cell text=\"담당부서\"/><Cell col=\"1\" text=\"담당자\"/><Cell col=\"2\" text=\"직위(직급)\"/><Cell col=\"3\" text=\"전화(사무실)\"/><Cell col=\"4\" text=\"휴대폰\"/><Cell col=\"5\" text=\"이메일\"/><Cell col=\"6\" text=\"FAX\"/><Cell col=\"7\" text=\"담당업무\"/></Band><Band id=\"body\"><Cell textAlign=\"left\" verticalAlign=\"middle\" displaytype=\"text\" text=\"bind:picDeptNm\" edittype=\"none\"/><Cell col=\"1\" suppressalign=\"middle\" textAlign=\"left\" verticalAlign=\"middle\" edittype=\"none\" displaytype=\"text\" cssclass=\"CellReadonly\" text=\"bind:picNm\"/><Cell col=\"2\" textAlign=\"left\" verticalAlign=\"middle\" text=\"bind:picJbpsNm\" edittype=\"none\"/><Cell col=\"3\" textAlign=\"center\" verticalAlign=\"middle\" displaytype=\"normal\" text=\"bind:picTelno\" edittype=\"none\" maskedittype=\"string\" maskeditformat=\"###-####-####\" maskeditmaskchar=\" \"/><Cell col=\"4\" textAlign=\"center\" verticalAlign=\"middle\" text=\"bind:picMblTelno\" edittype=\"none\" maskedittype=\"string\" maskeditformat=\"###-####-####\" maskeditmaskchar=\" \" displaytype=\"normal\"/><Cell col=\"5\" textAlign=\"left\" verticalAlign=\"middle\" text=\"bind:picEmlAddr\" edittype=\"none\"/><Cell col=\"6\" textAlign=\"center\" verticalAlign=\"middle\" displaytype=\"normal\" text=\"bind:picFxno\" edittype=\"none\" maskedittype=\"string\" maskeditformat=\"###-####-####\" maskeditmaskchar=\" \"/><Cell col=\"7\" cssclass=\"CellEnd\" textAlign=\"left\" verticalAlign=\"middle\" text=\"bind:dtyBsnsNm\" edittype=\"none\"/></Band></Format></Formats>");
            this.divForm.form.divPicListGrp.form.divGrdPicList.addChild(obj.name, obj);
            ...
            obj = new Div("Div05","0","30","100%","201",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("19");
            obj.set_text("Div00");
            obj.set_cssclass("div_WF_Bg");
            obj.set_fittocontents("height");
            ...
            obj = new Panel("panFile00_00","0","42","100.00%","156",null,null,null,null,null,null,this.divForm.form.Div05.form);
            obj.set_taborder("2");
            obj.set_fittocontents("height");
            obj.set_spacing("10px 20px 10px 20px");
            obj.set_flexwrap("wrap");
            obj.set_cssclass("pal_WF_DtlBg");
            obj.set_verticalgap("4");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"panTitle00_00\"/><PanelItem id=\"PanelItem01\" componentid=\"grdFile2\"/></Contents>");
            this.divForm.form.Div05.addChild(obj.name, obj);
            ...
            obj = new Layout("default","",0,0,this.divForm.form.Div05.form,
                ...
                p.panFile00_00.set_cssclass("pal_WF_DtlBg");
                p.panFile00_00.set_verticalgap("4");
                p.panFile00_00.move("0","42","100.00%","156",null,null);
            ...
            obj = new Layout("default","",0,0,this.divForm.form,
                ...
                var rootobj = p;
                p = rootobj;
                p.Div00.set_taborder("24");
                p.Div00.set_text("div00");
                p.Div00.set_cssclass("div_WF_Bg");
                p.Div00.set_fittocontents("height");
                p.Div00.move("990","16","100%","96",null,null);
                ...
                p.Div05.move("0","30","100%","201",null,null);

                p.staSubTitleRvwOpnn.set_taborder("20");
                p.staSubTitleRvwOpnn.set_text("임차의향서(변경) 검토의견");
        ...
        // User Script
        this.addIncludeScript("REN042M01.xfdl","xjs::TaskCom.xjs");
        this.registerScript("REN042M01.xfdl", function() {
        /**
        *  인천공항 원스톱 입주자서비스 프로젝트
        *  @FileName 	REN042M01.xfdl
        *  @Creator 	(주)이루온
        ...
        *******************************************************************************************************************************/
        this.fnInit = function()
        {
        	...
        	this.dsSearch.setColumn(0, "grp1CdId"	,"REN042M01");
        ...
        *******************************************************************************************************************************/
        	...
        	switch(svcID)
        	{
        		...
        		case "search":
        			...
        			if (this.dsMaster.getColumn(0,"prgrsSttsCd") != "31") {
        				...
        				this.divForm.form.divRvwOpnn.form.txtRvwOpnn.readonly = true;
        			}

        			// 공간내역건수 표시
        			this.divForm.form.divSpceListGrp.form.staTotalCnt.text = this.dsSpceList.getRowCount();
        		...
        		// 확정/반려
        		case "updateChgHireLoiCfmtnRjct":
        ...
        this.divBtn_btnCfmtn_onclick = function(obj,e)
        {
        	...
        	if (this.cfnGrdIsValidated(this.divForm.form.divSpceListGrp.form.divGrdSpceList.form.grdSpceList, this.dsSpceList, "Y") == true) {
        ...
        this.divBtn_btnRjct_onclick = function(obj,e)
        {
        	 if (this.gfnDsIsUpdated(this.dsMaster) == true) {
        		this.gfnConfirmMsg("rjct_confirm", "CST_001", "msgCallback", ["확인", "취소"], ["Y", "N"],"",["반려"]);
        	} else {
        ...
        this.msgCallback = function(sPopupId, sRtn) {
        	...
        	if (oRtn.result == "Y") {
        		if (sPopupId == "cfmtn_confirm") {
        			this.dsMaster.setColumn(0, "prgrsSttsCd"	, "34");	// 진행상태코드: 30.작성중 31.제출 32.접수 33.반려 34.확정 35.SAP전송
        		} else {
        			this.dsMaster.setColumn(0, "prgrsSttsCd"	, "33");	// 진행상태코드: 30.작성중 31.제출 32.접수 33.반려 34.확정 35.SAP전송
        		}

        		var strSvcId    = "updateChgHireLoiCfmtnRjct";
        		var strSvcUrl   = "ren/chg/updateChgHireLoiCfmtnRjct.do";
        		var inData      = "dsMaster=dsMaster:A dsCustInfo=dsCustInfo:A dsSpceList=dsSpceList:U dsPicList=dsPicList:U dsAtflList=dsAtflList:U";
        		var outData     = "";
        		var strArg      = "";
        		var callBackFnc = "fnCallback";
        		var isAsync   	= false;
        ...
        this.on_initEvent = function()
        {
            ...
            this.divForm.form.Div05.form.staLabel00_02_01.addEventHandler("onclick",this.divForm_Div05_staLabel00_02_01_onclick,this);
        ...
        this.loadIncludeScript("REN042M01.xfdl");
