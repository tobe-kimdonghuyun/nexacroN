(function()
{
    return function()
    {
        ...
        {
            this.set_name("REN033M00");
            this.set_titletext("임대보증금/선납임대료 반환신청 목록(입주자)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"hireLoiNo\" type=\"STRING\" size=\"256\"/><Column id=\"rcptNo\" type=\"STRING\" size=\"256\"/><Column id=\"bzentyNm\" type=\"STRING\" size=\"256\"/><Column id=\"bldgNm\" type=\"STRING\" size=\"256\"/><Column id=\"rentPrd\" type=\"STRING\" size=\"256\"/><Column id=\"rtfeYnNm\" type=\"STRING\" size=\"256\"/><Column id=\"mncoYnNm\" type=\"STRING\" size=\"256\"/><Column id=\"utltYnNm\" type=\"STRING\" size=\"256\"/><Column id=\"ctrtCncltnYmd\" type=\"STRING\" size=\"256\"/><Column id=\"prgrsSttsCd\" type=\"STRING\" size=\"256\"/><Column id=\"prgrsSttsNm\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSearch", this);
            obj._setContents("<ColumnInfo><Column id=\"currentPageNo\" type=\"STRING\" size=\"256\"/><Column id=\"recordCountPerPage\" type=\"STRING\" size=\"256\"/><Column id=\"pBldgCd\" type=\"STRING\" size=\"256\"/><Column id=\"pBgngYmd\" type=\"STRING\" size=\"256\"/><Column id=\"pEndYmd\" type=\"STRING\" size=\"256\"/><Column id=\"pSbmsnId\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"recordCountPerPage\">10</Col><Col id=\"currentPageNo\">1</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"200\"/><Column size=\"297\"/><Column size=\"217\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"130\"/><Column size=\"150\"/></Columns><Rows><Row size=\"56\" band=\"head\"/><Row size=\"48\"/></Rows><Band id=\"head\"><Cell text=\"업체명\"/><Cell col=\"1\" text=\"건물명(호실번호)\"/><Cell col=\"2\" text=\"계약기간\"/><Cell col=\"3\" text=\"임대료\"/><Cell col=\"4\" text=\"관리비\"/><Cell col=\"5\" text=\"유틸리티\"/><Cell col=\"6\" text=\"임대계약해지일자\"/><Cell col=\"7\" text=\"상태\"/></Band><Band id=\"body\"><Cell textAlign=\"center\" text=\"bind:bzentyNm\"/><Cell col=\"1\" text=\"bind:bldgNm\" textAlign=\"left\"/><Cell col=\"2\" text=\"bind:rentPrd\" textAlign=\"center\" displaytype=\"normal\" maskedittype=\"string\"/><Cell col=\"3\" text=\"bind:rtfeYnNm\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:mncoYnNm\" textAlign=\"left\"/><Cell col=\"5\" text=\"bind:utltYnNm\" textAlign=\"left\"/><Cell col=\"6\" text=\"bind:ctrtCncltnYmd\" textAlign=\"center\" displaytype=\"date\"/><Cell col=\"7\" text=\"bind:prgrsSttsNm\" textAlign=\"left\"/></Band></Format></Formats>");
            this.divGrd.addChild(obj.name, obj);
            ...
            //-- Default Layout : this
            obj = new Layout("default","",1420,900,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                p = rootobj;
                p.set_titletext("임대보증금/선납임대료 반환신청 목록(입주자)");
            ...
            obj = new Layout("mobile","",390,900,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.divSch.move("20","0",null,"153","20",null);
        ...
        // User Script
        this.addIncludeScript("REN033M00.xfdl","xjs::TaskCom.xjs");
        this.registerScript("REN033M00.xfdl", function() {
        /**
        *  인천공항 원스톱 입주자서비스 프로젝트
        *  @FileName 	REN033M00.xfdl
        *  @Creator 	(주)이루온
        *  @CreateDate 	2024/11/19
        *  @Desction    임대보증금/선납임대료 반환신청
        ******************** 소스 수정 이력 ***********************************************
        ...
        *******************************************************************************************************************************/
        ...
        this.cfnSearch = function(page)
        {
        	if (this.dsSearch.getColumn(0, "pSptIdntyBgngYmd") > this.dsSearch.getColumn(0, "pSptIdntyEndYmd")) {
        		this.gfnAlertMsg("msg", "MSG_012", ["임대계약해지일자"]);		//{0} 시작일자가 종료일자보다 큽니다.
        		return;
        	}
        ...
        *******************************************************************************************************************************/
        ...
        this.getSearchTransaction = function() {
        	...
        	var strSvcId    = "search";
        	var strSvcUrl   = "ren/rtn/selectRentSctdpGvbkAplyList.do";
        ...
        *******************************************************************************************************************************/
        this.fnInit = function()
        {
        	...
        	this.dsSearch.setColumn(0,"pSbmsnId",this.objApp.gUser.userId);
        };
        ...
        this.selectBldgCdList = function() {
        	...
        	var strArg      = "pInqSe=A pTaskSe=LOI pSttsCd='32,34,35'"	// 32.의향서접수 34.임대배정정보SAP전송 35.임대배정확정
        	var callBackFnc = "fnCallback";
        	var isAsync   	= true;
        ...
        this.divGrd_grdList_oncellclick = function(obj,e)
        {
        	//if(e.cell == 0) {
        		...
        		var sMenuUrl = 'work::REN/RTN/REN033M01.xfdl';
        		var actNm = '상세';
        ...
        this.loadIncludeScript("REN033M00.xfdl");
