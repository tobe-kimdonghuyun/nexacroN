(function()
{
    return function()
    {
        ...
        {
            this.set_name("REN022M02");
            this.set_titletext("임차의향서(정기) 접수목록");
            ...
            obj._setContents("<ColumnInfo><Column id=\"currentPageNo\" type=\"STRING\" size=\"256\"/><Column id=\"recordCountPerPage\" type=\"STRING\" size=\"256\"/><Column id=\"pRcptNo\" type=\"STRING\" size=\"256\"/><Column id=\"pBzentyNm\" type=\"STRING\" size=\"256\"/><Column id=\"pBldgCd\" type=\"STRING\" size=\"256\"/><Column id=\"pPrgrsSttsCd\" type=\"STRING\" size=\"256\"/><Column id=\"pBgngYmd\" type=\"STRING\" size=\"256\"/><Column id=\"pEndYmd\" type=\"STRING\" size=\"256\"/><Column id=\"pPrcsDeptCd\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"recordCountPerPage\">10</Col><Col id=\"currentPageNo\">1</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsList", this);
            obj._setContents("<ColumnInfo><Column id=\"rcptNo\" type=\"STRING\" size=\"256\"/><Column id=\"bzentyNm\" type=\"STRING\" size=\"256\"/><Column id=\"bldgCd\" type=\"STRING\" size=\"256\"/><Column id=\"bldgNm\" type=\"STRING\" size=\"256\"/><Column id=\"sbmsnDt\" type=\"STRING\" size=\"256\"/><Column id=\"prgrsSttsCd\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_flexgrow("1");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"staLabel03\"/><PanelItem id=\"PanelItem01\" componentid=\"cboPrgrsSttsCd\"/></Contents>");
            this.divSch.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"200\"/><Column size=\"300\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"56\" band=\"head\"/><Row size=\"48\"/></Rows><Band id=\"head\"><Cell text=\"접수번호\"/><Cell col=\"1\" text=\"업체명\"/><Cell col=\"2\" text=\"건물명(호실번호)\"/><Cell col=\"3\" text=\"제출일자\"/><Cell col=\"4\" text=\"상태\" cssclass=\"CellEnd\"/></Band><Band id=\"body\"><Cell text=\"bind:rcptNo\" displaytype=\"text\"/><Cell col=\"1\" text=\"bind:bzentyNm\" displaytype=\"text\" edittype=\"none\" maskeditformat=\"####-##-##\"/><Cell col=\"2\" text=\"bind:bldgNm\" displaytype=\"text\" combodataset=\"dsCboBzentyClsfCd\" combodatacol=\"cdNm\" combocodecol=\"cdId\"/><Cell col=\"3\" text=\"bind:sbmsnDt\" displaytype=\"text\" combodataset=\"dsCboPstnCd\" combodatacol=\"cdNm\" combocodecol=\"cdId\"/><Cell col=\"4\" text=\"bind:prgrsSttsCd\" displaytype=\"combotext\" edittype=\"none\" maskedittype=\"string\" textAlign=\"center\" cssclass=\"CellEnd\" combodataset=\"dsCboPrgrsSttsCd\" combocodecol=\"cdId\" combodatacol=\"cdNm\"/></Band></Format></Formats>");
            this.divGrd.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("REN022M02.xfdl","xjs::TaskCom.xjs");
        this.registerScript("REN022M02.xfdl", function() {
        /**
        *  인천공항 원스톱 입주자서비스 프로젝트
        *  @FileName 	REN022M02.xfdl
        *  @Creator 	(주)이루온
        ...
        *******************************************************************************************************************************/
        ...
        {
        	var strSvcId    = "search";
        	var strSvcUrl   = "ren/rgl/selectHireLoiRcptList.do";
        ...
        *******************************************************************************************************************************/
        ...
        this.divGrd_grdList_oncelldblclick = function(obj,e)
        {
        	...
        	if (this.objApp.screenid == "Desktop_screen") {
        		...
        		var sMenuUrl = 'work::REN/RGL/REN022M03.xfdl';
        		var actNm = '처리자 상세';
        		...
        		/*****  MDI 에 추가하는 페이지 오픈을 위한 코드 *****/
        			...
        			this.gfnOpenPopup("REN022M03", "work::REN/RGL/REN022M03.xfdl", objArg, sPopupCallBack, objOption);
        	}
        };
        ...
        this.loadIncludeScript("REN022M02.xfdl");
