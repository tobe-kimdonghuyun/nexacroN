(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"currentPageNo\" type=\"STRING\" size=\"256\"/><Column id=\"recordCountPerPage\" type=\"STRING\" size=\"256\"/><Column id=\"pBldgCd\" type=\"STRING\" size=\"256\"/><Column id=\"pPrgrsSttsCd\" type=\"STRING\" size=\"256\"/><Column id=\"pLoiSeCd\" type=\"STRING\" size=\"256\"/><Column id=\"pUserId\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"recordCountPerPage\">10</Col><Col id=\"currentPageNo\">1</Col></Row></Rows>");
            ...
            obj = new Div("divSch","0","divTitle:10",null,"153","60",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Div00");
            ...
            obj = new Panel("Panel00","1694.00","398","560","40",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("5");
            obj.set_type("horizontal");
            ...
            obj = new Panel("Panel01","1694.00","398","560","40",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("10");
            obj.set_type("horizontal");
            obj.set_horizontalgap("10");
            obj.set_fittocontents("height");
            obj.set_flexgrow("1");
            obj._setContents("<Contents><PanelItem id=\"PanelItem02\" componentid=\"staLabel01\"/><PanelItem id=\"PanelItem01\" componentid=\"cboPrgrsSttsCd\"/></Contents>");
            this.divSch.addChild(obj.name, obj);
            ...
            obj = new Layout("default","Desktop_screen",1480,900,this,
                ...
                p.divSch.move("0","divTitle:10",null,"153","60",null);
        ...
        // User Script
        this.addIncludeScript("REN023M02.xfdl","xjs::TaskCom.xjs");
        this.registerScript("REN023M02.xfdl", function() {
        /**
        *  인천공항 원스톱 입주자서비스 프로젝트
        *  @FileName 	REN023M02.xfdl
        *  @Creator 	(주)이루온
        ...
        *******************************************************************************************************************************/
        ...
        this.cfnSearch = function (page)
        {
        	...
        	this.dsSearch.setColumn(0, "pbzentyNm", this.objApp.gdsUser.getColumn(0, "userNm"));
        ...
        *******************************************************************************************************************************/
        ...
        {
        	var strSvcId    = "search";
        	var strSvcUrl   = "ren/rgl/selectRentAsnCfmtnList.do";
        ...
        this.fnCallback = function(svcID, errorCode, errorMsg)
        {
        	...
        	switch(svcID)
        	{
        		case "_cfnComCdLoad_":
        			...
        			this.dsCboPrgrsSttsCd.filter("cdId == '32' || cdId == '34' || cdNm == '전체' ");
        			...
        			if (this.strFilter == "") {
        				for (var i=0; i < this.dsList.rowcount; i++) {
        					if (i < this.dsList.rowcount -1) {
        						this.strFilter += "cdId == '"+this.dsList.getColumn(i,"bldgCd")+"' &&  grp2CdId == '" +this.dsList.getColumn(i,"pstnCd")+"' || ";
        					} else {
        						this.strFilter += "cdId == '"+ this.dsList.getColumn(i,"bldgCd")+"' &&  grp2CdId == '" +this.dsList.getColumn(i,"pstnCd")+"' || cdNm == '전체' ";
        					}
        				}
        ...
        *******************************************************************************************************************************/
        this.fnInit = function()
        {
        	...
        	this.dsSearch.setColumn(0, "pLoiSeCd", "R"); // 의향서구분코드 R.변경
        ...
        *******************************************************************************************************************************/
        ...
        this.divGrd_grdList_oncelldblclick = function(obj,e)
        {
        	...
        	if (this.objApp.screenid == "Desktop_screen") {
        		...
        		var sMenuUrl = 'work::REN/RGL/REN023M03.xfdl';
        		var actNm = '상세';
        		...
        		/*****  MDI 에 추가하는 페이지 오픈을 위한 코드 *****/
        			...
        			this.gfnOpenPopup("REN022M03", "work::REN/RGL/REN023M03.xfdl", objArg, sPopupCallBack, objOption);
        	}
        };
        ...
        this.loadIncludeScript("REN023M02.xfdl");
