(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("작업신고서 조회 및 작업공유 (신청자) ");
            ...
            obj = new Panel("pan01_00","860","30","300","40",null,null,null,null,null,null,this.divForm.form.divSch.form);
            obj.set_taborder("10");
            obj.set_type("horizontal");
            obj.set_horizontalgap("10");
            obj.set_flexgrow("1");
            ...
            obj = new Panel("pan01_00_00","752.00","54","300","40",null,null,null,null,null,null,this.divForm.form.divSch.form);
            obj.set_taborder("12");
            obj.set_type("horizontal");
            obj.set_horizontalgap("10");
            obj.set_flexgrow("1");
            ...
            obj = new Panel("pan01_00_00_00","755.00","65","300","40",null,null,null,null,null,null,this.divForm.form.divSch.form);
            obj.set_taborder("15");
            obj.set_type("horizontal");
            obj.set_horizontalgap("10");
            obj.set_flexgrow("1");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"250\"/><Column size=\"150\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"44\" band=\"head\"/><Row size=\"44\"/></Rows><Band id=\"head\"><Cell text=\"순번\"/><Cell col=\"1\" text=\"작업구분\"/><Cell col=\"2\" text=\"작업신청서번호\"/><Cell col=\"3\" text=\"신청일자\"/><Cell col=\"4\" text=\"공유시작일자\"/><Cell col=\"5\" text=\"공유종료일자\"/><Cell col=\"6\" text=\"신청자\"/><Cell col=\"7\" text=\"승인여부\"/><Cell col=\"8\" text=\"승인일자\"/><Cell col=\"9\" text=\"승인자\" cssclass=\"CellEnd\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" textAlign=\"right\" text=\"expr:currow+1\"/><Cell col=\"1\" text=\"bind:aplySeNm\" displaytype=\"text\" textAlign=\"left\"/><Cell col=\"2\" text=\"bind:aplyNo\" displaytype=\"text\" textAlign=\"center\"/><Cell col=\"3\" textAlign=\"center\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\" text=\"bind:aplyYmd\"/><Cell col=\"4\" textAlign=\"center\" calendardateformat=\"yyyy-MM-dd\" displaytype=\"date\" text=\"bind:shrnBgngYmd\" calendardisplaynulltype=\"nulltext\"/><Cell col=\"5\" textAlign=\"center\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\" text=\"bind:shrnEndYmd\" calendardisplaynulltype=\"nulltext\"/><Cell col=\"6\" textAlign=\"center\" text=\"bind:aplcntNm\"/><Cell col=\"7\" textAlign=\"center\" text=\"bind:shrnAprvCd\" displaytype=\"combotext\" combodataset=\"dsAprv\" combodatacol=\"name\" combocodecol=\"code\"/><Cell col=\"8\" textAlign=\"center\" calendardateformat=\"yyyy-MM-dd\" displaytype=\"date\" text=\"bind:shrnAprvYmd\" calendardisplaynulltype=\"nulltext\"/><Cell col=\"9\" cssclass=\"CellEnd\" textAlign=\"center\" text=\"bind:shrnAutzrNm\"/></Band></Format></Formats>");
            this.divForm.form.divGrd.addChild(obj.name, obj);
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divSch.form,
                ...
                p.pan01_00.move("860","30","300","40",null,null);
                ...
                p.pan01_00_00.move("752.00","54","300","40",null,null);
                ...
                p.pan01_00_00_00.move("755.00","65","300","40",null,null);
            ...
            obj = new Layout("default","Desktop_screen",1000,700,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.set_titletext("작업신고서 조회 및 작업공유 (신청자) ");
        ...
        // User Script
        this.addIncludeScript("CST006P10_01.xfdl","xjs::TaskCom.xjs");
        this.registerScript("CST006P10_01.xfdl", function() {
        /**
        ...
        *******************************************************************************************************************************/
        		...
        		if(this.dsList.getColumn(i, "chk") == "1") {
        			if(!this.gfnIsNull(this.dsList.getColumn(i, "endDt"))){
        				...
        				if (this.gfn_getDiffDate(replaceEndDt, this.fvCurDate) > 0) {
        					...
        					this.gfnAlertMsg("req1", "MSG_024", ["승인인자는 작업종료일자보다 \n클 수"]); // {0} 없습니다.
        					return false;
        				}
        			}
        		}
        ...
        this.loadIncludeScript("CST006P10_01.xfdl");
