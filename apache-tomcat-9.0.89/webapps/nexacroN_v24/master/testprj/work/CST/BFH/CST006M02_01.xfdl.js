(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("작업신청내역조회(팝업)");
            ...
            obj = new Div("divForm","0","0",null,"800","0",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("div00");
            ...
            obj.set_fittocontents("height");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"pan03\"/><PanelItem id=\"PanelItem01\" componentid=\"Panel05_00\"/></Contents>");
            this.divForm.form.divSch.addChild(obj.name, obj);

            obj = new Panel("pan03","20.00","67","300","40",null,null,null,null,null,null,this.divForm.form.divSch.form);
            obj.set_taborder("1");
            obj.set_type("horizontal");
            ...
            obj = new Panel("Panel05_00","1694.00","398","300","40",null,null,null,null,null,null,this.divForm.form.divSch.form);
            obj.set_taborder("8");
            obj.set_flexgrow("1");
            obj.set_horizontalgap("10");
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divSch.form,
                ...
                p.pan03.move("20.00","67","300","40",null,null);
                ...
                p.Panel05_00.move("1694.00","398","300","40",null,null);
            	}
            );
            ...
            this.divForm.form.addLayout(obj.name, obj);
            //-- Default Layout : this
            obj = new Layout("default","Desktop_screen,Phone_screen",1000,800,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                p = rootobj;
                p.set_titletext("작업신청내역조회(팝업)");
            ...
            obj = new Layout("mobile","Phone_screen",480,800,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.divForm.move("20","60",null,"850","20",null);
            	}
            );
            obj.set_mobileorientation("Landscape");
            obj.set_type("default");
        ...
        // User Script
        this.addIncludeScript("CST006M02_01.xfdl","xjs::TaskCom.xjs");
        this.registerScript("CST006M02_01.xfdl", function() {
        /**
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("CST006M02_01.xfdl");
