(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("작업신고서 불러오기(메인)");
            ...
            obj = new Panel("Panel05","230","110","480","40",null,null,null,null,null,null,this.divForm.form.divSch.form);
            obj.set_taborder("18");
            obj.set_flexgrow("1");
            obj.set_horizontalgap("10");
            ...
            obj = new Panel("Panel05_00","230","110","480","40",null,null,null,null,null,null,this.divForm.form.divSch.form);
            obj.set_taborder("23");
            obj.set_flexgrow("1");
            obj.set_horizontalgap("10");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"150\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"250\"/><Column size=\"200\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"150\"/></Columns><Rows><Row size=\"44\" band=\"head\"/><Row size=\"44\"/></Rows><Band id=\"head\"><Cell text=\"순번\"/><Cell col=\"1\" text=\"신청번호\"/><Cell col=\"2\" text=\"단계\"/><Cell col=\"3\" text=\"종료구분\"/><Cell col=\"4\" text=\"신청구분\"/><Cell col=\"5\" text=\"제목(작업명)\"/><Cell col=\"6\" text=\"위치정보(룸번호)\"/><Cell col=\"7\" text=\"회사\"/><Cell col=\"8\" text=\"신청자\"/><Cell col=\"9\" text=\"신청일자\"/><Cell col=\"10\" text=\"처리자\"/><Cell col=\"11\" text=\"처리그룹\" cssclass=\"CellEnd\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\" textAlign=\"right\"/><Cell col=\"1\" text=\"bind:aplyNo\" cursor=\"pointer\" textAlign=\"center\" textDecoration=\"underline\" cssclass=\"CellLink,CellTxtBlue\" displaytype=\"text\"/><Cell col=\"2\" text=\"bind:jobNm\"/><Cell col=\"3\" text=\"bind:endNm\"/><Cell col=\"4\" text=\"bind:aplySeNm\"/><Cell col=\"5\" text=\"bind:bldgSeNm\"/><Cell col=\"6\" text=\"bind:pstnInfoRnb\"/><Cell col=\"7\" text=\"bind:aplcntCoNm\"/><Cell col=\"8\" text=\"bind:aplcntNm\" textAlign=\"center\"/><Cell col=\"9\" text=\"bind:aplyDt\" textAlign=\"center\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"10\" text=\"bind:pbcprtPrcrNm\" textAlign=\"center\"/><Cell col=\"11\" cssclass=\"CellEnd\" text=\"bind:prcrGroupNm\"/></Band></Format></Formats>");
            this.divForm.form.divGrd.addChild(obj.name, obj);
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divSch.form,
                ...
                p.Panel05.move("230","110","480","40",null,null);
                ...
                p.Panel05_00.move("230","110","480","40",null,null);
            ...
            obj = new Layout("default","",0,0,this.divForm.form,
                ...
                p.divSch.move("20","10","100%","292",null,null);

                p.divGrd.set_taborder("0");
                p.divGrd.set_text("Div01");
                p.divGrd.set_formscrollbartype("none none");
                p.divGrd.set_fittocontents("height");
                p.divGrd.move("0","30","100.00%","460",null,null);
            	}
            );
            obj.set_verticalgap("20");
            obj.set_type("vertical");
        ...
        // User Script
        this.addIncludeScript("CST006P02.xfdl","xjs::TaskCom.xjs");
        this.registerScript("CST006P02.xfdl", function() {
        /**
        ...
        *******************************************************************************************************************************/
        this.fnSearch = function (page) {
        	...
        	var pstnInfoRnb = this.divForm.form.divSch.form.edtPstnInfoRnb.value;
        	var pbcprtPrcrNm = this.divForm.form.divSch.form.edtPbcprtPrcrNm.value;
        	var cstrnJobNm = this.divForm.form.divSch.form.edtCstrnJobNm.value;
        	this.dsSearch.setColumn(0, "aplyNo", aplyNo);
        	this.dsSearch.setColumn(0, "pstnInfoRnb", pstnInfoRnb);
        	this.dsSearch.setColumn(0, "pbcprtPrcrNm", pbcprtPrcrNm);
        	this.dsSearch.setColumn(0, "cstrnJobNm", cstrnJobNm);
        ...
        *******************************************************************************************************************************/
        ...
        //공통코드 후석 처리(서비스 구분 세팅 등)
        this.comCodeSet = function() {

        	this.dsComcodeList.filter("cdLvl != '1'");
        	//서비스구분 세팅
        ...
        *******************************************************************************************************************************/
        ...
        this.divForm_divSch_btnSch_onclick = function(obj,e)
        {
        	...
        	if (this.dsSearch.getColumn(0, "aplyEdDt") > this.fvCurDate) {
        		this.divForm.form.divSch.form.divCal.form.calAplyEdDt.setFocus();
        		this.gfnAlertMsg("msg", "MSG_024", ["기준종료일자는 오늘 날짜보다 \n클 수"]); // {0} 없습니다.
        		return false;
        	}
        ...
        //검색조건 회사명 팝업조회 외 임의로 변경 시
        this.divForm_divSch_divEdtPop_edtAplcntInstCd_onchanged = function(obj,e)
        {
        	//회사명 팝업 검색이 아닌 임의로 입력 시 회사코드 초기화
        	this.dsSearch.setColumn(0, "aplcntInstCd", "");
        };
        ...
        this.divForm_divGrd_Grid00_oncellclick = function(obj,e)
        {
        	...
        	if(e.cell == 1) {
        		...
        		this.gfnOpenPopup("aplyNoPop", "work::CST/BFH/CST006P02_01.xfdl", {}, (sPopId, sJsonStr) => {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divForm.form.divSch.form.divEdtPop.form.edtAplcntInstCd.addEventHandler("onchanged",this.divForm_divSch_divEdtPop_edtAplcntInstCd_onchanged,this);
        ...
        this.loadIncludeScript("CST006P02.xfdl");
