(function()
{
    return function()
    {
        ...
        {
            this.set_name("CST012P05");
            this.set_titletext("물품 그룹 투입 수량 등록");
            ...
            obj = new Static("staSubTitle","170","70","100%","50",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("물품 그룹 투입 수량 등록");
            obj.set_cssclass("sta_WF_SubTitle");
            this.addChild(obj.name, obj);

            obj = new Panel("Panel02","170","70","100%","48",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"staSubTitle\"/></Contents>");
            this.addChild(obj.name, obj);

            obj = new Static("staLabel03_00","0.00","0","43.75%","46",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new Panel("Panel02_00","20.00","0","350","86",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_type("vertical");
            obj.set_flexgrow("1");
            ...
            obj = new Panel("Panel02_01","390.00","0","350","1",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_type("vertical");
            obj.set_flexgrow("1");
            ...
            obj = new Panel("pan00","0","0","100%","97",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            ...
            obj = new Panel("panGrdBtn",null,"0","230","34","0",null,null,null,null,null,this.divGrd.form);
            obj.set_taborder("6");
            obj.set_flexcrossaxisalign("start");
            obj.set_flexcrossaxiswrapalign("start");
            obj.set_flexmainaxisalign("end");
            obj.set_horizontalgap("10");
            obj._setContents("<Contents><PanelItem id=\"PanelItem01\" componentid=\"btnAddRow\"/><PanelItem id=\"PanelItem03\" componentid=\"btnDelRow\"/></Contents>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"200\"/><Column size=\"200\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"150\"/><Column size=\"200\"/><Column size=\"120\"/></Columns><Rows><Row size=\"56\" band=\"head\"/><Row size=\"48\"/></Rows><Band id=\"head\"><Cell text=\"물품등록번호\"/><Cell col=\"1\" text=\"물품 명\"/><Cell col=\"2\" text=\"이미지\"/><Cell col=\"3\" text=\"수량\"/><Cell col=\"4\" text=\"단위\"/><Cell col=\"5\" text=\"물품 규격\"/><Cell col=\"6\" text=\"보관위치\"/><Cell col=\"7\" text=\"등록일자\" cssclass=\"CellEnd\"/></Band><Band id=\"body\"><Cell text=\"bind:userCmdtySn\" displaytype=\"text\" textAlign=\"left\"/><Cell col=\"1\" text=\"bind:cmdtyNm\" displaytype=\"text\" textAlign=\"left\" expandsize=\"20\"/><Cell col=\"2\" text=\"bind:이미지경로\" displaytype=\"text\" textAlign=\"left\"/><Cell col=\"3\" displaytype=\"editcontrol\" edittype=\"text\" editinputtype=\"digit\" textAlign=\"right\" text=\"bind:cmdtyQty\"/><Cell col=\"4\" text=\"bind:unitNm\" displaytype=\"text\" textAlign=\"left\"/><Cell col=\"5\" textAlign=\"left\" text=\"bind:spcfctNm\"/><Cell col=\"6\" displaytype=\"editcontrol\" edittype=\"text\" textAlign=\"left\" text=\"bind:cmdtyStgLctn\"/><Cell col=\"7\" text=\"bind:frstRegDt\" displaytype=\"date\" cssclass=\"CellEnd\" textAlign=\"center\" calendardateformat=\"yyyy-MM-dd\" calendardisplayinvalidtype=\"none\" calendardisplaynulltype=\"none\"/></Band></Format></Formats>");
            this.divGrd.addChild(obj.name, obj);
            ...
            obj = new Button("btnAddRow","80.00","0","71","34",null,null,null,null,null,null,this.divGrd.form);
            obj.set_taborder("4");
            obj.set_text("추가");
            obj.set_cssclass("btn_WF_Small");
            this.divGrd.addChild(obj.name, obj);

            obj = new Button("btnDelRow","161.00","0","69","34",null,null,null,null,null,null,this.divGrd.form);
            obj.set_taborder("5");
            obj.set_text("선택삭제");
            ...
            obj = new Button("btnSave","606.00","5","68","40",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("저장");
            ...
            obj = new Layout("default","",0,0,this.divGrd.form,
                ...
                p.btnAddRow.move("80.00","0","71","34",null,null);
                ...
                p.btnDelRow.move("161.00","0","69","34",null,null);
            	}
            );
            ...
            obj = new Layout("default","Desktop_screen",1280,700,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.set_titletext("물품 그룹 투입 수량 등록");
                ...
                p.staSubTitle.set_text("물품 그룹 투입 수량 등록");
                p.staSubTitle.set_cssclass("sta_WF_SubTitle");
                p.staSubTitle.move("170","70","100%","50",null,null);

                p.Panel02.set_taborder("2");
                p.Panel02.move("170","70","100%","48",null,null);

                p.staLabel03_00.set_taborder("3");
                p.staLabel03_00.set_text("물품 그룹 선택");
                p.staLabel03_00.set_cssclass("sta_WF_Label");
                p.staLabel03_00.move("0.00","0","43.75%","46",null,null);

                p.cboGrpCd.set_taborder("4");
                ...
                p.Panel02_00.move("20.00","0","350","86",null,null);

                p.Panel02_01.set_taborder("6");
                p.Panel02_01.set_type("vertical");
                p.Panel02_01.set_flexgrow("1");
                p.Panel02_01.move("390.00","0","350","1",null,null);
                ...
                p.pan00.move("0","0","100%","97",null,null);
                ...
                p.btnSave.move("606.00","5","68","40",null,null);
            	}
            );
            ...
            obj = new Layout("mobile","Phone_screen",480,700,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.Panel00.move("20","0",null,"145","20",null);

                p.divGrd.move("20","Panel00:20",null,null,"20","Panel01:20");

                p.Panel01.move("20",null,null,"50","20","0");
            	}
            );
            obj.set_mobileorientation("Landscape");
        ...
        // User Script
        this.registerScript("CST012P05.xfdl", function() {
        /**
        *  인천국제공항공사 입주자 원스톱 서비스 프로젝트
        *  @FileName 	CST012P05.xfdl
        *  @Creator 	ELUON INS
        ...
        *******************************************************************************************************************************/
        //추가
        this.divGrd_btnAddRow_onclick = function(obj,e)
        {
        ...
        //선택삭제
        this.divGrd_btnDelRow_onclick = function(obj,e)
        {
        	if (this.dsList.findRow("chk", "1") == -1) {
        		this.gfnAlertMsg("msg3", "MSG_011", ["선택된 정보가 없습니다."]);
        		return;
        	}
        ...
        this.divGrd_grdList_onexpandup = function(obj,e)
        {
        	...
        	//팝업에서 gfnClosePopup 으로 닫는 경우 popupCallback이 2번 실행되서 메시지 팝업 수행 시 반복적으로 나오지 않도록 별도 처리
        	let sameCnt = 0;
        ...
        this.btnSave_onclick = function(obj,e)
        {
        	...
        	let nFindRow = this.dsList.findRowExpr("dataset.parent.gfnIsNull(userCmdtySn)");
        	if (nFindRow != -1) {
        		this.dsList.rowposition = nFindRow;
        		this.gfnAlertMsg("msg5", "MSG_009", ["물품정보"]); /// {0} 을/를 입력해 주세요.
        		this.divGrd.form.grdList.setFocus();
        		return;
        	}

        	nFindRow = this.dsList.findRowExpr("dataset.parent.gfnIsNull(cmdtyQty)");
        	if (nFindRow != -1) {
        		this.dsList.rowposition = nFindRow;
        		this.gfnAlertMsg("msg6", "MSG_009", ["수량"]); /// {0} 을/를 입력해 주세요.
        		this.divGrd.form.grdList.setFocus();
        		return;
        	}

        	if (!this.gfnDsIsUpdated(this.dsList)) {
        		this.gfnAlertMsg("msg4", "MSG_004");	// 변경된 내역이 없습니다.
        		return;
        	}
        ...
        this.on_initEvent = function()
        {
            ...
            this.divGrd.form.btnAddRow.addEventHandler("onclick",this.divGrd_btnAddRow_onclick,this);
            this.divGrd.form.btnDelRow.addEventHandler("onclick",this.divGrd_btnDelRow_onclick,this);
            this.btnSave.addEventHandler("onclick",this.btnSave_onclick,this);
            this.dsList.addEventHandler("oncolumnchanged",this.dsList_oncolumnchanged,this);
            this.dsList.addEventHandler("cancolumnchange",this.dsList_cancolumnchange,this);
        };
        this.loadIncludeScript("CST012P05.xfdl");
