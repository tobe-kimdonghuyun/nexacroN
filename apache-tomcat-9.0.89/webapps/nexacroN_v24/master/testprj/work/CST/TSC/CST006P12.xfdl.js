(function()
{
    return function()
    {
        ...
        {
            this.set_name("CST006P12");
            this.set_titletext("만족도조사(작업신고서)");
        ...
        // User Script
        this.addIncludeScript("CST006P12.xfdl","xjs::TaskCom.xjs");
        this.registerScript("CST006P12.xfdl", function() {
        /**
        *  인천국제공항공사 입주자 원스톱 서비스 프로젝트
        *  @FileName 	CST005S06.xfdl
        *  @Creator 	ELUON INS
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("CST006P12.xfdl");
