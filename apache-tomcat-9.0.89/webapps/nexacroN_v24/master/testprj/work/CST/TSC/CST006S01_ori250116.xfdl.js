(function()
{
    return function()
    {
        ...
        {
            this.set_name("CST006S01");
            this.set_titletext("신청자정보(작업신고서)");
            ...
            obj.set_fittocontents("height");
            obj.set_verticalgap("4");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"staLabel05_01_00\"/><PanelItem id=\"PanelItem03\" componentid=\"edtHwrtInptPstnInfoCn\"/></Contents>");
            this.divAplcntInfo.addChild(obj.name, obj);
            ...
            obj = new BindItem("item21","divAplcntInfo.form.divCtrtChc.form.btnCtrtChc","visible","dsAtrb","vsAplcfmWrt");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("CST006S01_ori250116.xfdl","xjs::TaskCom.xjs");
        this.registerScript("CST006S01_ori250116.xfdl", function() {
        /**
        ...
        *******************************************************************************************************************************/
        ...
        {
        	// 가이드
        	this.panInfoGuide.visible = this.cfnGetAtrb.call("vsAplcfmWrt");
        ...
        *******************************************************************************************************************************/
        ...
        this.loadIncludeScript("CST006S01_ori250116.xfdl");
