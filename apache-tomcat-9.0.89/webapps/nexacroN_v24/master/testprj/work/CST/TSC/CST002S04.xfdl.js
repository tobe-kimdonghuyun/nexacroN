    ...
    return function()
    {
        ...
        *******************************************************************************************************************************/
        this.cfnIsVldDat = function() {
            ...
            if(!this.cfnGetAtrb.call("roCmcnInspYmd")) {
        		// 준공검사일자
        	...
        	// TAS00489:도면및서류최종검토
        	if(!this.cfnGetAtrb.call("roFlrplnAplcnYn")) {
        		// 도면적용여부
        ...
        *******************************************************************************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.dsCmcnInspRvw.addEventHandler("cancolumnchange",this.Dataset_cancolumnchange,this);
        };
