(function()
{
    return function()
    {
        ...
        {
            this.set_name("CST014M01");
            this.set_titletext("위해물품반입신청");
            ...
            obj.set_horizontalgap("10");
            obj._setContents("<Contents><PanelItem id=\"PanelItem06\" componentid=\"btnAply\"/><PanelItem id=\"PanelItem04\" componentid=\"btnGrdDel\"/><PanelItem id=\"PanelItem07\" componentid=\"btnSave\"/><PanelItem id=\"PanelItem05\" componentid=\"btnGrdRegi\"/><PanelItem id=\"PanelItem08\" componentid=\"btnAplcfm\"/></Contents>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"120\"/><Column size=\"180\"/><Column size=\"140\"/><Column size=\"140\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"130\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"44\" band=\"head\"/><Row size=\"44\"/><Row size=\"48\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"순번\"/><Cell col=\"1\" text=\"사진\"/><Cell col=\"2\" text=\"물품명\"/><Cell col=\"3\" text=\"규격\"/><Cell col=\"4\" text=\"단위\"/><Cell col=\"5\" text=\"신청수량\"/><Cell col=\"6\" text=\"스캔수량\"/><Cell col=\"7\" text=\"육안확인수량\"/><Cell col=\"8\" text=\"수량합계\"/><Cell col=\"9\" text=\"정산(과오)수량\"/><Cell col=\"10\" text=\"총저장수량\"/><Cell col=\"11\" text=\"총승인수량\" cssclass=\"CellEnd\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\" textAlign=\"right\"/><Cell col=\"1\" textAlign=\"left\"/><Cell col=\"2\" text=\"bind:cmdtyNm\" textAlign=\"left\"/><Cell col=\"3\" textAlign=\"left\" text=\"bind:spcfctVl\"/><Cell col=\"4\" textAlign=\"left\" text=\"bind:unitVl\"/><Cell col=\"5\" textAlign=\"right\" text=\"bind:thldQty\" displaytype=\"number\"/><Cell col=\"6\" textAlign=\"right\" text=\"bind:autoInptQty\" displaytype=\"normal\" edittype=\"none\" editinputtype=\"digit\" editmaxlength=\"10\" editautoselect=\"true\"/><Cell col=\"7\" textAlign=\"right\" text=\"bind:mnlInptQty\" displaytype=\"editcontrol\" edittype=\"normal\" editinputtype=\"digit\" editmaxlength=\"10\" editautoselect=\"true\"/><Cell col=\"8\" textAlign=\"right\" text=\"bind:hstryCrynQty\" displaytype=\"number\"/><Cell col=\"9\" cssclass=\"expr:errQty != 0 ? &quot;CellEnd CellTxtRed&quot; : &quot;CellEnd&quot;\" textAlign=\"right\" text=\"bind:errQty\" displaytype=\"number\" font=\"bold 17px/normal &quot;pretendard&quot;\"/><Cell col=\"10\" text=\"bind:allRegQty\" displaytype=\"number\" textAlign=\"right\"/><Cell col=\"11\" text=\"bind:crynQty\"/></Band><Band id=\"summary\"><Cell/><Cell col=\"1\"/><Cell col=\"2\"/><Cell col=\"3\"/><Cell col=\"4\"/><Cell col=\"5\"/><Cell col=\"6\"/><Cell col=\"7\" text=\"합계수량\"/><Cell col=\"8\" expr=\"dataset.parent.gfn_appendComma(dataset.getSum(&apos;hstryCrynQty&apos;))\" textAlign=\"right\"/><Cell col=\"9\" expr=\"dataset.parent.gfn_appendComma(dataset.getSum(&apos;errQty&apos;)) \" textAlign=\"right\"/><Cell col=\"10\" expr=\"dataset.parent.gfn_appendComma(dataset.getSum(&apos;allRegQty&apos;)) + &quot; / &quot; + dataset.parent.gfn_appendComma(dataset.getSum(&apos;thldQty&apos;))\" textAlign=\"right\"/><Cell col=\"11\" expr=\"dataset.parent.gfn_appendComma(dataset.getSum(&apos;crynQty&apos;)) + &quot; / &quot; + dataset.parent.gfn_appendComma(dataset.getSum(&apos;thldQty&apos;))\" textAlign=\"right\"/></Band></Format></Formats>");
            this.divForm.form.divGrd.addChild(obj.name, obj);
            ...
            obj = new Button("btnAply","334.00","0","57","34",null,null,null,null,null,null,this.divForm.form.divGrd.form);
            obj.set_taborder("7");
            obj.set_text("승인");
            obj.set_fittocontents("width");
            ...
            obj = new Button("btnSave","513.00","0","57","34",null,null,null,null,null,null,this.divForm.form.divGrd.form);
            obj.set_taborder("9");
            obj.set_text("저장");
            obj.set_fittocontents("width");
            obj.set_cssclass("btn_WF_Small");
            ...
            obj = new Div("divHstry","0","divGrd:20","100%","400",null,null,null,null,null,null,this.divForm.form);
            obj.set_taborder("2");
            obj.set_fittocontents("height");
            obj.set_formscrollbartype("none none");
            obj.set_formscrolltype("none");
            ...
            obj = new Grid("grdList","0","44","100.00%",null,null,"0",null,null,null,null,this.divForm.form.divHstry.form);
            obj.set_taborder("2");
            ...
            obj.set_taborder("1");
            obj.set_value("29^SEC2411_00024^WAPWATCHBOX00002");
            obj.set_visible("true");
            obj.set_text("29^SEC2411_00024^WAPWATCHBOX00002");
            this.addChild(obj.name, obj);
            ...
            obj = new Layout("default","",0,0,this.divForm.form.divGrd.form,
                ...
                p.btnAply.set_taborder("7");
                p.btnAply.set_text("승인");
                p.btnAply.set_fittocontents("width");
                p.btnAply.set_cssclass("btn_WF_SmallGray");
                p.btnAply.move("334.00","0","57","34",null,null);

                p.btnAplcfm.set_taborder("8");
            ...
            obj = new Layout("default","",0,0,this.divForm.form,
                ...
                p.divHstry.move("0","divGrd:20","100%","400",null,null);
            	}
            );
            obj.set_verticalgap("20");
            obj.set_type("vertical");
            ...
            obj = new Layout("default","Desktop_screen",1480,700,this,
                ...
                p.edtQrCode.set_value("29^SEC2411_00024^WAPWATCHBOX00002");
            ...
            obj = new BindItem("item1","divForm.form.divSch.form.cboChckpntId","value","dsSearch","chckpntId");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("CST014M01.xfdl","xjs::TaskCom.xjs");
        this.registerScript("CST014M01.xfdl", function() {
        /**
        *  인천국제공항공사 입주자 원스톱 서비스 프로젝트
        *  @FileName 	CST014M01.xfdl
        *  @Creator 	ELUON INS
        ...
        *******************************************************************************************************************************/
        ...
        this.fnSearch = function () {
        	var strSvcId    = "search";
        	var strSvcUrl   = "cst/sec/selectDgadsCmdtyCrynList.do";
        ...
        this.fnSave = function () {
        	var strSvcId    = "save";
        	var strSvcUrl   = "cst/sec/insertDgadsCmdtyCrynList.do";
        ...
        this.fnSaveDtl = function () {
        	var strSvcId    = "save";
        	var strSvcUrl   = "cst/sec/insertDgadsCmdtyCrynDtlList.do";
        ...
        this.fnAply = function () {
        	var strSvcId    = "aply";
        	var strSvcUrl   = "cst/sec/insertDgadsCmdtyCrynAply.do";
        	var inData      = "dsList=dsList:A";
        	var outData     = "";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        *******************************************************************************************************************************/
        ...
        this.divForm_divSch_btnSch_onclick = function(obj,e)
        {
        	...
        	if (this.gfnIsNull(this.dsSearch.getColumn(0, "chckpntId"))) {
        		...
        		this.gfnAlertMsg("msg2", "MSG_009", ["반입초소"]); /// {0} 을/를 입력해 주세요.
        		return false;
        	}
        ...
        this.dsList_oncolumnchanged = function(obj,e)
        {
        	...
        	if (e.columnid == "autoInptQty" || e.columnid == "mnlInptQty") {
        		...
        		const nThldQty   = nexacro.toNumber(obj.getColumn(e.row, "thldQty"), 0);
        		const nAllRegQty = nexacro.toNumber(obj.getColumn(e.row, "allRegQty"), 0);

        		obj.setColumn(e.row, "hstryCrynQty", nAutoQty + nMnlQty);
        		obj.setColumn(e.row, "errQty", -(nThldQty - (nAllRegQty + nAutoQty + nMnlQty)));
        	}
        };
        ...
        {
        	if (!this.gfnDsIsUpdated(this.dsList)) {
        		const nFindRow = this.dsList.findRowExpr("nexacro.toNumber(allRegQty, 0) != nexacro.toNumber(crynQty, 0)");
        		if (nFindRow == -1) {
        ...
        {
        	const nDelRows = this.dsList.extractRows("chk == 1");
        	if(nDelRows == -1 || nDelRows.length == 0){
        		this.gfnAlertMsg("msg7", "MSG_011", ["선택된 정보가 없습니다."]);
        		return false;
        	}

        	const nFindRow = this.dsList.findRowExpr("chk == 1 && nexacro.toNumber(crynQty, 0) > 0");
        	if (nFindRow > - 1) {
        		this.gfnAlertMsg("msg8", "MSG_011", ["승인된 물품은 삭제할 수 없습니다."]);
        		return false;
        	}

        	nDelRows.reverse().forEach(nRow => this.dsList.deleteRow(nRow));
        ...
        this.divForm_divHstry_btnHstryDel_onclick = function(obj,e)
        {
        	...
        	if(nDelRows == -1 || nDelRows.length == 0){
        		this.gfnAlertMsg("msg9", "MSG_011", ["선택된 정보가 없습니다."]);
        		return false;
        	}
        ...
        this.divForm_divHstry_btnHstrySave_onclick = function(obj,e)
        {
        	if (!this.gfnDsIsUpdated(this.dsDtlList)) {
        		this.gfnAlertMsg("msg10", "MSG_011", ["변경된 내역이 존재하지 않습니다."]);
        		return false;
        	}
        ...
        // 스캐너 이벤트 (임시)
        this.CST014M01_onkeyup = function(obj,e)
        {
        	/*
        	QR코드 생성규칙 확인필요!!!
        	*/
	...
	if (nFindRow == -1) {
        		this.gfnAlertMsg("msg11", "MSG_011", ["물품정보가 존재하지 않습니다."]);
         		return false;
        	}
        ...
        this.divForm_divGrd_btnAplcfm_onclick = function(obj,e)
        {
        	...
        	this.gfnOpenPopup("popDtl", "work::CST/SEC/CST014P02.xfdl", oArg, function (sPopupId, oRtn) {
        		if (this.gfnIsNull(oRtn)) return;
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onkeyup",this.CST014M01_onkeyup,this);
        ...
        this.loadIncludeScript("CST014M01.xfdl");
