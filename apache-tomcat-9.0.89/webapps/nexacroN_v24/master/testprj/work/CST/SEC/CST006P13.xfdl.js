(function()
{
    return function()
    {
        ...
        {
            this.set_name("CST006P13");
            this.set_titletext("위해물품유효성확인");
            ...
            obj = new Div("divSch","0","60",null,"175","60",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Div00");
            ...
            obj = new Panel("panLabel","20","14","96.56%","107",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("0");
            ...
            obj = new Panel("pan01","1694.00","398","340","40",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("2");
            obj.set_type("horizontal");
            ...
            obj = new Panel("pan06","710","135","320","1",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("7");
            obj.set_flexgrow("1");
            obj._setContents("<Contents/>");
            this.divSch.addChild(obj.name, obj);

            obj = new Panel("pan02","1694.00","398","300","1",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("3");
            obj.set_type("horizontal");
            obj.set_horizontalgap("10");
            obj.set_flexgrow("1");
            ...
            obj = new Panel("pan07","476","106","320","1",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("6");
            obj.set_type("horizontal");
            obj.set_horizontalgap("10");
            obj.set_flexgrow("1");
            ...
            obj = new Panel("pan01_00","860","30","340","40",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("9");
            obj.set_type("horizontal");
            obj.set_horizontalgap("10");
            obj.set_flexgrow("1");
            ...
            obj = new Panel("Panel00","863","76","340","1",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("18");
            obj.set_flexgrow("1");
            obj._setContents("");
            this.divSch.addChild(obj.name, obj);
            ...
            obj = new Panel("pan01_00_00","752.00","54","340","40",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("11");
            obj.set_type("horizontal");
            obj.set_horizontalgap("10");
            obj.set_flexgrow("1");
            ...
            obj = new Panel("pan01_00_01","860","30","340","40",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("13");
            obj.set_type("horizontal");
            obj.set_horizontalgap("10");
            obj.set_fittocontents("height");
            ...
            obj = new Panel("pan01_00_00_00","755.00","65","730","40",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("15");
            obj.set_type("horizontal");
            obj.set_horizontalgap("10");
            obj.set_flexgrow("2");
            ...
            obj = new Calendar("calScrtyDgadsCmdtyUseEndYmd","130.00","14","50%","40",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("17");
            ...
            obj = new Div("divGrd00","0","divPage:20",null,"400","60",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Div01");
            obj.set_fittocontents("height");
            obj.set_formscrollbartype("none none");
            ...
            obj = new Grid("grdDtlList","0","panGrdBtn:10","100.00%",null,null,"0",null,null,null,null,this.divGrd00.form);
            obj.set_taborder("0");
            ...
            obj = new Static("staTotal","0","0","330","34",null,null,null,null,null,null,this.divGrd00.form);
            obj.set_taborder("1");
            ...
            obj = new Layout("default","",0,0,this.divSch.form,
                ...
                p.panLabel.move("20","14","96.56%","107",null,null);
                ...
                p.edtCstrnPstnDtlInptCn.set_taborder("21");
                ...
                p.staLabel01_00_00.set_taborder("10");
                ...
                p.edtSprvsnCoNm.set_taborder("16");
                ...
                p.staLabel01_00_01.set_taborder("12");
                ...
                p.edtScrtyDgadsCmdtyUsePrpsCn.set_taborder("19");
                ...
                p.calScrtyDgadsCmdtyUseEndYmd.set_taborder("17");
            ...
            obj = new Layout("default","Desktop_screen",1280,700,this,
                ...
                p.divSch.move("0","60",null,"175","60",null);
                ...
                p.divGrd00.move("0","divPage:20",null,"400","60",null);
            ...
            obj = new Layout("mobile","Phone_screen",480,600,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.divSch.move("20","0",null,"127","20",null);
            ...
            obj = new BindItem("item0","divSch.form.calScrtyDgadsCmdtyUseEndYmd","value","dsSearch","scrtyDgadsCmdtyUseEndYmd");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divSch.form.edtSprvsnCoNm","value","dsSearch","sprvsnCoNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divSch.form.edtCstrnPstnDtlInptCn","value","dsSearch","cstrnPstnDtlInptCn");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divSch.form.edtMngPlcCn","value","dsSearch","mngPlcCn");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divSch.form.edtScrtyDgadsCmdtyUsePrpsCn","value","dsSearch","scrtyDgadsCmdtyUsePrpsCn");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("CST006P13.xfdl","xjs::TaskCom.xjs");
        this.registerScript("CST006P13.xfdl", function() {
        /**
        *  인천국제공항공사 입주자 원스톱 서비스 프로젝트
        *  @FileName 	CST006P13.xfdl
        *  @Creator 	ELUON INS
        ...
        *******************************************************************************************************************************/
        this.fnInit = function () {
        	this.dsSearch.setColumn(0, "scrtyDgadsCmdtyUseBgngYmd", "");
        	this.dsSearch.setColumn(0, "scrtyDgadsCmdtyUseEndYmd", this.fvCurDate);
        	this.dsSearch.setColumn(0, "type", "vld"); // 유효성
        ...
        *******************************************************************************************************************************/
        ...
        {
        	this.gfn_excelExport(this.divGrd.form.grdMstList, "위해물품유효성확인", "위해물품유효성확인");
        };
        ...
        this.loadIncludeScript("CST006P13.xfdl");
