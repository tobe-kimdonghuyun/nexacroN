(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("위해물품반출목록(집계)");
        ...
        // User Script
        this.addIncludeScript("CST014M04.xfdl","xjs::TaskCom.xjs");
        this.registerScript("CST014M04.xfdl", function() {
        /**
        *  인천국제공항공사 입주자 원스톱 서비스 프로젝트
        *  @FileName 	CST014M04.xfdl
        *  @Creator 	ELUON INS
        ...
        *******************************************************************************************************************************/
        this.fnSearch = function () {
        	var strSvcId    = "search";
        	var strSvcUrl   = "cst/sec/selectDgadsCmdtyShpgotTotList.do";
        ...
        *******************************************************************************************************************************/
        ...
        this.divForm_divGrd_grdList_oncellclick = function(obj,e)
        {
        	...
        	this.gfnOpenPopup("plcSch", "work::CST/SEC/CST014P03.xfdl", objArg, sPopupCallBack, objOption);
        };
        ...
        this.loadIncludeScript("CST014M04.xfdl");
