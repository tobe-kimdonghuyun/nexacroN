(function()
{
    return function()
    {
        ...
        {
            this.set_name("CST011P19");
            this.set_titletext("위해물품보관목록조회");
            ...
            obj = new Panel("Panelblank","784.00","48","340","1",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("17");
            obj.set_flexgrow("1");
            obj.set_fittocontents("height");
            obj.set_horizontalgap("10");
            ...
            obj = new Calendar("calScrtyDgadsCmdtyUseEndYmd","170","25","50%","40",null,null,null,null,null,null,this.divSch.form);
            obj.set_taborder("21");
            ...
            obj = new Button("Button00","1106","6","124","34",null,null,null,null,null,null,this.divGrd.form);
            obj.set_taborder("5");
            ...
            obj = new Layout("default","",0,0,this.divSch.form,
                ...
                p.edtCstrnPstnDtlInptCn.set_taborder("20");
                p.edtCstrnPstnDtlInptCn.move("1024","31","100%","40",null,null);

                p.Panelblank.set_taborder("17");
                p.Panelblank.set_flexgrow("1");
                p.Panelblank.set_fittocontents("height");
                p.Panelblank.set_horizontalgap("10");
                p.Panelblank.move("784.00","48","340","1",null,null);
                ...
                p.edtScrtyDgadsCmdtyUsePrpsCn.set_taborder("18");
                ...
                p.calScrtyDgadsCmdtyUseEndYmd.set_taborder("21");
                p.calScrtyDgadsCmdtyUseEndYmd.set_readonly("true");
                p.calScrtyDgadsCmdtyUseEndYmd.move("170","25","50%","40",null,null);
            	}
            );
        ...
        // User Script
        this.addIncludeScript("CST011P19.xfdl","xjs::TaskCom.xjs");
        this.registerScript("CST011P19.xfdl", function() {
        /**
        ...
        *******************************************************************************************************************************/
        this.fnInit = function () {
        	...
        	this.dsSearch.setColumn(0, "type", "con");
        ...
        *******************************************************************************************************************************/
        ...
        {
        	this.gfn_excelExport(this.divGrd.form.grdMstList, "위해물품보관목록조회", "위해물품보관목록조회");
        };
        });
        ...
        this.loadIncludeScript("CST011P19.xfdl");
