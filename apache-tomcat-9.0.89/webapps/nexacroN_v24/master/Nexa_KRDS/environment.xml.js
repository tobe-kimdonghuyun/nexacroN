if (nexacro.Environment)
{
    ...
    env.on_init = function ()
    {
        ...
        this.set_userfontid("font::PretendardGOV.xfont");
        ...
        this.set_scrollindicatorsize("1");
        this.set_icon("url(\'theme::NexaKRDS/images/UXPro_KRDS01.png\')");
    };
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("svcUrl", "JSP", "http://localhost:9093/", "none", null, "", "0", "0");
