(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("StaDt00","40","40","90","48",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("조회구분");
            ...
            obj = new Radio("Radio00","StaDt00:0","40","180","48",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            ...
            obj = new Edit("Edit00","Radio00:16","40","160","48",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_accessibilitylabel("[@StaDt00]");
            this.divSearch.addChild(obj.name, obj);

            obj = new Panel("Panel00","40","40","405","48",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_flexgrow("1");
            ...
            obj = new Button("btnSearch","560","40","120","48",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("조회");
            obj.set_cssclass("btn_WF_Sch");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staTitle","40","divSearch:28",null,"38","200",null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Grid("grdMain","40","staTitle:10",null,"313","40",null,null,null,null,null,this);
            obj.set_taborder("2");
