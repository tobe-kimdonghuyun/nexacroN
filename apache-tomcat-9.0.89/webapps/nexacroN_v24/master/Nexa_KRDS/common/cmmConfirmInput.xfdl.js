(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("0");
            obj.set_image("url(\'theme::NexaKRDS/images/img_WF_Valid.png\')");
            obj.set_text("");
            ...
            obj = new TextArea("txtMsgContent","40","Static00:16",null,"142","40",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_readonly("true");
            obj.set_cssclass("txt_POP_Text");
            this.addChild(obj.name, obj);

            obj = new Edit("edtInput","40",null,"480","48",null,"108",null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_displaynulltext("입력해주세요.");
            this.addChild(obj.name, obj);

            obj = new Button("btnOk",null,null,"90","48","236","40",null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("확인");
            obj.set_cssclass("btn_WF_Crud");
            this.addChild(obj.name, obj);

            obj = new Button("btnCancel",null,null,"90","48","138","40",null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("취소");
            this.addChild(obj.name, obj);

            obj = new Button("btnExtend",null,null,"90","48","40","40",null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("취소");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Panel("Panel00","40","312",null,"48","40",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_flexmainaxisalign("end");
            obj.set_horizontalgap("8");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"btnOk\"/><PanelItem id=\"PanelItem01\" componentid=\"btnCancel\"/><PanelItem id=\"PanelItem02\" componentid=\"btnExtend\"/></Contents>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.registerScript("cmmConfirmInput.xfdl", function() {
        /**
        *  devPro
        ...
        */
        this.btnOk_onclick = function(obj,e)
        {
        	...
        	if (!this.gfnIsNull(this.fvArrButton))
        	{
        		...
        		if(this.gfnIsNull(this.edtInput.value))
        		{
        			this.edtInput.set_cssclass("error");
        			this.edtInput.set_displaynulltext("필수 입력입니다.");
        			return;
        		}
        		this.close(this.edtInput.value);
        	}
        };
        ...
        */
        ...
        this.loadIncludeScript("cmmConfirmInput.xfdl");
