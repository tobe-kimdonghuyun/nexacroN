(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",500,495,this,function(p){});
        ...
        // User Script
        this.registerScript("cmmUtilView2.xfdl", function() {
        /**
        *  KRDS
        ...
        *******************************************************************************************************************************/
        ...
        this.Radio00_onitemchanged = function(obj,e)
        {
        	switch(e.postvalue) {
        		case "0":
        			...
        			//var objFrame = this.objApp.gvFrmMain;
        			//nexacro.setWheelZoom( objFrame, 90 );
        			this.fvZoom = 0.9;
        			break;
        		case "1":
        			document.body.style.zoom = 1;
        			//var objFrame = this.objApp.gvFrmMain;
        			//nexacro.setWheelZoom( objFrame, 100 );
        			this.fvZoom = 1;
        			break;
        		case "2":
        		    document.body.style.zoom = 1.1;
        			//var objFrame = this.objApp.gvFrmMain;
        			//nexacro.setWheelZoom( objFrame, 110 );
        			this.fvZoom = 1.1;
        			break;
        		case "3":
        		    document.body.style.zoom = 1.2;
        			//var objFrame = this.objApp.gvFrmMain;
        			//nexacro.setWheelZoom( objFrame, 120 );
        			this.fvZoom = 1.2;
        			break;
        		case "4":
        		    document.body.style.zoom = 1.3;
        			//var objFrame = this.objApp.gvFrmMain;
        			//nexacro.setWheelZoom( objFrame, 130 );
        			this.fvZoom = 1.3;
        			break;
        		default:
        	}
        ...
        this.loadIncludeScript("cmmUtilView2.xfdl");
