(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static00","0","0",null,"500","0",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_cssclass("sta_WF_Detailbox");
            this.addChild(obj.name, obj);

            obj = new Div("divFind","40","40",null,"352","40",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("div00");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTitle00","0","0","108","48",null,null,null,null,null,null,this.divFind.form);
            obj.set_taborder("4");
            obj.set_text("대상컬럼");
            obj.set_cssclass("sta_WF_SchDetail");
            this.divFind.addChild(obj.name, obj);

            obj = new Static("staTitle01","0","staTitle00:16","108","48",null,null,null,null,null,null,this.divFind.form);
            obj.set_taborder("5");
            obj.set_text("찾을 문자열");
            obj.set_cssclass("sta_WF_SchDetail");
            this.divFind.addChild(obj.name, obj);

            obj = new Static("staTitle02","0","staTitle01:16","108","48",null,null,null,null,null,null,this.divFind.form);
            obj.set_taborder("6");
            obj.set_text("찾을 방향");
            obj.set_cssclass("sta_WF_SchDetail");
            this.divFind.addChild(obj.name, obj);

            obj = new Static("staTitle03","0","staTitle02:16","108","48",null,null,null,null,null,null,this.divFind.form);
            obj.set_taborder("7");
            obj.set_text("찾을 위치");
            obj.set_cssclass("sta_WF_SchDetail");
            this.divFind.addChild(obj.name, obj);

            obj = new Static("staTitle05","0","staTitle03:16","108","94",null,null,null,null,null,null,this.divFind.form);
            obj.set_taborder("8");
            obj.set_text("찾을 조건");
            obj.set_cssclass("sta_WF_SchDetail");
            this.divFind.addChild(obj.name, obj);

            obj = new Combo("cboColumn","staTitle00:4","5",null,"48","4",null,null,null,null,null,this.divFind.form);
            obj.set_taborder("9");
            ...
            obj = new Edit("edtFindTxt","staTitle01:4","cboColumn:16",null,"48","4",null,null,null,null,null,this.divFind.form);
            obj.set_taborder("10");
            this.divFind.addChild(obj.name, obj);

            obj = new Radio("rdoDirection","staTitle02:4","edtFindTxt:16",null,"48","4",null,null,null,null,null,this.divFind.form);
            obj.set_taborder("11");
            ...
            divFind_form_rdoDirection_innerdataset._setContents({"ColumnInfo" : {"Column" : [ {"id" : "codecolumn","size" : "256"},{"id" : "datacolumn","size" : "256"}]},"Rows" : [{"codecolumn" : "prev","datacolumn" : "이전"},{"codecolumn" : "next","datacolumn" : "다음"}]});
            ...
            obj = new Radio("rdoPosition","staTitle03:4","rdoDirection:24",null,"30","4",null,null,null,null,null,this.divFind.form);
            obj.set_taborder("12");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_direction("vertical");
            var divFind_form_rdoPosition_innerdataset = new nexacro.NormalDataset("divFind_form_rdoPosition_innerdataset", obj);
            divFind_form_rdoPosition_innerdataset._setContents({"ColumnInfo" : {"Column" : [ {"id" : "codecolumn","size" : "256"},{"id" : "datacolumn","size" : "256"}]},"Rows" : [{"codecolumn" : "current","datacolumn" : "현재위치"},{"codecolumn" : "first","datacolumn" : "처음부터"}]});
            ...
            obj = new Radio("rdoCondition","staTitle05:4","rdoPosition:8",null,"30","4",null,null,null,null,null,this.divFind.form);
            obj.set_taborder("13");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_direction("vertical");
            var divFind_form_rdoCondition_innerdataset = new nexacro.NormalDataset("divFind_form_rdoCondition_innerdataset", obj);
            divFind_form_rdoCondition_innerdataset._setContents({"ColumnInfo" : {"Column" : [ {"id" : "codecolumn","size" : "256"},{"id" : "datacolumn","size" : "256"}]},"Rows" : [{"codecolumn" : "equal","datacolumn" : "일치"},{"codecolumn" : "inclusion","datacolumn" : "포함"}]});
            ...
            obj = new CheckBox("chkGubun","staTitle05:4","rdoCondition:10","138","40",null,null,null,null,null,null,this.divFind.form);
            obj.set_taborder("14");
            obj.set_text("대/소문자 구분");
            this.divFind.addChild(obj.name, obj);

            obj = new Button("btnCancel",null,"412","90","48","40",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("취소");
            ...
            obj = new Button("btnFind",null,"412","90","48","146",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("찾기");
            obj.set_fittocontents("width");
            this.addChild(obj.name, obj);
            ...
            //-- Default Layout : this
            obj = new Layout("default","",560,500,this,function(p){});
