(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(140,48);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("dsYear", this);
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "year","type" : "INT","size" : "4"}]}});
            this.addChild(obj.name, obj);


            obj = new Dataset("dsMonth", this);
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "month","type" : "STRING","size" : "256"}]},"Rows" : [{"month" : "01"},{"month" : "02"},{"month" : "03"},{"month" : "04"},{"month" : "05"},{"month" : "06"},{"month" : "07"},{"month" : "08"},{"month" : "09"},{"month" : "10"},{"month" : "11"},{"month" : "12"}]});
            this.addChild(obj.name, obj);


            obj = new Dataset("dsCal", this);
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "d0","type" : "STRING","size" : "10"},{"id" : "d1","type" : "STRING","size" : "10"},{"id" : "d2","type" : "STRING","size" : "10"},{"id" : "d3","type" : "STRING","size" : "10"},{"id" : "d4","type" : "STRING","size" : "10"},{"id" : "d5","type" : "STRING","size" : "10"},{"id" : "d6","type" : "STRING","size" : "10"},{"id" : "d7","type" : "STRING","size" : "10"},{"id" : "css0","type" : "STRING","size" : "256"},{"id" : "css1","type" : "STRING","size" : "256"},{"id" : "css2","type" : "STRING","size" : "256"},{"id" : "css3","type" : "STRING","size" : "256"},{"id" : "css4","type" : "STRING","size" : "256"},{"id" : "css5","type" : "STRING","size" : "256"},{"id" : "css6","type" : "STRING","size" : "256"},{"id" : "css7","type" : "STRING","size" : "256"}]}});
            this.addChild(obj.name, obj);
            ...
            obj = new PopupDiv("pdivCal","2","80","234","302",null,null,null,null,null,null,this);
            obj.set_text("pdiv00");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",140,48,this,function(p){});
