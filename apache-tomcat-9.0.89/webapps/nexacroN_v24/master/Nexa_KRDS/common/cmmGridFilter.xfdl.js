(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnFilterCancel",null,"22","90","48","152",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("필터취소");
            obj.set_fittocontents("width");
            this.addChild(obj.name, obj);

            obj = new Button("btnUp",null,"22","48","48","96",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_cssclass("btn_WF_Up");
            this.addChild(obj.name, obj);

            obj = new Button("btnDown",null,"22","48","48","40",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_cssclass("btn_WF_Down");
            this.addChild(obj.name, obj);

            obj = new Grid("grdFilterList","40","btnFilterCancel:10",null,"300","40",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_binddataset("dsFilter");
            obj.set_autofittype("col");
            obj.getSetter("griduserproperty").set("!sort,!rowfix,!colfix,!filter,!initial");
            obj.set_autoenter("select");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"175\"/><Column size=\"180\"/><Column size=\"190\"/></Columns><Rows><Row size=\"39\" band=\"head\"/><Row size=\"57\"/></Rows><Band id=\"head\"><Cell text=\"컬럼명\" expandchar=\"popup.columnname\"/><Cell col=\"1\" text=\"필터기준\" expandchar=\"popup.filtercriteria\"/><Cell col=\"2\" text=\"찾을조건\" expandchar=\"popup.findcondition\"/></Band><Band id=\"body\"><Cell text=\"bind:title\" displaytype=\"text\" edittype=\"none\" combodataset=\"dsFilterCol\" combodatacol=\"columnName\" combocodecol=\"columnId\"/><Cell col=\"1\" displaytype=\"combocontrol\" edittype=\"combo\" combodataset=\"dsFilterType\" combodatacol=\"name\" combocodecol=\"code\" text=\"bind:filtertype\"/><Cell col=\"2\" text=\"bind:filtervalue\" displaytype=\"editcontrol\" edittype=\"text\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("btnSetFilter","210",null,"90","48",null,"40",null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("확인");
            obj.set_fittocontents("width");
            this.addChild(obj.name, obj);

            obj = new Button("btnClose","btnSetFilter:8",null,"90","48",null,"40",null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("취소");
            obj.set_fittocontents("width");
