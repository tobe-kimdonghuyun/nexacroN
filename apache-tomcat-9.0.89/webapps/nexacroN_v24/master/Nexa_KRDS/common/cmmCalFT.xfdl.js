(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Calendar("calFrom","0","0","47.22222222222222%",null,null,"0",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_popuptype("none");
            this.addChild(obj.name, obj);

            obj = new Static("staTerm","calFrom:4","0","17",null,null,"0",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("~");
            ...
            obj = new PopupDiv("pdivCal","3","115","776","524",null,null,null,null,null,null,this);
            obj.set_text("pdiv00");
            ...
            obj = new Calendar("calFromM","0","5","384",null,null,"80",null,null,null,null,this.pdivCal.form);
            obj.set_taborder("1");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_type("monthonly");
            this.pdivCal.addChild(obj.name, obj);

            obj = new Calendar("calToM","calFromM:5","5","384",null,null,"80",null,null,null,null,this.pdivCal.form);
            obj.set_taborder("2");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_type("monthonly");
            this.pdivCal.addChild(obj.name, obj);

            obj = new Button("btnCancle",null,null,"90","48","40","5",null,null,null,null,this.pdivCal.form);
            obj.set_taborder("4");
            obj.set_text("취소");
            obj.set_cssclass("btn_WF_Crud");
            this.pdivCal.addChild(obj.name, obj);

            obj = new Button("btnOk",null,null,"90","48","btnCancle:8","5",null,null,null,null,this.pdivCal.form);
            obj.set_taborder("3");
            obj.set_text("확인");
            this.pdivCal.addChild(obj.name, obj);

            obj = new Static("staMsg","0","194",null,"60","0",null,null,null,null,null,this.pdivCal.form);
            obj.set_taborder("5");
            obj.set_text("sta00");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",360,48,this,function(p){});
