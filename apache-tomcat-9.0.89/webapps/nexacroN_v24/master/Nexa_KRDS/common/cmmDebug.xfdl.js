(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01","40","56",null,"36","208",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("디버그");
            ...
            obj = new Div("divSearch","40","108",null,"240","40",null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Static("staTitle00","40","40","98","48",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("LOCAL");
            obj.set_cssclass("sta_WF_SchDetail");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboDataset","staTitle00:0","40","320","48",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            ...
            obj = new Button("btnLocalFilter","cboDataset:8","40","90","48",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("필터해제");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtLocal","btnLocalFilter:8","40",null,"48","40",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_accessibilitylabel("[@staTitle00]");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staTitle01","40","staTitle00:8","98","48",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("GLOBAL");
            obj.set_cssclass("sta_WF_SchDetail");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboGDS","staTitle01:0","cboDataset:8","320","48",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            ...
            obj = new Button("cbtnGlobalFilter","cboGDS:8","cboDataset:8","90","48",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("필터해제");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtGlobal","cbtnGlobalFilter:8","cboDataset:8",null,"48","40",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_accessibilitylabel("[@staTitle01]");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staTitle02","40","staTitle01:8","98","48",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("GRID");
            obj.set_cssclass("sta_WF_SchDetail");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboGrid","138","edtGlobal:8",null,"48","40",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            ...
            obj = new Tab("tabComponent","40","divSearch:40",null,null,"40","40",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_tabindex("0");
            ...
            obj = new Button("btnSaveExcel",null,"12","110","48","128",null,null,null,null,null,this.tabComponent.tabpage1.form);
            obj.set_taborder("0");
            obj.set_text("Excel 저장");
            this.tabComponent.tabpage1.addChild(obj.name, obj);

            obj = new Button("btnCreatSQL",null,"12","104","48","16",null,null,null,null,null,this.tabComponent.tabpage1.form);
            obj.set_taborder("1");
            obj.set_text("SQL 생성");
            this.tabComponent.tabpage1.addChild(obj.name, obj);

            obj = new Grid("grdDataset","24","70",null,null,"24","0",null,null,null,null,this.tabComponent.tabpage1.form);
            obj.set_taborder("2");
            ...
            obj = new TextArea("txtSaveXML","16","16",null,null,"16","16",null,null,null,null,this.tabComponent.tabpage2.form);
            obj.set_taborder("0");
            ...
            obj = new TextArea("txtSetGrid","16","16",null,null,"16","16",null,null,null,null,this.tabComponent.tabpage3.form);
            obj.set_taborder("0");
            ...
            obj = new TextArea("txtGridFormat","16","16",null,null,"16","16",null,null,null,null,this.tabComponent.tabpage4.form);
            obj.set_taborder("0");
            ...
            obj = new Grid("grdProperties00","16","16","50%",null,null,"16",null,null,null,null,this.tabComponent.tabpage5.form);
            obj.set_taborder("0");
            obj.getSetter("useinputpanel").set("false");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"162\"/><Column size=\"105\"/><Column size=\"51\"/><Column size=\"55\"/><Column size=\"48\"/></Columns><Rows><Row size=\"39\" band=\"head\"/><Row size=\"57\"/></Rows><Band id=\"head\"><Cell text=\"PATH\"/><Cell col=\"1\" text=\"NAME\"/><Cell col=\"2\" text=\"taborder\"/><Cell col=\"3\" text=\"access\"/><Cell col=\"4\" text=\"visible\"/></Band><Band id=\"body\"><Cell text=\"bind:PATH\" textAlign=\"left\"/><Cell col=\"1\" text=\"bind:NAME\" textAlign=\"left\"/><Cell col=\"2\" text=\"bind:taborder\"/><Cell col=\"3\" text=\"bind:accessibilityenable\"/><Cell col=\"4\" text=\"bind:visible\"/></Band></Format></Formats>");
            this.tabComponent.tabpage5.addChild(obj.name, obj);

            obj = new Grid("grdProperties","grdProperties00:5","16","277",null,null,"16",null,null,null,null,this.tabComponent.tabpage5.form);
            obj.set_taborder("1");
            obj.getSetter("useinputpanel").set("false");
            ...
            obj.set_autofittype("col");
            obj.set_selecttype("row");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"178\"/><Column size=\"186\"/></Columns><Rows><Row size=\"39\" band=\"head\"/><Row size=\"57\"/></Rows><Band id=\"head\"><Cell text=\"Properties Name\"/><Cell col=\"1\" text=\"Value\"/></Band><Band id=\"body\"><Cell style=\"align:left;\" text=\"bind:NAME\" textAlign=\"left\"/><Cell col=\"1\" edittype=\"normal\" style=\"align:left;\" text=\"bind:VALUE\" textAlign=\"left\"/></Band></Format></Formats>");
            this.tabComponent.tabpage5.addChild(obj.name, obj);

            obj = new TextArea("txtScript","grdProperties:16","16",null,null,"16","16",null,null,null,null,this.tabComponent.tabpage5.form);
            obj.set_taborder("2");
            this.tabComponent.tabpage5.addChild(obj.name, obj);
            ...
            obj = new Static("StaVtype","16","16","130","48",null,null,null,null,null,null,this.tabComponent.tabpage6.form);
            obj.set_text("Variable Type");
            obj.set_taborder("0");
            obj.set_cssclass("sta_WF_SchDetail");
            this.tabComponent.tabpage6.addChild(obj.name, obj);

            obj = new Combo("cboVariable","StaVtype:0","16","200","48",null,null,null,null,null,null,this.tabComponent.tabpage6.form);
            obj.set_taborder("1");
            obj.set_innerdataset("dsVariableType");
            obj.set_codecolumn("CODE");
            obj.set_datacolumn("NAME");
            obj.set_accessibilitylabel("[@StaVtype]");
            obj.set_text("Form");
            obj.set_value("FORM");
            obj.set_index("0");
            this.tabComponent.tabpage6.addChild(obj.name, obj);

            obj = new Grid("grdVariable","16","cboVariable:10",null,null,"16","16",null,null,null,null,this.tabComponent.tabpage6.form);
            obj.set_taborder("2");
            obj.getSetter("useinputpanel").set("false");
            ...
            obj = new Button("btnRunScript",null,"16","120","48","16",null,null,null,null,null,this.tabComponent.tabpage7.form);
            obj.set_taborder("0");
            obj.set_text("Run Script");
            this.tabComponent.tabpage7.addChild(obj.name, obj);

            obj = new TextArea("txtScript","16","btnRunScript:16",null,"145","16",null,null,null,null,null,this.tabComponent.tabpage7.form);
            obj.set_taborder("1");
            obj.set_value("//디버그 실행 예제\n//alert(this.opener.dsList.saveXML());\n//return this.opener.dsList.saveXML();");
            this.tabComponent.tabpage7.addChild(obj.name, obj);

            obj = new TextArea("txtResult","16","txtScript:16",null,null,"16","16",null,null,null,null,this.tabComponent.tabpage7.form);
            obj.set_taborder("2");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",888,900,this,function(p){});
        ...
        */
        this.fnMakeDatasetGrid = function()
        {
            ...
            if( this.fvCurrentCombo == "cboDataset" )
            {
        		...
        		dataset = this.opener[this.divSearch.form.cboDataset.value];
            }
            else
            {
        ...
        */
        this.fnMakeGridFormats = function()
        {
        	...
        	var targetgrid = this.opener[this.divSearch.form.cboGrid.value];
        ...
        */
        this.fnMakeCompoentsData = function()
        {
        	...
        	var targetobj = this.opener[sCompName];
        ...
        */
        this.fnExecScript = function(obj,  e)
        {
            try
            {
        		var sVal = this.tabComponent.tabpage7.form.txtScript.text;
        		var func = new Function(sVal);
        ...
        */
        ...
        {
        	var dataset = this.opener[this.divSearch.form.cboDataset.value];
            dataset.filter("");
        };
        /**
        ...
        */
        ...
        this.divSearch_btnLocalFilter_onclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.btnLocalFilter.addEventHandler("onclick",this.divSearch_btnLocalFilter_onclick,this);
