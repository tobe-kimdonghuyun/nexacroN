(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(248,48);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("dsCombo", this);
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "chk","type" : "STRING","size" : "256"},{"id" : "code","type" : "STRING","size" : "256"},{"id" : "value","type" : "STRING","size" : "256"}]}});
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Button("btnCbo",null,"0","48",null,"0","0",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_cssclass("btn_WF_Down");
            this.addChild(obj.name, obj);

            obj = new Edit("edtCbo","0","0",null,null,"btnCbo:8","0",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_displaynulltext("선택하세요");
            obj.set_readonly("true");
            this.addChild(obj.name, obj);

            obj = new PopupDiv("pdvCbo","0","68",null,"360","0",null,null,null,null,null,this);
            obj.set_text("pdiv00");
            ...
            obj = new Grid("grdMultiCombo","0","0",null,null,"0","58",null,null,null,null,this.pdvCbo.form);
            obj.set_taborder("1");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"39\" band=\"head\"/><Row size=\"57\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" autosizecol=\"limitmax\" text=\"0\"/><Cell col=\"1\" text=\"code\"/><Cell col=\"2\" text=\"value\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" autosizecol=\"limitmax\" text=\"bind:chk\"/><Cell col=\"1\" text=\"bind:code\"/><Cell col=\"2\" text=\"bind:value\"/></Band></Format></Formats>");
            this.pdvCbo.addChild(obj.name, obj);

            obj = new Button("btnOk","0",null,null,"48","0","0",null,null,null,null,this.pdvCbo.form);
            obj.set_taborder("2");
            obj.set_text("확인");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",248,48,this,function(p){});
