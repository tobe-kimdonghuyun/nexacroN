(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static00","40","56",null,"36","40",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("타이틀");
            obj.set_cssclass("sta_WF_H4");
            this.addChild(obj.name, obj);

            obj = new TextArea("TextArea00","40","108",null,"142","40",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Static("Static02","23","420","467","60",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("모달의 최대 높이는 화면 높이 기준 20% 여백을 가져야 한다.");
            this.addChild(obj.name, obj);

            obj = new Static("Static03","16","486","1320","578",null,null,null,null,null,null,this);
            obj.set_taborder("7");
        ...
        // User Script
        this.registerScript("cmmMadal_PC00.xfdl", function() {
        ...
        this.loadIncludeScript("cmmMadal_PC00.xfdl");
