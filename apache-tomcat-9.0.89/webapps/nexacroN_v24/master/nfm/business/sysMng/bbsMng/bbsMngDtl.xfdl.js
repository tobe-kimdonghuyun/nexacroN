(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(1050,450);
            }
            ...
            obj = new Div("divContents","0","Static01_00_00:12",null,"336","0",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_cssclass("div_DA");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("StaDuyTpcd","0","0","160","37",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("2");
            obj.set_text("시스템");
            ...
            obj = new Static("StaBbrssId","0","37","160","37",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("3");
            obj.set_text("게시판 ID");
            obj.set_cssclass("sta_DA_label_L");
            obj.set_textAlign("center");
            ...
            obj = new Static("StaBbrssTpeCd","0","74","160","37",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("6");
            ...
            obj = new Static("staBbrssNm","0","111","160","37",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("7");
            ...
            obj = new Static("Static10","0","148",null,"74","0",null,null,null,null,null,this.divContents.form);
            obj.set_taborder("8");
            obj.set_cssclass("sta_DA_rowAll");
            this.divContents.addChild(obj.name, obj);

            obj = new Static("staBbrssIntrdCont","0","148","160","74",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("9");
            ...
            obj = new Edit("duyTpcd","StaDuyTpcd:0","4",null,"28","20",null,null,null,null,null,this.divContents.form);
            obj.set_taborder("0");
            obj.set_readonly("true");
            obj.set_cssclass("display");
            obj.set_value("MRV");
            obj.set_displaynulltext("MRV");
            obj.set_text("MRV");
            this.divContents.addChild(obj.name, obj);

            obj = new Edit("bbsId","StaBbrssId:0","41",null,"28","20",null,null,null,null,null,this.divContents.form);
            obj.set_taborder("1");
            obj.set_cssclass("display");
            obj.set_readonly("true");
            this.divContents.addChild(obj.name, obj);

            obj = new Edit("bbsNm","staBbrssNm:10","115",null,"28","10",null,null,null,null,null,this.divContents.form);
            obj.set_taborder("4");
            obj.set_text("N");
            this.divContents.addChild(obj.name, obj);

            obj = new TextArea("bbsIntrdCn","staBbrssIntrdCont:10","152",null,"66","10",null,null,null,null,null,this.divContents.form);
            obj.set_taborder("5");
            this.divContents.addChild(obj.name, obj);

            obj = new Static("StaUseYn","0","222","160","37",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("10");
            ...
            obj = new Static("StaAnsrTchncUsgYn","0","259","160","37",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("11");
            ...
            obj = new Static("StaSecrtSntnTchncUsgYn","350","259","160","37",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("12");
            ...
            obj = new Radio("useYn","StaUseYn:10","227","135","28",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("13");
            ...
            obj = new Radio("ansUseYn","StaAnsrTchncUsgYn:10","264","135","28",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("14");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_rowcount("1");
            ...
            obj = new Radio("secrtSntnSkillUseYn","StaSecrtSntnTchncUsgYn:10","264","135","28",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("15");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_rowcount("1");
            ...
            obj = new MaskEdit("atchPsbltyFileNo","520","300","88","28",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("16");
            obj.set_format("###,###");
            this.divContents.addChild(obj.name, obj);

            obj = new Static("StrBbrssNticEstbsCnt00","atchPsbltyFileNo:7","301","33","28",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("17");
            obj.set_text("개");
            this.divContents.addChild(obj.name, obj);

            obj = new Static("StaAttchFilePssblYn","0","296","160","37",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("18");
            ...
            obj = new Static("StaAttchFilePssblYn00","350","296","160","37",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("20");
            ...
            obj = new Static("StaAttchFilePssblYn00_00","680","296","160","37",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("21");
            ...
            obj = new MaskEdit("atchPsbltyFileSz","850","300","90","28",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("22");
            obj.set_format("###,###");
            this.divContents.addChild(obj.name, obj);

            obj = new Radio("atchFileUseYn","StaAttchFilePssblYn:10","300","135","28",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("19");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_rowcount("1");
            var divContents_form_atchFileUseYn_innerdataset = new nexacro.NormalDataset("divContents_form_atchFileUseYn_innerdataset", obj);
            divContents_form_atchFileUseYn_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">Y</Col><Col id=\"datacolumn\">사용</Col></Row><Row><Col id=\"codecolumn\">N</Col><Col id=\"datacolumn\">미사용</Col></Row></Rows>");
            obj.set_innerdataset(divContents_form_atchFileUseYn_innerdataset);
            obj.set_text("");
            obj.set_index("-1");
            this.divContents.addChild(obj.name, obj);

            obj = new Button("btnDel",null,"divContents:20","78","32","4",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("삭제");
            obj.set_cssclass("btn_WF_common05");
            this.addChild(obj.name, obj);

            obj = new Button("btnSave",null,"divContents:20","78","32","btnDel:6",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("저장");
            obj.set_cssclass("btn_WF_common01");
            this.addChild(obj.name, obj);

            obj = new Radio("bbsTypeCd","170","133","462","28",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_rowcount("1");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",1050,450,this,function(p){});
            ...
            obj = new BindItem("item10","divContents.form.atchPsbltyFileNo","value","dsList","atchPsbltyFileNo");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item13","divContents.form.atchFileUseYn","value","dsList","atchFileUseYn");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item21","divContents.form.atchPsbltyFileSz","value","dsList","atchPsbltyFileSz");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("bbsMngDtl.xfdl", function() {
        /**
        *  게시판관리 상세
        ...
        * FORM EVENT 영역(onload)
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	const param = this.gfnGetMdiRootDiv() ? this.gfnGetMdiRootDiv().arguments.menuParam : this.getOwnerFrame();
        	this.dsSearch.setColumn(0,"bbsId",param.bbsId);
        ...
        */
        ...
        {
        	var strSvcId    = "save";
        	var strSvcUrl   = "/cmmnn/sysMng/bbsMng/updateBbsMng.do";
        ...
        */
        ...
        {
        	var strSvcId    = "delete";
        	var strSvcUrl   = "/cmmnn/sysMng/bbsMng/deleteBBSMng.do";
        	var inData      = "dsList=dsList";
        	var outData     = "";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        */
        ...
        this.btnDel_onclick = function(obj,e)
        {
        	...
        	if (this.dsList.getColumn(0, 'regSntnCnt') != 0)
        	{
        ...
        this.divContents_bbrssTpeCd_onitemchanged = function(obj,e)
        {
        ...
        this.loadIncludeScript("bbsMngDtl.xfdl");
