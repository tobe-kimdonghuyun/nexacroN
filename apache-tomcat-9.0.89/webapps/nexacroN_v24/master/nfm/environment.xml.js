if (nexacro.Environment)
{
    ...
    env.on_init = function ()
    {
        ...
        this.set_initvaluefileid("initvalue::nfm.xiv");
        this.set_icon("url(\'theme://images/favicon.png\')");
        this.set_loadingimage("url(\'imagerc::work/loading.gif\')");
        this.set_scrollbarsize("9");
    };
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("svcUrl", "JSP", "http://localhost:8084/", "none", null, "", "0", "0");
        nexacro._addService("devPackLib", "file", "./nexacrolib/component/DevPackLib/", "none", null, "", "0", "0");
        ...
        nexacro._addService("common", "form", "./common/", "none", null, "", "0", "0");
        nexacro._addService("business", "form", "./business/", "none", null, "", "0", "0");
