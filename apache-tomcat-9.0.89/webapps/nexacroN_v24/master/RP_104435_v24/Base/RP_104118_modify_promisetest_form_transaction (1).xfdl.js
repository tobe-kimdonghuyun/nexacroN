(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("RP_104118_modify_promisetest_form_transaction (1).xfdl", function() {
        ...
        this.loadIncludeScript("RP_104118_modify_promisetest_form_transaction (1).xfdl");
