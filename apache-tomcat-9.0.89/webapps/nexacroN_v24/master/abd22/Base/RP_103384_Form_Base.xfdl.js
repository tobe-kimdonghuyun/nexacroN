(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grdMain00_00","33","504",null,"246","170",null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new Layout("default","desktopScr,Desktop_screen",1280,1360,this,
                ...
                p.grdMain00_00.move("33","504",null,"246","170",null);
        ...
        // User Script
        this.registerScript("RP_103384_Form_Base.xfdl", function() {
        ...
        this.loadIncludeScript("RP_103384_Form_Base.xfdl");
