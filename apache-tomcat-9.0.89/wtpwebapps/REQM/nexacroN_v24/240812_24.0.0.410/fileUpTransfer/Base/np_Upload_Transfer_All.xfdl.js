(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"FILENAME\" type=\"STRING\" size=\"256\"/><Column id=\"FILESIZE\" type=\"STRING\" size=\"256\"/><Column id=\"FILEPATH\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj = new Button("Button01","193","12","176","44",null,null,null,null,null,null,this);
            obj.set_taborder("7");
        ...
        {
        	var sTemp = Math.floor(Math.random() * 10000000);
        	...
        	if ( true == this.CheckBox00.value )
        	{
        		...
        		trace("upload url >>>> " + "http://172.10.12.45:9090/fileUpload_postdatatest.jsp?filefolder=filefolders_"+sTemp);
        		this.FileUpTransfer00.upload("http://172.10.12.45:9090/fileUpload_postdatatest.jsp?filefolder=filefolders_"+sTemp);
        	}
        	else
        	{
