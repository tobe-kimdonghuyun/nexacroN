...
if (!nexacro.TCPClientSocket)
{
	...
	else if ((nexacro._OS == "Android" || nexacro._OS == "iOS" || nexacro._linux_app) && nexacro._isHybrid()) {
		nexacro._createTCPClientSocket = function (obj /*, func_succ, func_error*/)
        {
	...
	if ((nexacro._OS == "Android" || nexacro._OS == "iOS" || nexacro._linux_app) && nexacro._isHybrid()) {
		_pTCPClientSocket.fire_onsuccess = function (params)
    	{
			var paramsObject;
			if (nexacro._OS == "iOS" || nexacro._linux_app)
			{
				if (nexacro._isObject(params))
				{
					paramsObject = params;
				}
				else
