(function()
{
    return function()
    {
        ...
        {
            var obj = new ChildFrame("childframe", "absolute", null, null, null, null, null, null, "Base::ExcelImport.xfdl", this);
            this.addChild(obj.name, obj);
            this.frame = obj;

            obj.set_formurl("Base::ExcelImport.xfdl");
        ...
        this.checkLicense("http://localhost:6060/nexacro14_client_license.xml");
        this.loadTypedefition();
        this.loadScreenInfo();
        this.loadTheme("default.xtheme");


        this.loadIncludeScript("RP_104839.xadl", true);
    };
}
)();
